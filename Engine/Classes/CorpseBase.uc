/*******************************************************************************
 * CorpseBase generated by Eliot.UELib using UELib.CLI.
...
function PostLoadMap()
{
	...
	// End:0x3C
	if(__NFUN_203__(__NFUN_227__(__NFUN_196__(__NFUN_199__(1, DrawScale), 0.75), 0, 1), 0.5))
	{
		bShrunkCorpse = true;
		__NFUN_812__(1);
	}
	i = __NFUN_166__(string(StartupDestroyedBones), 1);
	J0x4B:
	...
	if(__NFUN_172__(i, 0))
	{
		...
		// End:0xA1
		if(__NFUN_148__(__NFUN_342__(DestroyableBone, 'None'), __NFUN_145__(__NFUN_1032__(DestroyableBone))))
		{
			__NFUN_1031__(StartupDestroyedBones[i],,, true, true, true);
		}
		__NFUN_185__(i);
		// [Loop Continue]
		goto J0x4B;
...
simulated event PreGameInit()
{
	...
	// End:0x3A [Loop If]
	if(__NFUN_169__(i, string(DestroyedBones)))
	{
...
simulated event Tick(float DeltaTime)
{
	...
	// End:0x98
	if(__NFUN_201__(TargetFrozenPercent, FrozenPercent))
	{
		// End:0x5F
		if(__NFUN_201__(FreezeDuration, 0))
		{
			__NFUN_209__(FrozenPercent, __NFUN_196__(DeltaTime, FreezeDuration));
		}
		// End:0x95
		if(__NFUN_150__(__NFUN_202__(FreezeDuration, 0), __NFUN_201__(FrozenPercent, TargetFrozenPercent)))
		{
	...
	{
		// End:0xBA
		if(__NFUN_201__(ThawDuration, 0))
		{
			__NFUN_210__(FrozenPercent, __NFUN_196__(DeltaTime, ThawDuration));
		}
		// End:0xE5
		if(__NFUN_150__(__NFUN_202__(ThawDuration, 0), __NFUN_200__(FrozenPercent, TargetFrozenPercent)))
		{
			FrozenPercent = TargetFrozenPercent;
		}
	}
	...
	// End:0x13F
	if(__NFUN_148__(__NFUN_202__(FrozenPercent, ThawJointsThreshold), __NFUN_201__(StartingFrozenPercent, ThawJointsThreshold)))
	{
		__NFUN_817__();
	}
...
function ApplyImpulse(Vector Dir, Vector Loc, optional name BoneName)
{
	...
	i = __NFUN_166__(__NFUN_568__().__NFUN_523__(), 1);
	J0x1F:

	// End:0xEE [Loop If]
	if(__NFUN_172__(i, 0))
	{
		ScratchBoneName = __NFUN_568__().__NFUN_524__(i);
		// End:0x53
		...
		// End:0x6B
		if(__NFUN_145__(__NFUN_568__().__NFUN_529__(ScratchBoneName)))
		{
			// [Explicit Continue]
			goto J0xE4;
		}
		ScratchBoneWeight = __NFUN_225__(0, __NFUN_199__(1, __NFUN_196__(__NFUN_251__(__NFUN_239__(__NFUN_568__().__NFUN_533__(ScratchBoneName, true), Loc)), 48)));
		// End:0xB2
	...
	// End:0x111
	if(__NFUN_173__(string(ImpulseBones), 0))
	{
		super(KarmaActor).ApplyImpulse(Dir, Loc, BoneName);
		return;
	}
	ImpulseBones[ImpulseBones.Add(1)] = BoneName;
	ImpulseWeights[ImpulseWeights.Add(1)] = __NFUN_195__(TotalWeight, 0.5);
	__NFUN_207__(TotalWeight, 1.5);
	i = __NFUN_166__(string(ImpulseBones), 1);
	J0x159:

	// End:0x19D [Loop If]
	if(__NFUN_172__(i, 0))
	{
		super(KarmaActor).ApplyImpulse(__NFUN_237__(__NFUN_235__(ImpulseWeights[i], Dir), TotalWeight), Loc, ImpulseBones[i]);
		__NFUN_185__(i);
		// [Loop Continue]
		goto J0x159;
	}
...
function InitConstraints()
{
	...
	// End:0x176 [Loop If]
	if(__NFUN_169__(i, string(BoneConstraints)))
	{
		// End:0x50
...
function bool CreateAnimatedCorpse(InteractiveActor aOther)
{
	...
	if(aOther.bLowerByCollision)
	{
		...
		{
			__NFUN_209__(NewPrePivot.Z, __NFUN_196__(aOther.CollisionHeight, __NFUN_195__(DrawScale, DrawScale3D.Z)));			
		}
		else
		{
			__NFUN_210__(NewPostPivot.Z, aOther.CollisionHeight);
		}
	}
	...
	// End:0x1FF [Loop If]
	if(__NFUN_169__(i, string(aOther.Skins)))
	{
	...
	// End:0x248 [Loop If]
	if(__NFUN_169__(i, string(aOther.ActorColorList)))
	{
	...
	// End:0x2ED
	if(__NFUN_148__(__NFUN_340__(OwnerPawn, none), OwnerPawn.IsFrozen()))
	{
	...
	TargetFrozenPercent = 0;
	i = __NFUN_166__(string(aOther.MountedActorList), 1);
	J0x31C:
	...
	{
		// End:0x48A
		if(__NFUN_148__(aOther.MountedActorList[i].bTransferToCorpse, __NFUN_340__(aOther.MountedActorList[i].MountedActor, none)))
		{
			...
			A.__NFUN_641__(self);
			// End:0x455
			if(__NFUN_173__(int(A.OwnerSeeStyle), int(2)))
			{
				A.OwnerSeeStyle = 0;
			}
			// End:0x48A
...
function bool CreateRagdollCorpse(InteractiveActor aOther)
{
	...
	// End:0x39
	if(__NFUN_148__(__NFUN_340__(OwnerPawn, none), OwnerPawn.IsMostlyShrunk()))
	{
		bShrunkCorpse = true;
		__NFUN_812__(1);
	}
	// End:0x49
	if(__NFUN_145__(bDontUseMeqonPhysics))
	{
		__NFUN_642__(18);
	}
	// End:0x57
...
{
	// End:0x1D
	if(__NFUN_201__(RemoveCheckTime, 0))
	{
...
event Destroyed()
{
	J0x00:
	// End:0x3E [Loop If]
	if(__NFUN_170__(string(BoneConstraints), 0))
	{
		// End:0x33
...
function CheckRemoval()
{
	...
	if(__NFUN_145__(IsMP()))
	{
		ZoneLastRenderTime = __NFUN_599__();
		// End:0x61
		if(__NFUN_201__(Level.GameTimeSeconds, ZoneLastRenderTime))
		{
			// End:0x5E
			if(__NFUN_200__(__NFUN_199__(Level.GameTimeSeconds, ZoneLastRenderTime), RemoveCheckTime))
			{
				__NFUN_607__(RemoveCheckTime, false, 'CheckRemoval');				
			}
			else
...
event TakeDamage(Pawn Instigator, float Damage, Vector DamageOrigin, Vector DamageDirection, class<DamageType> DamageType, optional name HitBoneName, optional Vector DamageStart)
{
	...
	// End:0x3A
	if(__NFUN_150__(__NFUN_173__(int(DrawType), int(8)), __NFUN_339__(__NFUN_574__(Mesh), none)))
	{
		bCanDie = true;
	}
	...
	// End:0xA8
	if(__NFUN_148__(bNoDamage, __NFUN_145__(IsFrozen())))
	{
		return;
	}
	// End:0xD0
	if(__NFUN_148__(bDelayedRagdoll, __NFUN_201__(Damage, 0)))
	{
		bDelayedRagdoll = false;
		MakeRagdoll();
	}
	...
	// End:0x113
	if(__NFUN_148__(__NFUN_148__(__NFUN_340__(Instigator, none), Instigator.bFullyShrunk), __NFUN_145__(bShrunk)))
	{
		return;
	}
	// End:0x2F6
	...
	{
		// End:0x19D
		if(__NFUN_150__(__NFUN_148__(DamageTypeCanGib(DamageType), __NFUN_203__(ThisFrameDamage.Damage, GibThreshold)), __NFUN_148__(IsFrozen(), __NFUN_203__(ThisFrameDamage.Damage, FrozenGibThreshold))))
		{
			// End:0x175
			if(IsFrozen())
			{
		...
		{
			// End:0x210
			if(__NFUN_148__(__NFUN_148__(__NFUN_148__(bShrunkCorpse, __NFUN_340__(Instigator, none)), Instigator.bIsPlayerPawn), __NFUN_145__(Instigator.IsMostlyShrunk())))
			{
				bDamageCouldGib = true;
				Gib(int(Damage), DamageOrigin, DamageDirection, DamageType, PlayerPawn(Instigator));				
			}
			else
			{
				...
				{
					// End:0x2F6
					if(__NFUN_150__(__NFUN_148__(IsFrozen(), __NFUN_203__(ThisFrameDamage.Damage, FrozenBoneDamageThreshold)), __NFUN_203__(ThisFrameDamage.Damage, BoneDamageThreshold)))
					{
						DamagedBone = __NFUN_571__(Mesh, HitBoneName);
						// End:0x2DD
						if(__NFUN_148__(__NFUN_342__(DamagedBone, 'None'), __NFUN_145__(__NFUN_1032__(DamagedBone))))
						{
							__NFUN_1031__(DamagedBone, PlayerPawn(Instigator), DamageOrigin);
							// End:0x2DA
						...
						{
							// End:0x2F6
							if(__NFUN_145__(DeferredGibbingInProgress))
							{
...
{
	// End:0x3B
	if(__NFUN_148__(__NFUN_340__(P, none), P.bIsPlayerPawn))
	{
...
animevent simulated function Destroy_Bone(optional EventInfo AnimEventInfo)
{
	...
	// End:0x42
	if(__NFUN_148__(__NFUN_342__(BoneToDestroy, 'None'), __NFUN_145__(__NFUN_1032__(BoneToDestroy))))
	{
		__NFUN_1031__(BoneToDestroy);
	}
	return;
}
...
animevent simulated function Destroy_Bone_NoLimb(optional EventInfo AnimEventInfo)
{
	...
	if(__NFUN_148__(__NFUN_342__(BoneToDestroy, 'None'), __NFUN_145__(__NFUN_1032__(BoneToDestroy))))
	{
		__NFUN_1031__(BoneToDestroy,,,, true);
	}
	return;
}
...
final simulated event Corpse_Gib SpawnLimb(SCorpseGib GibInfo)
{
	...
	// End:0x2A
	if(__NFUN_150__(__NFUN_341__(GibInfo.BoneName, 'None'), __NFUN_339__(GibInfo.RenderObject, none)))
	{
		return none;
	}
	...
	if(__NFUN_340__(Limb, none))
	{
		...
		// End:0xEF
		if(__NFUN_148__(IsMP(), __NFUN_206__(DrawScale, 1)))
		{
		...
		{
			Limb.__NFUN_591__(__NFUN_195__(DrawScale, __NFUN_226__(GibInfo.DrawScale, __NFUN_211__(GibInfo.DrawScaleVariance))), bChangeCollision);			
		}
		else
		{
			Limb.__NFUN_591__(__NFUN_226__(DrawScale, __NFUN_211__(GibInfo.DrawScaleVariance)), bChangeCollision);
		}
		...
		if(__NFUN_340__(Limb.__NFUN_568__(), none))
		{
			...
			Limb.__NFUN_645__(MeshInstance.__NFUN_533__(GibInfo.BoneName, true));
			Limb.MeshInstance.__NFUN_538__('Root', BoneRotate, true);
			NumChildren = Limb.MeshInstance.__NFUN_527__(GibInfo.BoneName);
			i = 0;
			J0x351:

			// End:0x3C2 [Loop If]
			if(__NFUN_169__(i, NumChildren))
			{
				ChildBoneName = Limb.MeshInstance.__NFUN_528__(GibInfo.BoneName, i);
				// End:0x3B8
				if(__NFUN_145__(__NFUN_1032__(ChildBoneName)))
				{
					Limb.MeshInstance.__NFUN_541__(__NFUN_568__(), ChildBoneName);
				}
				__NFUN_184__(i);
				// [Loop Continue]
				goto J0x351;
			}
			Limb.MeshInstance.__NFUN_537__(GibInfo.BoneName, __NFUN_232__(0, 0, 0), false);
		...
		Limb.bIgnorePawnAirCushion = __NFUN_150__(GibInfo.bIgnorePawnAirCushion, bShrunkCorpse);
		// End:0x4F6
		if(__NFUN_145__(IsMP()))
		{
			Limb.__NFUN_621__(true,,, true, true);
		}
		// End:0x55F
		if(GibInfo.bStaticGib)
		{
			...
			Limb.__NFUN_812__(0);
			// End:0x55C
			if(__NFUN_150__(bShrunkCorpse, GibInfo.bKDNoPawnInteractions))
			{
				Limb.__NFUN_811__(3);
			}			
		}
		else
		{
			...
			if(IsMP())
			{
				AngularVelocity = __NFUN_256__(AngularVelocity, FullyGibbedAngularVelocityVariance);
				// End:0x5AC
				if(bRandomGibDir)
				{
					LinearVelocity = __NFUN_255__();
					__NFUN_209__(LinearVelocity.Z, 0.5);
					__NFUN_246__(LinearVelocity, MPLimbLinearVelocity);					
				}
				else
				{
					LinearVelocity = __NFUN_241__(FullyGibbedLinearVelocity, Rotator(__NFUN_239__(Limb.Location, Location)));
				}
				LinearVelocity = __NFUN_234__(LinearVelocity, DrawScale);
				...
				// End:0x746
				if(__NFUN_206__(__NFUN_251__(AngularVelocity), 0))
				{
					NewRotationRate.Pitch = int(__NFUN_195__(AngularVelocity.Y, __NFUN_195__(32768, 0.3183099)));
					NewRotationRate.Yaw = int(__NFUN_195__(AngularVelocity.Z, __NFUN_195__(32768, 0.3183099)));
					NewRotationRate.Roll = int(__NFUN_195__(AngularVelocity.X, __NFUN_195__(32768, 0.3183099)));
		...
		// End:0x989
		if(__NFUN_148__(__NFUN_148__(__NFUN_148__(CanSpawnBloodyMess(), __NFUN_145__(IsFrozen())), __NFUN_145__(GibInfo.bNoBloodyMess)), __NFUN_340__(GibInfo.GibBloodyMess, none)))
		{
			BloodyMess = __NFUN_615__(GibInfo.GibBloodyMess);
			// End:0x989
			if(__NFUN_340__(BloodyMess, none))
			{
				...
				BloodyMess.__NFUN_591__(__NFUN_195__(BloodyMess.default.DrawScale, Limb.DrawScale));
			}
		}
		...
		if(__NFUN_201__(ImpulseMag, 0))
		{
			...
			Dir = __NFUN_234__(Dir, ImpulseMag);
			Limb.__NFUN_820__(__NFUN_234__(Dir, ImpulseMag));
		}
		// End:0xAB0
		if(__NFUN_340__(cBonePartMapper, none))
		{
			...
			// End:0xAAD [Loop If]
			if(__NFUN_169__(i, string(cBonePartMapper.default.DestroyableBones)))
			{
				// End:0xAA3
				if(__NFUN_148__(__NFUN_341__(cBonePartMapper.default.DestroyableBones[i].BoneName, GibInfo.BoneName), cBonePartMapper.default.DestroyableBones[i].bAddToLimbCount))
				{
					__NFUN_184__(NumberOfLimbsGibbed);
					// End:0xAA3
					if(__NFUN_173__(NumberOfLimbsGibbed, cBonePartMapper.default.NumLimbsUntilDestructible))
					{
						__NFUN_607__(1E-06, false, 'EnableDeath');
					}
				}
	...
	if(IsMP())
	{
		...
		if(__NFUN_342__(GibInfo.BoneName, 'neck'))
		{
			...
			// End:0xBAE [Loop If]
			if(__NFUN_169__(i, __NFUN_743__()))
			{
				Mat = __NFUN_740__(i);
				// End:0xB84
				if(__NFUN_148__(__NFUN_148__(__NFUN_340__(Mat, __NFUN_742__(i)), __NFUN_340__(Mat, Level.DefaultMaterial)), __NFUN_340__(Mat, ClearMaterial)))
				{
...
function HurtRadiusActivity(Actor DamageInstigator, float DamageAmount, Vector DamageOrigin, float DamageRadius, float DamageFalloffStart, class<DamageType> DamageType, Vector DamageStart, optional bool bIgnoreDrawScale, optional float RelativeScale)
{
	...
	// End:0x9C
	if(__NFUN_148__(__NFUN_148__(__NFUN_340__(__NFUN_568__(), none), __NFUN_201__(DamageRadius, 0)), __NFUN_200__(__NFUN_196__(__NFUN_251__(__NFUN_239__(MeshInstance.__NFUN_533__(CenterOfMassBone, true), DamageOrigin)), DamageRadius), 0.25)))
	{
		bDamageCouldGib = true;
	}
...
final simulated function GrowChildren(MeshInstance IMesh, name BoneName)
{
	...
	// End:0x20
	if(__NFUN_150__(__NFUN_339__(IMesh, none), __NFUN_341__(BoneName, 'None')))
	{
		return;
	}
	NumChildren = IMesh.__NFUN_527__(BoneName);
	i = 0;
	J0x3F:
	...
	if(__NFUN_169__(i, NumChildren))
	{
		...
		IMesh.__NFUN_539__(ChildName, __NFUN_232__(1, 1, 1), false);
		__NFUN_184__(i);
		// [Loop Continue]
		goto J0x3F;
	}
...
final simulated event RemoveBoneCap(name BoneName)
{
	...
	i = __NFUN_166__(string(LimbCaps), 1);
	J0x0F:
	...
	if(__NFUN_172__(i, 0))
	{
		...
		if(__NFUN_340__(LimbCaps[i], none))
		{
			...
			if(__NFUN_342__(TestBone, 'None'))
			{
				...
				TestBone = MeshInstance.__NFUN_526__(TestBone);
				// [Loop Continue]
				goto J0x47;
			}
		}
...
event RegisterPrecacheComponents(PrecacheIndex PrecacheIndex)
{
	...
	// End:0xED
	if(__NFUN_148__(__NFUN_340__(FreezeRayClass, none), PrecacheIndex.__NFUN_1286__(FreezeRayClass)))
	{
		i = __NFUN_166__(string(FrozenPhysicsSoundOverrides), 1);
		J0x86:

		// End:0xED [Loop If]
		if(__NFUN_172__(i, 0))
		{
			j = __NFUN_166__(string(FrozenPhysicsSoundOverrides[i].Sounds), 1);
			J0xAB:
