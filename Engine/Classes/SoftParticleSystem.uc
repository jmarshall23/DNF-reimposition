...
var const editconst transient pointer ParticleSystemHandle;
...
var const editconst transient array<transient pointer> PendingDeleteTextureAnimControllers;
var int CacheRenderParticleNumber;
var int AllocatedRenderData;
var const editconst transient pointer ParticleRenderDataHandle;
...
defaultproperties
{
	...
	ActorColorList(0)=(Engine=/* Unknown default property type! */,Color=/* Unknown default property type! */,R=255,G=255,B=255,A=255)
	ActorColorList(1)=(ActorColor_LightEx=none,ActorColor_LightExScale=(X=1.293258E-41,Y=3.079134E-17,Z=0),Z=0)
	ActorColorList(2)=(id=SystemColor)
	ActorColorList(3)=(RemoteRole=0,TransientSoundRadius=1024,TransientSoundInnerRadius=512)
	ActorColorList(4)=
