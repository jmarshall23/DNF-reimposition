/*******************************************************************************
 * MusicTrigger generated by Eliot.UELib using UELib.CLI.
...
event Trigger(Actor Other, Pawn EventInstigator)
{
	...
	// End:0x26
	if(__NFUN_148__(OnceOnly, bTriggered))
	{
		return;
	}
	// End:0x135
	if(__NFUN_342__(PlayFromActorTag, 'None'))
	{
		...
		foreach __NFUN_747__(class'Actor', A, PlayFromActorTag)
		{
			...
			{
				A.AmbientMusicVolume = __NFUN_196__(float(Volume), 255);
	...
	{
		__NFUN_699__(TrackName, MixerGroup, CrossfadeSeconds, __NFUN_196__(float(Volume), 255), Loop, MusicEndedEvent, OldMusicFadeOutTime, AllowReverb);
	}
	bTriggered = true;
	return;
}
