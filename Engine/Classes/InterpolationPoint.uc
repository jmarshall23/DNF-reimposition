/*******************************************************************************
 * InterpolationPoint generated by Eliot.UELib using UELib.CLI.
...
event PostBeginPlay()
{
	...
	// End:0x51
	if(__NFUN_201__(RateModifierBlendBegin, float(1)))
	{
	...
	// End:0x7F
	if(__NFUN_201__(RateModifierBlendEnd, float(1)))
	{
		RateModifierBlendEnd = 1;
	}
	// End:0x99
	if(__NFUN_201__(RateModifierBlendBegin, RateModifierBlendEnd))
	{
		RateModifierBlendBegin = 0;
	}
	return;
...
event BuildPath(optional int bWalkTree)
{
	...
	if(__NFUN_340__(i, none))
	{
		...
		// End:0xB2
		if(__NFUN_148__(__NFUN_148__(__NFUN_174__(bWalkTree, 0), __NFUN_340__(Next, none)), __NFUN_339__(Next.Next, none)))
		{
	...
	// End:0xE1
	if(__NFUN_148__(bDebugPathing, __NFUN_339__(Next, none)))
	{
...
final function SetInterpolationVariance(Vector NewLocationVariance, Rotator NewRotationVariance)
{
	...
	// End:0x59
	if(__NFUN_150__(__NFUN_145__(__NFUN_242__(LocationVariance, __NFUN_232__(0, 0, 0))), __NFUN_145__(__NFUN_271__(RotationVariance, __NFUN_265__(0, 0, 0)))))
	{
...
{
	// End:0x18
	if(__NFUN_150__(__NFUN_145__(bHasInterpVariance), bInterpVarianceInUse))
	{
		return;
	}
	bInterpVarianceInUse = true;
	InterpLocation = __NFUN_256__(Location, LocationVariance);
	InterpRotation = __NFUN_284__(Rotation, RotationVariance);
	return;
}
...
{
	// End:0x0D
	if(__NFUN_145__(bHasInterpVariance))
	{
		return;
	}
...
event InterpolateBegin(Actor Other)
{
	...
	// End:0xC0
	if(__NFUN_148__(bTriggerImmediately, __NFUN_342__(TriggerEvent, 'None')))
	{
...
event InterpolateEnd(Actor Other)
{
	...
	// End:0x86
	if(__NFUN_148__(bRebuildPathEachUse, __NFUN_340__(Next, none)))
	{
		Next = GetRandomNext();
		// End:0x86
		if(__NFUN_340__(Next, none))
	...
	// End:0x108
	if(__NFUN_148__(__NFUN_145__(bTriggerImmediately), __NFUN_342__(TriggerEvent, 'None')))
	{
		// End:0xEC
		if(bDebugPathing)
		{
...
final function InterpolationPoint GetRandomNext()
{
	...
	// End:0xC0
	if(__NFUN_174__(string(Destinations), 0))
	{
		i = Destinations[__NFUN_187__(string(Destinations))];		
	}
	else
	{
		i = none;
