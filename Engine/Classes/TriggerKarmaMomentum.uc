/*******************************************************************************
 * TriggerKarmaMomentum generated by Eliot.UELib using UELib.CLI.
...
function Trigger(Actor Other, Pawn EventInstigator)
{
	...
	if(bApplyInDirection)
	{
		...
		__NFUN_736__(Location, __NFUN_238__(Location, __NFUN_235__(TraceDistance, Vector(Rotation))), TFlags, TResult);
		// End:0x98
		if(__NFUN_340__(TResult.Actor, none))
		{
			A = KarmaActor(TResult.Actor);
			Dir = __NFUN_253__(__NFUN_239__(TResult.Location, Location));
	...
	else
	{
		...
		{
			Dir = __NFUN_253__(__NFUN_239__(A.Location, Location));
			Loc = A.Location;
			// End:0xE7
			break;			
		}		
	...
	// End:0x160
	if(__NFUN_148__(__NFUN_340__(A, none), __NFUN_173__(int(A.Physics), int(18))))
	{
		// End:0x13D
		if(bApplyAsForce)
		{
			A.__NFUN_819__(__NFUN_235__(Momentum, Dir), Loc, AffectedBone);			
		}
		else
		{
			A.__NFUN_820__(__NFUN_235__(Momentum, Dir), Loc, AffectedBone);
		}
	}
	return;
}
