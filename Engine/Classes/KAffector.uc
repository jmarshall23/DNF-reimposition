/*******************************************************************************
 * KAffector generated by Eliot.UELib using UELib.CLI.
...
event PostBeginPlay()
{
	...
	// End:0x4C
	if(__NFUN_148__(__NFUN_148__(__NFUN_148__(__NFUN_339__(KConstraintActor1, none), __NFUN_341__(KConstraintActor1Tag, 'None')), __NFUN_339__(KConstraintActor2, none)), __NFUN_341__(KConstraintActor2Tag, 'None')))
	{
...
event Trigger(Actor Other, Pawn EventInstigator)
{
	...
	SetAffectorState(__NFUN_174__(int(Physics), int(18)));
	return;
}
...
function SetAffectorState(bool bDesiredAffectorState)
{
	...
	if(bDesiredAffectorState)
	{
		__NFUN_642__(18);
		// End:0x59
		if(__NFUN_148__(__NFUN_173__(int(Physics), int(18)), bWakeOnAffectorChange))
		{
			// End:0x40
