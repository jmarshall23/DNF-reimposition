/*******************************************************************************
 * KeyframeDispatch generated by Eliot.UELib using UELib.CLI.
...
final function SetActorKeyframe_Location(Actor Target)
{
	...
	ScratchDL.TargetVariance = __NFUN_232__(0, 0, 0);
...
final function SetKeyframeSounds(Actor Target)
{
	...
	{
		// End:0x132
		if(__NFUN_150__(__NFUN_150__(__NFUN_150__(__NFUN_150__(bUseOldKeyframe, bUseTargetRotation), bUseTargetRotationYaw), bUseTargetRotationPitch), bUseTargetRotationRoll))
		{
			Target.bStopAmbientOnEndRotation = true;
		}
		// End:0x158
		if(__NFUN_150__(bUseOldKeyframe, bUseTargetLocation))
		{
...
final function Rotator GetKeyframeRotation(Actor Target, Rotator KeyframeRotation)
{
	...
	{
		// End:0x2E
		if(__NFUN_148__(UseMyRotationMounted, __NFUN_340__(MountParent, none)))
		{
			Result = MountAngles;			
		}
		else
	...
	{
		// End:0x97
		if(__NFUN_148__(__NFUN_340__(Target.MountParent, none), __NFUN_145__(Target.IndependentRotation)))
		{
			__NFUN_277__(Result, Target.MountAngles);			
		}
		else
		{
			__NFUN_277__(Result, Target.Rotation);
		}
	}
...
final function Vector GetKeyframeLocation(Actor Target, Vector KeyframeLocation, optional Vector KeyframeLocationVariance)
{
	...
	{
		// End:0x2E
		if(__NFUN_148__(UseMyPositionMounted, __NFUN_340__(MountParent, none)))
		{
			Result = MountOrigin;			
		}
		else
	...
	Result = __NFUN_256__(Result, KeyframeLocationVariance);
	// End:0x7B
	...
	if(RelativeMotion)
	{
		__NFUN_249__(Result, GetStartLocation(Target));
	}
...
{
	// End:0x40
	if(__NFUN_148__(__NFUN_340__(Target.MountParent, none), __NFUN_145__(Target.IndependentLocation)))
	{
...
{
	// End:0x20
	if(__NFUN_148__(__NFUN_204__(Min, float(0)), __NFUN_204__(Max, float(0))))
	{
		return Value;
	}
	// End:0x8B
	if(__NFUN_201__(Min, Max))
	{
		// End:0x82
		if(__NFUN_148__(__NFUN_202__(Value, Min), __NFUN_203__(Value, Max)))
		{
			// End:0x79
			if(__NFUN_200__(__NFUN_211__(__NFUN_199__(Value, Min)), __NFUN_211__(__NFUN_199__(Value, Max))))
			{
				return Min;				
			}
			else
	...
	{
		return __NFUN_227__(Value, Min, Max);
	}
	return;
}
...
{
	// End:0x27
	if(__NFUN_170__(Value, 32768))
	{
		Value = __NFUN_166__(__NFUN_175__(Value, 65535), 65536);		
	}
	else
	{
		// End:0x4D
		if(__NFUN_169__(Value, -32767))
		{
			Value = __NFUN_165__(__NFUN_175__(Value, 65535), 65536);
		}
	}
	return Value;
	return;
