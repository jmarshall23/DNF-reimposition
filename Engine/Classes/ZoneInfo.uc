/*******************************************************************************
 * ZoneInfo generated by Eliot.UELib using UELib.CLI.
...
event ActorEntered(Actor Other)
{
	...
	if(__NFUN_340__(Other, none))
	{
		...
		{
			__NFUN_184__(ZonePlayerCount);
			// End:0x47
			if(__NFUN_173__(ZonePlayerCount, 1))
			{
		...
		{
			// End:0x27B
			if(__NFUN_148__(__NFUN_148__(Other.bIsCorpse, __NFUN_145__(Other.bGibActor)), __NFUN_170__(MaxCorpses, 0)))
			{
				Corpses[Corpses.Add(1)] = Corpse(Other);
				// End:0x27B
				if(__NFUN_170__(string(Corpses), MaxCorpses))
				{
					BestIdx = 0;
					BestTimeSinceRender = 0;
					i = __NFUN_166__(string(Corpses), 1);
					J0xE0:
					...
					if(__NFUN_172__(i, 0))
					{
						...
						TimeSinceRender = __NFUN_199__(Level.TimeSeconds, Corpses[i].LastRenderTime);
						// End:0x175
						if(__NFUN_201__(TimeSinceRender, BestTimeSinceRender))
						{
					...
					// End:0x251
					if(__NFUN_148__(__NFUN_340__(P, none), __NFUN_200__(BestTimeSinceRender, 0.5)))
					{
						BestIdx = 0;
						BestDist = 0;
						i = __NFUN_166__(string(Corpses), 1);
						...
						if(__NFUN_172__(i, 0))
						{
							...
							Dist = __NFUN_252__(__NFUN_239__(P.Location, Corpses[i].Location));
							// End:0x247
							if(__NFUN_201__(Dist, BestDist))
							{
								BestIdx = i;
								BestDist = Dist;
							}
...
event ActorLeaving(Actor Other)
{
	...
	if(Other.bIsPlayerPawn)
	{
		__NFUN_185__(ZonePlayerCount);
		// End:0x3B
		if(__NFUN_173__(ZonePlayerCount, 0))
		{
	...
	{
		// End:0xC4
		if(__NFUN_148__(Other.bIsCorpse, __NFUN_145__(Other.bGibActor)))
		{
			i = __NFUN_166__(string(Corpses), 1);
			J0x8D:
...
defaultproperties
{
	...
	AmbientLightScale=1
	DistanceFog=Color=(B=6,G=1,R=255,A=7),Engine[1]=/* Unknown default property type! */,
/* Exception thrown while deserializing DistanceFog
...
Parameter name: index
   ...
   at UELib.Core.UDefaultProperty.DeserializeDefaultPropertyValue(PropertyType type, DeserializeFlags& deserializeFlags) in E:\SteamLibrary\steamapps\common\DukeNukem\Tools\UnrealscriptDecompiler\Core\Classes\UDefaultProperty.cs:line 767 */
	GlobalHeightFog=Color=(B=6,G=1,R=255,A=7),Engine[1]=/* Unknown default property type! */,
/* Exception thrown while deserializing GlobalHeightFog
System.ArgumentOutOfRangeException: Index was out of range. Must be non-negative and less than the size of the collection.
Parameter name: index
   at System.ThrowHelper.ThrowArgumentOutOfRangeException(ExceptionArgument argument, ExceptionResource resource)
   at System.Collections.Generic.List`1.get_Item(Int32 index)
   ...
   at UELib.Core.UDefaultProperty.DeserializeDefaultPropertyValue(PropertyType type, DeserializeFlags& deserializeFlags) in E:\SteamLibrary\steamapps\common\DukeNukem\Tools\UnrealscriptDecompiler\Core\Classes\UDefaultProperty.cs:line 767 */
	...
	RemoteRole=0
	ScaleModifierGroupList(0)=(Engine=40304649,bTexture=false)
	ScaleModifierGroupList(1)=none
	ScaleModifierGroupList(2)=none
	ScaleModifierGroupList(3)=(AssignSound=none)
	ScaleModifierGroupList(4)=none
	ScaleModifierGroupList(5)=none
	ScaleModifierGroupList(6)=(NoUpdate=false)
	ScaleModifierGroupList(7)=none
