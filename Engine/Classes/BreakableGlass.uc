/*******************************************************************************
 * BreakableGlass generated by Eliot.UELib using UELib.CLI.
...
simulated event PreGameInit()
{
	...
	// End:0x2C
	if(__NFUN_148__(bShattered, __NFUN_145__(Level.bStartup)))
	{
		PreShatterGlass();
	}
	return;
...
event Vector OrientDrawScale3D(Vector DS3D)
{
	...
	temp2.X = __NFUN_211__(temp.Y);
	temp2.Y = __NFUN_211__(temp.Z);
	temp2.Z = 1;
	return temp2;
	return;
}
...
defaultproperties
{
	...
	DrawType=12
	AlphaSortGroup=8
	DrawScale3D=(X=1.293258E-41,Y=3.084809E-17,Z=64)
