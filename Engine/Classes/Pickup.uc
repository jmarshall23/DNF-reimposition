...
var float ShowRespawnMarkerTime;
...
defaultproperties
{
	...
	bAcceptMines=false
	bCollideActors=true
	TouchClasses(0)=class'Actor'
	TouchClasses(1)=class'Pawn'
	TouchClasses(2)=class'PhysicsVolume'
	TouchClasses(3)=class'Target'
	TouchClasses(4)=class'Inventory'
	TouchClasses(5)=none
	TouchClasses(6)=none
	TouchClasses(7)=class'bDropping'
	TouchClasses(8)=class'ReturnValue'
	TouchClasses(9)=
/* Exception thrown while deserializing TouchClasses
...
System.IO.EndOfStreamException: Unable to read beyond the end of the stream.
   ...
   at UELib.UObjectStream.ReadObject() in E:\SteamLibrary\steamapps\common\DukeNukem\Tools\UnrealscriptDecompiler\UnrealStream.cs:line 742
   at UELib.Core.UDefaultProperty.DeserializeDefaultPropertyValue(PropertyType type, DeserializeFlags& deserializeFlags) in E:\SteamLibrary\steamapps\common\DukeNukem\Tools\UnrealscriptDecompiler\Core\Classes\UDefaultProperty.cs:line 559 */
	Engine=/* Unknown default property type! */
}