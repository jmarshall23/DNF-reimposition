/*******************************************************************************
 * ActionPoint generated by Eliot.UELib using UELib.CLI.
...
{
	// End:0x35
	if(__NFUN_148__(__NFUN_340__(CurrentAP, none), __NFUN_339__(CurrentAP.Class, self.Class)))
	{
		return bLocked;
	}
	return bLocked;
...
simulated event bool LockActionPoint(Actor NewUser)
{
	...
	i = __NFUN_166__(string(CloseActionPoints), 1);
	J0x21:
...
final function CheckUnlock()
{
	...
	DistSq = __NFUN_252__(__NFUN_239__(User.Location, Location));
	// End:0x6C
	if(__NFUN_201__(DistSq, __NFUN_195__(__NFUN_195__(User.CollisionRadius, float(3)), __NFUN_195__(User.CollisionRadius, float(3)))))
	{
		InternalUnlock();
	}
	return;
...
{
	return __NFUN_238__(__NFUN_239__(Location, __NFUN_234__(Vector(Rotation), APOffset)), __NFUN_232__(0, 0, DestActor.CollisionHeight));
	return;
}
