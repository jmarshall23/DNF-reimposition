...
var const editconst transient pointer CachePrimitive;
...
var(Collision) const noexport bool bBlockKarma "This actor should attempt to have some sort of Karma collision.";
...
var(Advanced) const noexport travel bool bHidden "Is hidden during gameplay.";
...
var Actor Target;
var Pawn Instigator;
var const editconst transient pointer SPActorInfo;
var(Object) noexport editinline name InitialState "Initial state of the object, uses default if none.";
...
var const editconst transient array<transient pointer> OctreeNodes;
...
var(movement) const noexport Vector Location "Actor's location -- use Move to set.";
...
var(Mounting) noexport edfindable Vector MountOrigin "Origin offset for attachment.";
var(Mounting) noexport edfindable Rotator MountAngles "Rotation angles for attachment.";
var(Mounting) noexport name MountMeshItem "Bone/Surface mount name to attach ourself to on our parent (Only valid on Meshes)";
var(Mounting) const noexport deprecated Actor MountParent "If Non-None then mount to this actor. Checked before MountParentTag." "MountOffsets are not autogenerated." "Only use if you know what you are doing and why you are doing it." "Do NOT click the new button. This is for debugging purposes ONLY.";
...
var(Display) const noexport float DrawScale "Draw scaling factor, 1.0=normal size.";
var(Display) const noexport edfindable Vector DrawScale3D "3D draw scaling factor.";
...
var(Display) const noexport StaticMesh StaticMesh "StaticMesh if DrawType=DT_StaticMesh.";
var transient StaticMesh RenderStaticMesh;
var(Display) const noexport Mesh Mesh "Mesh if DrawType=DT_Mesh.";
var transient Mesh RenderMesh;
var const transient float LastRenderTime;
var(Display) const noexport array<MaterialEx> Skins "Array of materials. Each index maps directly to the same-numbered section of the mesh/staticmesh.";
...
var const editconst transient array<transient pointer> Projectors;
...
var const editconst transient pointer RenderData;
...
var(Sound) const noexport Sound AmbientSound "Ambient sound effect attached to actor.";
...
var(Sound) const noexport string AmbientMusic "Filename of the .mp3 file to be streamed from this actor.";
...
k2call simulated function StopVoicePackEntry(optional EventInfo AnimEventInfo)
{
	// End:0x27
	if(__NFUN_309__(AnimEventInfo.EventString, ""))
	{
...
k2call simulated function StopVoicePackEntryLoopEnd(optional EventInfo AnimEventInfo)
{
	// End:0x27
	if(__NFUN_309__(AnimEventInfo.EventString, ""))
	{
...
k2call simulated function PlayAnimTrigger(optional EventInfo AnimEventInfo)
{
