/*******************************************************************************
 * Lights_Generic_Recessed_SmallCircle_A generated by Eliot.UELib using UE Explorer.exe.
 * Eliot.UELib ? 2009-2022 Eliot van Uytfanghe. All rights reserved.
 * http://eliotvu.com
 *
 * All rights belong to their respective owners.
 *******************************************************************************/
class Lights_Generic_Recessed_SmallCircle_A extends Lights_Generic
    collapsecategories;
...
defaultproperties
{
    ...
    DecoActivities_Default(2)=(ActivityData=(bInitialized=false,CurrentIndex=0,NextPerformTime=0,NextPerformTime_Failure=0),ActivityIDScript=(LightOn),ActivityID=none,ActivityMethod=0,ActivityStates_Success=none,ActivityStates_Failure=none,ActivityDebugID="",Activities=((ActivityRules=none,ActivityElements=(DecoActivities_Display'Lights_Generic_Recessed_SmallCircle_A.DA_Display_Lights_Generic_Recessed_SmallCircle_A_On'),ActivitySetup=(bDisabled=false,bPerformedThisRound=false,PerformedCounter=0,LoopCount=0,PerformAgainDelay=0),FailureActivityElements=none,FailureActivitySetup=(bDisabled=false,bPerformedThisRound=false,PerformedCounter=0,LoopCount=0,PerformAgainDelay=0))),bDisabled=false)
    DecoActivities_Default(3)=(ActivityData=(bInitialized=false,CurrentIndex=0,NextPerformTime=0,NextPerformTime_Failure=0),ActivityIDScript=(LightOff),ActivityID=none,ActivityMethod=0,ActivityStates_Success=none,ActivityStates_Failure=none,ActivityDebugID="",Activities=((ActivityRules=none,ActivityElements=(DecoActivities_Display'Lights_Generic_Recessed_SmallCircle_A.DA_Display_Lights_Generic_Recessed_SmallCircle_A_Off'),ActivitySetup=(bDisabled=false,bPerformedThisRound=false,PerformedCounter=0,LoopCount=0,PerformAgainDelay=0),FailureActivityElements=none,FailureActivitySetup=(bDisabled=false,bPerformedThisRound=false,PerformedCounter=0,LoopCount=0,PerformAgainDelay=0))),bDisabled=false)
    ...
    begin object name=DA_Display_Lights_Generic_Recessed_SmallCircle_A_Brkn class=DecoActivities_Display
        Skins(0)=(Index=0,NewMaterialEx='smt_skins9.RecessedLight.RecessedLight_brkn_fb')
    object end
    // Reference: DecoActivities_Display'Lights_Generic_Recessed_SmallCircle_A.DA_Display_Lights_Generic_Recessed_SmallCircle_A_Brkn'
    DestroyedActivities(3)=DA_Display_Lights_Generic_Recessed_SmallCircle_A_Brkn
    HealthPrefab=1
    bAcceptsDecalProjectors=false
    TransientSoundScaled=false
    CollisionRadius=4
    CollisionHeight=0
    StaticMesh='sm_class_lights.WallMounted.RecessedLight2'
}