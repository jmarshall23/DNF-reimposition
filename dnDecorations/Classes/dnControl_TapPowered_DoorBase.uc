/*******************************************************************************
 * dnControl_TapPowered_DoorBase generated by Eliot.UELib using UELib.CLI.
...
simulated function bool CanBeUsedBy(Pawn TestPawn)
{
	...
	if(ret)
	{
		...
		if(__NFUN_340__(Player, none))
		{
			...
			dotProd = __NFUN_244__(playerDirection, doorDirection);
			// End:0x9C
...
{
	// End:0x3D
	if(__NFUN_200__(__NFUN_244__(Vector(DefaultRotation), __NFUN_253__(__NFUN_239__(AttacheeCameraLoc, __NFUN_232__(Location.X, Location.Y, AttacheeCameraLoc.Z)))), 0))
	{
		return true;
	}
	return false;
...
{
	// End:0x40
	if(__NFUN_148__(__NFUN_340__(Door, none), __NFUN_342__(Door.PortalSurfaceTag, 'None')))
	{
...
state() idle
{
	...
	function UpdateUserLift()
	{
		...
		// End:0x75
		if(__NFUN_201__(PartiallyOpenPercent, 0))
		{
			UserLiftPct = __NFUN_195__(0.5, __NFUN_198__(UserLiftVal, 1));
			// End:0x6A
			if(__NFUN_148__(__NFUN_203__(UserLiftPct, PartiallyOpenPercent), __NFUN_200__(LastLiftPercent, PartiallyOpenPercent)))
			{
