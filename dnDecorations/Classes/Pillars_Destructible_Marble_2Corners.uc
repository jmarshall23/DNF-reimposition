...
defaultproperties
{
	...
	begin object name=DA_Display_Pilr_Destr_Marb_2C class=DecoActivities_Display
		RenderObject='sm_lvl_ladykiller.Pillars.LKcas_SqareCol_BRKN2'
	object end
	// Reference: DecoActivities_Display'Pillars_Destructible_Marble_2Corners.DA_Display_Pilr_Destr_Marb_2C'
	DestroyedActivities(1)=DA_Display_Pilr_Destr_Marb_2C
	...
	StaticMesh='sm_lvl_ladykiller.Pillars.LKcas_SqareCol_BRKN2'
}