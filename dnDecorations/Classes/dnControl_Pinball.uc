/*******************************************************************************
 * dnControl_Pinball generated by Eliot.UELib using UELib.CLI.
...
function InitItems()
{
	...
	TrackSensor = __NFUN_615__(class'KBoxSensor', self,, __NFUN_238__(Location, __NFUN_263__(TrackCenter, Rotation)), Rotation);
	// End:0x1EA
	...
	GutterSensor = __NFUN_615__(class'KBoxSensor', self,, __NFUN_238__(Location, __NFUN_263__(GutterCenter, Rotation)), Rotation);
	// End:0x2BE
	...
	SlotSet.SpawnSlots(__NFUN_232__(-21, 7, 8), __NFUN_232__(-21, 1, 8), __NFUN_232__(-21, -5, 8));
	HitBoxSet1 = dnControlHelper_Pinball_HitBoxSet(FindMountedActor('HitBoxSet1', class'dnControlHelper_Pinball_HitBoxSet'));
	HitBoxSet1.AddHitBox(__NFUN_232__(-3, 22, 8), __NFUN_232__(-3, 20, 6.1));
	HitBoxSet1.AddHitBox(__NFUN_232__(1, 22, 8), __NFUN_232__(1, 20, 6.1));
	HitBoxSet1.AddHitBox(__NFUN_232__(5, 22, 8), __NFUN_232__(5, 20, 6.1));
	HitBoxSet2 = dnControlHelper_Pinball_HitBoxSet(FindMountedActor('HitBoxSet2', class'dnControlHelper_Pinball_HitBoxSet'));
	HitBoxSet2.AddHitBox(__NFUN_232__(-1, -16, 8), __NFUN_232__(-1, -14, 6.1), true);
	HitBoxSet2.AddHitBox(__NFUN_232__(3, -16, 8), __NFUN_232__(3, -14, 6.1), true);
	HitBoxSet2.AddHitBox(__NFUN_232__(7, -16, 8), __NFUN_232__(7, -14, 6.1), true);
	HitBoxSet2.AddHitBox(__NFUN_232__(11, -16, 8), __NFUN_232__(11, -14, 6.1), true);
	Target1 = dnControlHelper_Pinball_Target(FindMountedActor('Target1', class'dnControlHelper_Pinball_Target'));
	Target1.AddLight(__NFUN_232__(-6.18, -13.02, 6.1), __NFUN_265__(0, 8516, 0), LightArrowMesh);
	Target2 = dnControlHelper_Pinball_Target(FindMountedActor('Target2', class'dnControlHelper_Pinball_Target'));
	Target2.AddLight(__NFUN_232__(-7.1, 18.18, 6.1), __NFUN_265__(0, -8564, 0), LightArrowMesh);
	Target3 = dnControlHelper_Pinball_Target(FindMountedActor('Target3', class'dnControlHelper_Pinball_Target'));
	Target3.AddLight(__NFUN_232__(-17.21, 18.95, 6.1), __NFUN_265__(0, -5664, 0), LightArrowMesh);
	...
	LeftSpacer.__NFUN_592__(__NFUN_232__(2, 1, 0.7));
	...
	RightSpacer.__NFUN_592__(__NFUN_232__(2, 1, 0.7));
...
function HideComponents()
{
	...
	J0x00:
	// End:0x2D [Loop If]
	if(__NFUN_169__(ii, string(LeftFlippers)))
	{
	...
	// End:0x61 [Loop If]
	if(__NFUN_169__(ii, string(RightFlippers)))
	{
...
simulated function AnimCallback_UserAttached()
{
	...
	__NFUN_606__('fScore');
	// End:0x61
	if(__NFUN_170__(BallsLeft, 0))
	{
		FlashMessage(BallsLeftMaterials[__NFUN_166__(BallsLeft, 1)], 3);
	}
...
simulated function DetachPawnSuccess(bool bForced)
{
	...
	OnDetachFromPinball();
	i = __NFUN_166__(string(LeftFlippers), 1);
	J0x21:
	...
	i = __NFUN_166__(string(RightFlippers), 1);
	J0x6D:
...
function TargetHit(dnControlHelper_Pinball_Target Target)
{
	...
	if(__NFUN_339__(Target, Target1))
	{
		...
		// End:0x8B
		if(__NFUN_145__(RightBlocker.bActivated))
		{
			RightBlocker.Activate();
	...
	else
	{
		...
		if(__NFUN_339__(Target, Target2))
		{
			...
			// End:0x119
			if(__NFUN_145__(LeftBlocker.bActivated))
			{
				LeftBlocker.Activate();
	...
	// End:0x1DA
	if(__NFUN_148__(__NFUN_148__(RedKeyLight.bActivated, BlueKeyLight.bActivated), __NFUN_145__(Target3.bActivated)))
	{
		Target3.Activate();
	}
	return;
...
{
	// End:0x0E
	if(__NFUN_173__(CurrentBonusLightIndex, 3))
	{
		return;
	}
	// End:0x2F
	if(__NFUN_172__(CurrentBonusLightIndex, 0))
	{
		BonusLights[CurrentBonusLightIndex].Deactivate();
	}
	__NFUN_184__(CurrentBonusLightIndex);
	__NFUN_180__(ScoreMultiplier, 2);
...
simulated function TriggerFunc_BallEnteredGutter()
{
	...
	if(__NFUN_172__(i, 0))
	{
		...
		if(__NFUN_339__(Balls[i].Actor, PrimaryBall))
		{
			...
			{
				__NFUN_185__(BallsLeft);
				// End:0xBB
				if(__NFUN_170__(BallsLeft, 0))
				{
					FlashMessage(BallsLeftMaterials[__NFUN_166__(BallsLeft, 1)], 2);
				}
				// End:0x111
				if(__NFUN_171__(BallsLeft, 0))
				{
					// End:0xE7
...
{
	// End:0x36
	if(__NFUN_172__(Score, highscore))
	{
...
final simulated function TriggerFunc_BallLeftTrack()
{
	...
	bAllowPlunger = __NFUN_170__(string(Balls), 0);
	TrackBlocker.StartActivateTimer(1);
	// End:0xA3
	if(__NFUN_145__(bMultiBall))
	{
		RightBlocker.Activate();
		RightBlocker.bActOnKImpact = false;
		__NFUN_607__(20, false, 'DisableRightBlocker');
...
final simulated function MoveBallToTrack(dnControlHelper_Pinball_Ball Ball)
{
	...
	Ball.__NFUN_645__(__NFUN_238__(Location, __NFUN_263__(TrackCenter, Rotation)));
...
simulated function AwardPoints(int Points)
{
	...
	mult = 1;
	// End:0x1D
	if(__NFUN_170__(ScoreMultiplier, 0))
	{
		mult = ScoreMultiplier;
	}
	__NFUN_180__(Score, __NFUN_162__(Points, mult));
	// End:0x6E
	if(__NFUN_170__(string(ScoreThreshholds), 0))
	{
		// End:0x6E
		if(__NFUN_172__(Score, ScoreThreshholds[CurrentThreshhold].ScoreThreshhold))
		{
			GlobalTrigger(ScoreThreshholds[__NFUN_184__(CurrentThreshhold)].ThreshholdEvent);
		}
	}
	// End:0x90
	if(bDebugScore)
	{
		BroadcastLog(__NFUN_302__("Score = ", string(Score)));
	}
	// End:0xF0
	if(__NFUN_170__(Score, highscore))
	{
		highscore = Score;
		// End:0xD2
		...
		// End:0xF0
		if(__NFUN_145__(bHasThrownHighScoreEvent))
		{
...
{
	// End:0x8D
	if(__NFUN_145__(bBallInGutter))
	{
		FindAndPlaySound('Pinball_Nudge');
		// End:0x31
		if(bTilted)
		{
			Dir = __NFUN_237__(Dir, 2);
		}
		PrimaryBall.__NFUN_790__(__NFUN_263__(Dir, Rotation), 3);
		// End:0x8D
		if(__NFUN_145__(bTilted))
		{
			__NFUN_605__(TiltDecayRate, false, 'TiltDecay');
			__NFUN_184__(NudgeCount);
			// End:0x8D
			if(__NFUN_170__(NudgeCount, NudgeMax))
			{
				// End:0x8D
				if(__NFUN_145__(bTurnOffTilt))
				{
					Tilt();
				}
			}
...
function LaunchBall()
{
	...
	{
		DesiredLoc.Target = __NFUN_238__(Location, __NFUN_263__(BallKeyframeLocation, Rotation));
		DesiredLoc.TimeTotal = __NFUN_196__(__NFUN_251__(__NFUN_239__(DesiredLoc.Target, PrimaryBall.Location)), BallLaunchVelocity);
		DesiredLoc.Style = 0;
...
state idle
{
	simulated function bool ControlEventInternal(optional int IntEvent, optional name CustomEventName)
	{
		...
		switch(IntEvent)
		{
			...
			case int(15):
				// End:0xAF
				if(__NFUN_145__(PlayerPawn(User).__NFUN_994__()))
				{
					// End:0xAC
					if(__NFUN_148__(__NFUN_145__(bLeftButton), __NFUN_145__(bTilted)))
					{
						i = __NFUN_166__(string(LeftFlippers), 1);
						J0x52:
				...
				{
					// End:0x130
					if(__NFUN_148__(__NFUN_145__(bRightButton), __NFUN_145__(bTilted)))
					{
						i = __NFUN_166__(string(RightFlippers), 1);
						J0xD6:
	...
	simulated function UsableSomethingQueryInteractKeyInfoState(HUD HUD)
	{
		...
		// End:0x7A
		if(__NFUN_170__(string(LeftFlippers), 0))
		{
			// End:0x63
		...
		// End:0xDB
		if(__NFUN_170__(string(RightFlippers), 0))
		{
			// End:0xC4
			if(__NFUN_149__(PlayerPawn(User).__NFUN_994__(), Level.__NFUN_1164__()))
			{
...
defaultproperties
{
	...
	PlungerPullSpeed=1
	TrackCenter=(X=1.291717E-41,Y=2.802848E-17,Z=-21)
	TrackExtent=(X=1.291717E-41,Y=2.802737E-17,Z=1)
	GutterCenter=(X=1.291717E-41,Y=2.802857E-17,Z=2)
	GutterExtent=(X=1.291717E-41,Y=2.80262E-17,Z=12)
	NudgeUpForce=(X=1.291717E-41,Y=2.813698E-17,Z=0)
	NudgeLeftForce=(X=1.291717E-41,Y=2.797242E-17,Z=25)
	NudgeRightForce=(X=1.291717E-41,Y=2.797242E-17,Z=-25)
	...
	BallsLeft=3
	bFirstTimePlay=true
	BallKeyframeLocation=(X=1.291717E-41,Y=2.813642E-17,Z=-21)
	...
	MountOnSpawn(10)=(bSkipVerifySelf=false,SpawnClass='dnControlHelper_Pinball_Flipper',SpawnChance=0,MountPrefab=(bDontActuallyMount=true,bHideable=false,bIndependentRotation=false,bIndependentLocation=false,bMatchParentLocation=false,bMatchParentRotation=false,bSurviveDismount=false,bDontScaleByDrawScale=false,bScaleByDrawScaleNonDefault=false,bTransformDrawScale3DChange=false,bTakeParentTag=false,bTransferToCorpse=false,bDontSetOwner=false,MountParentTag=None,DrawScaleOverride=0,AppendToTag=None,ForceTag=PB_LEFT_FLIPPER,ForceEvent=None,MountMeshItem=None,MountOrigin=(X=1.291717E-41,Y=2.802851E-17,Z=9),Z=7),MountOriginVariance=(X=1.291717E-41,Y=2.797242E-17,Z=0),Z=0)
	MountOnSpawn(11)=(MountAngles=(Pitch=8709,Yaw=571080704,Roll=-16384),Roll=0)
	...
	MountOnSpawn(15)=(bSkipVerifySelf=false,SpawnClass='dnControlHelper_Pinball_Flipper',SpawnChance=0,MountPrefab=(bDontActuallyMount=true,bHideable=false,bIndependentRotation=false,bIndependentLocation=false,bMatchParentLocation=false,bMatchParentRotation=false,bSurviveDismount=false,bDontScaleByDrawScale=false,bScaleByDrawScaleNonDefault=false,bTransformDrawScale3DChange=false,bTakeParentTag=false,bTransferToCorpse=false,bDontSetOwner=false,MountParentTag=None,DrawScaleOverride=0,AppendToTag=None,ForceTag=PB_LEFT_FLIPPER,ForceEvent=None,MountMeshItem=None,MountOrigin=(X=1.291717E-41,Y=2.80279E-17,Z=18),Z=7),MountOriginVariance=(X=1.291717E-41,Y=2.797242E-17,Z=0),Z=0)
	MountOnSpawn(16)=(MountAngles=(Pitch=8709,Yaw=571080704,Roll=-16384),Roll=0)
	...
	MountOnSpawn(20)=(bSkipVerifySelf=false,SpawnClass='dnControlHelper_Pinball_Flipper',SpawnChance=0,MountPrefab=(bDontActuallyMount=true,bHideable=false,bIndependentRotation=false,bIndependentLocation=false,bMatchParentLocation=false,bMatchParentRotation=false,bSurviveDismount=false,bDontScaleByDrawScale=false,bScaleByDrawScaleNonDefault=false,bTransformDrawScale3DChange=false,bTakeParentTag=false,bTransferToCorpse=false,bDontSetOwner=false,MountParentTag=None,DrawScaleOverride=0,AppendToTag=None,ForceTag=PB_RIGHT_FLIPPER,ForceEvent=None,MountMeshItem=None,MountOrigin=(X=1.291717E-41,Y=2.802851E-17,Z=-5),Z=7),MountOriginVariance=(X=1.291717E-41,Y=2.797242E-17,Z=0),Z=0)
	MountOnSpawn(21)=(MountAngles=(Pitch=8709,Yaw=571080704,Roll=16384),Roll=0)
	MountOnSpawn(22)=(MountAnglesVariance=(Pitch=8709,Yaw=571080704,Roll=0),Roll=0)
	MountOnSpawn(23)=(MountType=0,DismountPhysics=0)
	MountOnSpawn(24)=(RenderObject=none,DrawScale=0)
	MountOnSpawn(25)=(bSkipVerifySelf=false,SpawnClass='dnControlHelper_Pinball_BallGate',SpawnChance=0,MountPrefab=(bDontActuallyMount=true,bHideable=false,bIndependentRotation=false,bIndependentLocation=false,bMatchParentLocation=false,bMatchParentRotation=false,bSurviveDismount=false,bDontScaleByDrawScale=false,bScaleByDrawScaleNonDefault=false,bTransformDrawScale3DChange=false,bTakeParentTag=false,bTransferToCorpse=false,bDontSetOwner=false,MountParentTag=None,DrawScaleOverride=0,AppendToTag=None,ForceTag=BallGateRight,ForceEvent=None,MountMeshItem=None,MountOrigin=(X=1.47066E-38,Y=2.81364E-17,Z=-11.00185),Z=9),MountOriginVariance=(X=1.291717E-41,Y=2.797242E-17,Z=0),Z=0)
	MountOnSpawn(26)=(MountAngles=(Pitch=8709,Yaw=571080704,Roll=0),Roll=0)
	MountOnSpawn(27)=(MountAnglesVariance=(Pitch=8709,Yaw=571080704,Roll=0),Roll=0)
	MountOnSpawn(28)=(MountType=0,DismountPhysics=0)
	MountOnSpawn(29)=(RenderObject=none,DrawScale=0)
	MountOnSpawn(30)=(bSkipVerifySelf=false,SpawnClass='dnControlHelper_Pinball_BallGate',SpawnChance=0,MountPrefab=(bDontActuallyMount=true,bHideable=false,bIndependentRotation=false,bIndependentLocation=false,bMatchParentLocation=false,bMatchParentRotation=false,bSurviveDismount=false,bDontScaleByDrawScale=false,bScaleByDrawScaleNonDefault=false,bTransformDrawScale3DChange=false,bTakeParentTag=false,bTransferToCorpse=false,bDontSetOwner=false,MountParentTag=None,DrawScaleOverride=0,AppendToTag=None,ForceTag=BallGateRight,ForceEvent=None,MountMeshItem=None,MountOrigin=(X=5.294891E-38,Y=2.81364E-17,Z=12.99811),Z=9),MountOriginVariance=(X=1.291717E-41,Y=2.797242E-17,Z=0),Z=0)
	MountOnSpawn(31)=(MountAngles=(Pitch=8709,Yaw=571080704,Roll=0),Roll=0)
	MountOnSpawn(32)=(MountAnglesVariance=(Pitch=8709,Yaw=571080704,Roll=0),Roll=0)
	MountOnSpawn(33)=(MountType=0,DismountPhysics=0)
	MountOnSpawn(34)=(RenderObject=none,DrawScale=0)
	MountOnSpawn(35)=(bSkipVerifySelf=false,SpawnClass='dnControlHelper_Pinball_Ball',SpawnChance=0,MountPrefab=(bDontActuallyMount=true,bHideable=false,bIndependentRotation=false,bIndependentLocation=false,bMatchParentLocation=false,bMatchParentRotation=false,bSurviveDismount=false,bDontScaleByDrawScale=false,bScaleByDrawScaleNonDefault=false,bTransformDrawScale3DChange=false,bTakeParentTag=false,bTransferToCorpse=false,bDontSetOwner=false,MountParentTag=None,DrawScaleOverride=0,AppendToTag=None,ForceTag=PRIMARY_BALL,ForceEvent=None,MountMeshItem=None,MountOrigin=(X=1.291717E-41,Y=2.802848E-17,Z=-21),Z=8),MountOriginVariance=(X=1.291717E-41,Y=2.797242E-17,Z=0),Z=0)
	MountOnSpawn(36)=(MountAngles=(Pitch=8709,Yaw=571080704,Roll=0),Roll=0)
	MountOnSpawn(37)=(MountAnglesVariance=(Pitch=8709,Yaw=571080704,Roll=0),Roll=0)
