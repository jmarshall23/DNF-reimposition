/*******************************************************************************
 * Barrels_Generic_Explosive_FireExt generated by Eliot.UELib using UE Explorer.exe.
...
defaultproperties
{
    ...
    bGrabbable=false
    DestroyedParticleFriendEffects(0)=(bAbsoluteLocation=false,bAbsoluteRotation=false,Scale=0,BoneName=None,Location=(X=0,Y=0,Z=0),Rotation=(Pitch=0,Yaw=0,Roll=0),Effect='p_Decorations.FireExtinguisher.FireExtinguisher_Explode_Main')
