/*******************************************************************************
 * Settings_Bathroom_ToiletPaper_HolderRoll generated by Eliot.UELib using UELib.CLI.
...
{
	// End:0x3B
	if(__NFUN_148__(__NFUN_340__(Owner, none), Owner.bBlockKarma))
	{
...
final function AddSpin()
{
	...
	__NFUN_791__(__NFUN_263__(__NFUN_232__(0, 0, -8), Rotation), 3);
	return;
}
