/*******************************************************************************
 * acDetails_Generic_BBallHoop_Net generated by Eliot.UELib using UE Explorer.exe.
 * Eliot.UELib ? 2009-2022 Eliot van Uytfanghe. All rights reserved.
 * http://eliotvu.com
 *
 * All rights belong to their respective owners.
 *******************************************************************************/
class acDetails_Generic_BBallHoop_Net extends dnAnimationControllerEx;
...
defaultproperties
{
    ...
    AnimChannels(1)=(ChannelName=Swish,ChannelGroupName=None,ChannelBlendOp=3,LastBlendAlpha=0,LastAnimLink=0,LastAnimControllerLink=none,ParentBlockChannelLink=0,bActAsGroup=false,GroupCrossfadeTime=0,PrimaryChannelIndex=0,FadeRates=0,FadeRates[1]=0,FadeRates[2]=0,FadeRates[3]=0,FadeRates[4]=0,FadeRates[5]=0,FadeRates[6]=0,FadeRates[7]=0,FadeRates[8]=0,FadeRates[9]=0,FadeRates[10]=0,FadeRates[11]=0,FadeRates[12]=0,FadeRates[13]=0,FadeRates[14]=0,FadeRates[15]=0,FadeRates[16]=0,FadeRates[17]=0,FadeRates[18]=0,FadeRates[19]=0,FadeRates[20]=0,FadeRates[21]=0,FadeRates[22]=0,FadeRates[23]=0,NumFadingOut=0,LastCrossfadeRate=0,bMovementActive=false)
    Animations(0)=(AnimationName=Swish,AnimationChannel=(ChannelName=Swish,ChannelLink=0,bLinkedToBlock=false),AnimSequence=a_swish,AnimStartingFrame=0,AnimRate=0,AnimRateVariance=0,AnimTween=0,AnimDefaultBlendAlpha=0,AnimEarlyEndTime=0,bLoopAnim=false,bInterrupt=false,bNoRemoveAnim=false,bBatchAnim=false,bAdjustStart=false,AnimBlendInInfo=(BlendTotalTime=0,StartingBlendAlpha=0,EndingBlendAlpha=0),AnimBlendOutInfo=(BlendTotalTime=0,StartingBlendAlpha=0,EndingBlendAlpha=0),AnimStart_FunctionCallName=None,AnimEnd_NextAnimStateName=None,AnimEnd_FunctionCallName=None,AnimEnd_Event=None,GroupCrossfadeOverride=0,bForceCrossfade=false,bIs3DGrid=false,AnimGridLink=0)
    AnimationGrids(0)=(AnimationGridName=IdleGrid,AnimationChannel=(ChannelName=Base,ChannelLink=0,bLinkedToBlock=false),AnimGridSequence=a_grid,bIs3DGrid=false,AnimationLink=0)
}