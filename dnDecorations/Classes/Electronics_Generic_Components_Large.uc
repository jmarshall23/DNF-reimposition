...
defaultproperties
{
	...
	SpawnOnDestroyed(5)=(BoneName=None,MotionInfo='Engine.RenderActor.MP_NoMotion')
	CollisionHeight=56
	StaticMesh='sm_class_decorations.Electronics.electronic_components3'
}