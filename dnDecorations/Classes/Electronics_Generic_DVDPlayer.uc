...
defaultproperties
{
	NoMovieInfo=(ShowSmack='dt_Props.Dvdinfo.dvdstartRC',ShowSound=(bAllowRepeats=false,bPlayAsAmbient=false,MixerGroupOverride=None,SimpleSingleSound=none,Sounds=/* Array type was not detected. */),SlotPriority=0,VolumePrefab=8,Slots=/* Array type was not detected. */)
	OpenTrayInfo=(ShowSmack='dt_Props.Dvdinfo.dvdopenRC',ShowSound=(bAllowRepeats=false,bPlayAsAmbient=false,MixerGroupOverride=None,SimpleSingleSound=none,Sounds=/* Array type was not detected. */),SlotPriority=0,VolumePrefab=8,Slots=/* Array type was not detected. */)
	LoadingInfo=(ShowSmack='dt_Props.Dvdinfo.dvdloadRC',ShowSound=(bAllowRepeats=false,bPlayAsAmbient=false,MixerGroupOverride=None,SimpleSingleSound=none,Sounds=/* Array type was not detected. */),SlotPriority=0,VolumePrefab=8,Slots=/* Array type was not detected. */)
	TrayLoadTime=1.5
