/*******************************************************************************
 * Biology_Generic_AnusDoor generated by Eliot.UELib using UELib.CLI.
...
event TakeDamage(Pawn Instigator, float Damage, Vector DamageOrigin, Vector DamageDirection, class<DamageType> DamageType, optional name HitBoneName, optional Vector DamageStart)
{
	...
	// End:0x5B
	if(__NFUN_148__(__NFUN_148__(bUsable, __NFUN_201__(Damage, 0)), __NFUN_357__(DamageType, class'MeleeDamage')))
	{
...
{
	// End:0x5C
	if(__NFUN_150__(__NFUN_150__(bLocked, User.bOnSteroids), __NFUN_148__(__NFUN_340__(User.Weapon, none), __NFUN_173__(int(User.Weapon.WeaponState), int(10)))))
	{
		return false;
	}
...
event Touch(Actor Other)
{
	...
	// End:0x46
	if(__NFUN_148__(__NFUN_148__(bAutoOpenForAI, Other.bIsPawn), __NFUN_145__(Other.bIsPlayerPawn)))
	{
		TriggerFunc_OpenAnus();
	}
	return;
...
final function TryPerformClose()
{
	...
	// End:0x61
	if(__NFUN_150__(__NFUN_150__(__NFUN_150__(__NFUN_145__(bInitialized), __NFUN_174__(int(AnusState), int(2))), __NFUN_170__(string(Touching), 0)), __NFUN_340__(Sensor.CurrentlySensingPawn, none)))
	{
