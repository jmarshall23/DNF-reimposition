...
defaultproperties
{
	...
	DecoActivities_Default(4)=(ActivityData=(bInitialized=false,CurrentIndex=0,NextPerformTime=0,NextPerformTime_Failure=0),ActivityIDScript=none,ActivityID=(3),ActivityMethod=0,ActivityStates_Success=(1),ActivityStates_Failure=none,ActivityDebugID="",Activities=((ActivityRules=none,ActivityElements=(DecoActivities_KarmaImpulse'Lights_Generic_DeskLamp_Mounted_A.DA_KImpulse_Lights_Generic_DeskLamp_Mounted_A_Nudge'),ActivitySetup=(bDisabled=false,bPerformedThisRound=false,PerformedCounter=0,LoopCount=0,PerformAgainDelay=0),FailureActivityElements=none,FailureActivitySetup=(bDisabled=false,bPerformedThisRound=false,PerformedCounter=0,LoopCount=0,PerformAgainDelay=0))),bDisabled=false)
	...
	begin object name=DA_Display_Lights_Generic_DeskLamp_Mounted_A_Brkn class=DecoActivities_Display
		RenderObject='c_generic.DeskLamp1_brkn'
		Skins(0)=(Index=0,NewMaterialEx=none)
	object end
	// Reference: DecoActivities_Display'Lights_Generic_DeskLamp_Mounted_A.DA_Display_Lights_Generic_DeskLamp_Mounted_A_Brkn'
	DestroyedActivities(5)=DA_Display_Lights_Generic_DeskLamp_Mounted_A_Brkn
	MountOnSpawn(0)=(bSkipVerifySelf=true,SpawnClass='Lights_Generic_DeskLamp_Mounted_LightEx',SpawnChance=0,MountPrefab=(bDontActuallyMount=false,bHideable=false,bIndependentRotation=false,bIndependentLocation=false,bMatchParentLocation=false,bMatchParentRotation=false,bSurviveDismount=false,bDontScaleByDrawScale=false,bScaleByDrawScaleNonDefault=false,bTransformDrawScale3DChange=false,bTakeParentTag=false,bTransferToCorpse=false,bDontSetOwner=false,MountParentTag=None,DrawScaleOverride=0,AppendToTag=None,ForceTag=MyLight,ForceEvent=None,MountMeshItem=Head,MountOrigin=(X=1.291717E-41,Y=2.797242E-17,Z=0),Z=0),MountOriginVariance=(X=1.291717E-41,Y=2.797242E-17,Z=0),Z=0)
	KLinearDamping=0.999999
	KAngularDamping=0.999999
	Physics=18
	CollisionRadius=18
	CollisionHeight=14.8
	Mass=20
	DrawType=2
	Mesh='c_generic.DeskLamp1'
}