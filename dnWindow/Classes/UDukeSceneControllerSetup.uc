/*******************************************************************************
 * UDukeSceneControllerSetup generated by Eliot.UELib using UELib.CLI.
...
function Paint(Canvas C, float X, float Y)
{
	...
	VerticalSensitivity.ArrowLeft = __NFUN_199__(float(ButtonWidth), __NFUN_195__(float(100), WinScaleY));
	HorizontalSensitivity.ArrowLeft = __NFUN_199__(float(ButtonWidth), __NFUN_195__(float(100), WinScaleY));
	...
	C.__NFUN_1250__(__NFUN_199__(__NFUN_199__(__NFUN_198__(ButtonLayoutButton.WinLeft, ButtonLayoutButton.WinWidth), __NFUN_195__(float(60), WinScaleY)), __NFUN_196__(XL, float(2))), ButtonLayoutButton.WinTop);
	C.__NFUN_1232__(str, false, false, false, TTFontScale, TTFontScale, FadeAlpha, 2);
	VerticalSensitivity.WinLeft = float(ButtonLeft);
	VerticalSensitivity.WinTop = __NFUN_198__(__NFUN_198__(ButtonLayoutButton.WinTop, ButtonLayoutButton.WinHeight), float(ControlBuffer));
	HorizontalSensitivity.WinLeft = float(ButtonLeft);
	HorizontalSensitivity.WinTop = __NFUN_198__(__NFUN_198__(VerticalSensitivity.WinTop, VerticalSensitivity.WinHeight), float(ControlBuffer));
	// End:0x3E2
	if(__NFUN_145__(__NFUN_402__()))
	{
		Vibration.WinLeft = float(ButtonLeft);
		Vibration.WinTop = __NFUN_198__(__NFUN_198__(HorizontalSensitivity.WinTop, HorizontalSensitivity.WinHeight), float(ControlBuffer));
	}
	SwapJoysticks.WinLeft = float(ButtonLeft);
	// End:0x43B
	if(__NFUN_145__(__NFUN_402__()))
	{
		SwapJoysticks.WinTop = __NFUN_198__(__NFUN_198__(Vibration.WinTop, Vibration.WinHeight), float(ControlBuffer));		
	}
	else
	{
		SwapJoysticks.WinTop = __NFUN_198__(__NFUN_198__(HorizontalSensitivity.WinTop, HorizontalSensitivity.WinHeight), float(ControlBuffer));
	}
	// End:0x563
	if(__NFUN_414__())
	{
		ToggleCrouch.WinLeft = float(ButtonLeft);
		ToggleCrouch.WinTop = __NFUN_198__(__NFUN_198__(SwapJoysticks.WinTop, SwapJoysticks.WinHeight), float(ControlBuffer));
...
function SaveConfigs()
{
	...
	setting = __NFUN_166__(int(HorizontalSensitivity.SelectedItem.Text), 1);	
	GetPlayerOwner().ConsoleCommand(__NFUN_303__("setnosave PlayerPawn LookSensitivityH", string(setting)));
	setting = __NFUN_166__(int(VerticalSensitivity.SelectedItem.Text), 1);	
