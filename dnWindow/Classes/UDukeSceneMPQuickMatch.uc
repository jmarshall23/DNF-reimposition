/*******************************************************************************
 * UDukeSceneMPQuickMatch generated by Eliot.UELib using UELib.CLI.
...
{
	super.Created();
	MapSelect.ArrowPadding = __NFUN_196__(class'UDukeListSlider'.default.ArrowPadding, 2);
...
function Paint(Canvas C, float X, float Y)
{
	...
	ModeSelect.WinTop = __NFUN_198__(__NFUN_198__(__NFUN_198__(MapSelect.WinTop, MapSelect.WinHeight), float(ControlBuffer)), float(ButtonHeight));
	MutatorSelect.WinLeft = float(ButtonLeft);
	MutatorSelect.WinTop = __NFUN_198__(__NFUN_198__(ModeSelect.WinTop, ModeSelect.WinHeight), float(ControlBuffer));
	return;
}
