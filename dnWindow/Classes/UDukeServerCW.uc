/*******************************************************************************
 * UDukeServerCW generated by Eliot.UELib using UELib.CLI.
...
function BeforePaint(Canvas C, float X, float Y)
{
	...
	CColLeft = __NFUN_166__(int(__NFUN_196__(WinWidth, float(2))), 51);
	CColRight = __NFUN_166__(int(__NFUN_196__(WinWidth, float(2))), 44);
	GameCombo.SetSize(200, GameCombo.WinHeight);
	GameCombo.WinLeft = float(CColRight);
	GameCombo.EditBoxWidth = 200;
	GameCombo.WinTop = 10;
	GameLabel.AutoSize(C);
	GameLabel.WinLeft = __NFUN_199__(float(CColLeft), GameLabel.WinWidth);
	...
	MapCombo.WinTop = 10;
	MapLabel.AutoSize(C);
	MapLabel.WinLeft = __NFUN_199__(float(CColLeft), MapLabel.WinWidth);
	MapLabel.WinTop = __NFUN_198__(GameCombo.WinTop, float(8));
	return;
}
