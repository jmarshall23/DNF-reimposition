/*******************************************************************************
 * UDukeLoginMenuCW generated by Eliot.UELib using UELib.CLI.
...
function BeforePaint(Canvas C, float X, float Y)
{
	...
	SpectateButton.WinTop = __NFUN_198__(__NFUN_198__(JoinButton.WinTop, JoinButton.WinHeight), float(5));
	JoinTeam1Button.AutoSize(C);
	JoinTeam1Button.WinLeft = 25;
	JoinTeam1Button.WinTop = __NFUN_198__(__NFUN_198__(SpectateButton.WinTop, SpectateButton.WinHeight), float(5));
	JoinTeam2Button.AutoSize(C);
	JoinTeam2Button.WinLeft = 25;
	JoinTeam2Button.WinTop = __NFUN_198__(__NFUN_198__(JoinTeam1Button.WinTop, JoinTeam1Button.WinHeight), float(5));
	// End:0x1A7
	...
	switch(E)
	{
		...
		case 2:
			switch(C)
			{
				...
				case JoinButton:
					// End:0x69
					if(__NFUN_145__(JoinButton.bDisabled))
					{
