/*******************************************************************************
 * UDukeTeamDMRulesCW generated by Eliot.UELib using UELib.CLI.
...
function BeforePaintOther(Canvas C, float X, float Y, int Left, int Right, int Top, int CenterWidth)
{
	...
	ForceTeamBalanceLabel.WinLeft = __NFUN_199__(__NFUN_199__(ForceTeamBalanceCheck.WinLeft, float(14)), ForceTeamBalanceLabel.WinWidth);
	ForceTeamBalanceLabel.WinTop = __NFUN_198__(ForceTeamBalanceCheck.WinTop, float(10));
	...
	FriendlyFireLabel.WinLeft = __NFUN_199__(__NFUN_199__(FriendlyFireCheck.WinLeft, float(14)), FriendlyFireLabel.WinWidth);
	FriendlyFireLabel.WinTop = __NFUN_198__(FriendlyFireCheck.WinTop, float(10));
	NextControlTop = __NFUN_198__(__NFUN_198__(FriendlyFireLabel.WinTop, FriendlyFireLabel.WinHeight), float(10));
	return;
}
