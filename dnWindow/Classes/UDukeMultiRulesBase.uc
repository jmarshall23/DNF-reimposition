/*******************************************************************************
 * UDukeMultiRulesBase generated by Eliot.UELib using UELib.CLI.
...
function SetupNetworkOptions()
{
	...
	ControlWidth = int(__NFUN_196__(WinWidth, 2.5));
	ControlLeft = __NFUN_163__(int(__NFUN_199__(__NFUN_196__(WinWidth, float(2)), float(ControlWidth))), 2);
	ControlRight = int(__NFUN_198__(__NFUN_196__(WinWidth, float(2)), float(ControlLeft)));
	CenterWidth = __NFUN_162__(int(__NFUN_196__(WinWidth, float(4))), 3);
	CenterPos = __NFUN_163__(int(__NFUN_199__(WinWidth, float(CenterWidth))), 2);
...
function BeforePaint(Canvas C, float X, float Y)
{
	...
	YOff = __NFUN_198__(__NFUN_198__(TimeEdit.WinTop, TimeEdit.WinHeight), float(5));
	...
	MaxPlayersLabel.WinLeft = __NFUN_199__(__NFUN_199__(FragEdit.WinLeft, float(14)), MaxPlayersLabel.WinWidth);
	...
	MaxSpectatorsLabel.WinLeft = __NFUN_199__(__NFUN_199__(TimeEdit.WinLeft, float(14)), MaxSpectatorsLabel.WinWidth);
	MaxSpectatorsLabel.WinTop = __NFUN_198__(MaxSpectatorsEdit.WinTop, float(8));
	__NFUN_209__(YOff, __NFUN_198__(MaxSpectatorsEdit.WinHeight, float(5)));
	...
	WarmupTimeLabel.WinLeft = __NFUN_199__(__NFUN_199__(FragEdit.WinLeft, float(14)), MaxPlayersLabel.WinWidth);
	WarmupTimeLabel.WinTop = __NFUN_198__(WarmupTimeEdit.WinTop, float(8));
	...
	RoundTimeLabel.WinLeft = __NFUN_199__(__NFUN_199__(TimeEdit.WinLeft, float(14)), MaxSpectatorsLabel.WinWidth);
	RoundTimeLabel.WinTop = __NFUN_198__(RoundTimeEdit.WinTop, float(8));
	__NFUN_209__(YOff, __NFUN_198__(WarmupTimeEdit.WinHeight, float(5)));
	...
	WeaponsLabel.WinLeft = __NFUN_199__(__NFUN_199__(FragEdit.WinLeft, float(14)), WeaponsLabel.WinWidth);
	WeaponsLabel.WinTop = __NFUN_198__(WeaponsCheck.WinTop, float(10));
	...
	MapCycleCheck.WinTop = __NFUN_198__(__NFUN_198__(WeaponsCheck.WinTop, WeaponsCheck.WinHeight), float(5));
	MapCycleLabel.WinLeft = __NFUN_199__(__NFUN_199__(TimeEdit.WinLeft, float(14)), MapCycleLabel.WinWidth);
	MapCycleLabel.WinTop = __NFUN_198__(MapCycleCheck.WinTop, float(10));
	...
	DoUplinkCheck.WinTop = __NFUN_198__(__NFUN_198__(MapCycleCheck.WinTop, MapCycleCheck.WinHeight), float(5));
	DoUplinkLabel.WinLeft = __NFUN_199__(__NFUN_199__(FragEdit.WinLeft, float(14)), DoUplinkLabel.WinWidth);
	DoUplinkLabel.WinTop = __NFUN_198__(DoUplinkCheck.WinTop, float(10));
	...
	LanPlayCheck.WinTop = __NFUN_198__(__NFUN_198__(MapCycleCheck.WinTop, MapCycleCheck.WinHeight), float(5));
	LanPlayLabel.WinLeft = __NFUN_199__(__NFUN_199__(TimeEdit.WinLeft, float(14)), LanPlayLabel.WinWidth);
	LanPlayLabel.WinTop = __NFUN_198__(LanPlayCheck.WinTop, float(10));
	NextControlTop = __NFUN_198__(__NFUN_198__(DoUplinkCheck.WinTop, DoUplinkCheck.WinHeight), float(5));
	...
	AdminEMailEdit.WinLeft = float(__NFUN_166__(CColRight, 80));
	AdminEMailEdit.WinTop = NextControlTop;
	AdminEMailLabel.AutoSize(C);
	AdminEMailLabel.WinLeft = __NFUN_199__(__NFUN_199__(float(CColLeft), AdminEMailLabel.WinWidth), float(80));
	AdminEMailLabel.WinTop = __NFUN_198__(AdminEMailEdit.WinTop, float(8));
	AdminNameEdit.SetSize(280, AdminNameEdit.WinHeight);
	AdminNameEdit.WinLeft = float(__NFUN_166__(CColRight, 80));
	AdminNameEdit.WinTop = __NFUN_198__(__NFUN_198__(AdminEMailEdit.WinTop, AdminEMailEdit.WinHeight), float(5));
	AdminNameLabel.AutoSize(C);
	AdminNameLabel.WinLeft = __NFUN_199__(__NFUN_199__(float(CColLeft), AdminNameLabel.WinWidth), float(80));
	AdminNameLabel.WinTop = __NFUN_198__(AdminNameEdit.WinTop, float(8));
	MOTDLine1Edit.SetSize(280, MOTDLine1Edit.WinHeight);
	MOTDLine1Edit.WinLeft = float(__NFUN_166__(CColRight, 80));
	MOTDLine1Edit.WinTop = __NFUN_198__(__NFUN_198__(AdminNameEdit.WinTop, AdminNameEdit.WinHeight), float(5));
	MOTDLine1Label.AutoSize(C);
	MOTDLine1Label.WinLeft = __NFUN_199__(__NFUN_199__(float(CColLeft), MOTDLine1Label.WinWidth), float(80));
	MOTDLine1Label.WinTop = __NFUN_198__(MOTDLine1Edit.WinTop, float(8));
	MOTDLine2Edit.SetSize(280, MOTDLine2Edit.WinHeight);
	MOTDLine2Edit.WinLeft = float(__NFUN_166__(CColRight, 80));
	MOTDLine2Edit.WinTop = __NFUN_198__(__NFUN_198__(MOTDLine1Edit.WinTop, MOTDLine1Edit.WinHeight), float(5));
	MOTDLine2Label.AutoSize(C);
	MOTDLine2Label.WinLeft = __NFUN_199__(__NFUN_199__(float(CColLeft), MOTDLine2Label.WinWidth), float(80));
	MOTDLine2Label.WinTop = __NFUN_198__(MOTDLine2Edit.WinTop, float(8));
	MOTDLine3Edit.SetSize(280, MOTDLine3Edit.WinHeight);
	MOTDLine3Edit.WinLeft = float(__NFUN_166__(CColRight, 80));
	MOTDLine3Edit.WinTop = __NFUN_198__(__NFUN_198__(MOTDLine2Edit.WinTop, MOTDLine2Edit.WinHeight), float(5));
	MOTDLine3Label.AutoSize(C);
	MOTDLine3Label.WinLeft = __NFUN_199__(__NFUN_199__(float(CColLeft), MOTDLine3Label.WinWidth), float(80));
	MOTDLine3Label.WinTop = __NFUN_198__(MOTDLine3Edit.WinTop, float(8));
	MOTDLine4Edit.SetSize(280, MOTDLine4Edit.WinHeight);
	MOTDLine4Edit.WinLeft = float(__NFUN_166__(CColRight, 80));
	MOTDLine4Edit.WinTop = __NFUN_198__(__NFUN_198__(MOTDLine3Edit.WinTop, MOTDLine3Edit.WinHeight), float(5));
	MOTDLine4Label.AutoSize(C);
	MOTDLine4Label.WinLeft = __NFUN_199__(__NFUN_199__(float(CColLeft), MOTDLine4Label.WinWidth), float(80));
	MOTDLine4Label.WinTop = __NFUN_198__(MOTDLine4Edit.WinTop, float(8));
	ServerNameEdit.SetSize(280, ServerNameEdit.WinHeight);
	ServerNameEdit.WinLeft = float(__NFUN_166__(CColRight, 80));
	ServerNameEdit.WinTop = __NFUN_198__(__NFUN_198__(MOTDLine4Edit.WinTop, MOTDLine4Edit.WinHeight), float(5));
	...
	DesiredHeight = __NFUN_198__(__NFUN_198__(ServerNameEdit.WinTop, ServerNameEdit.WinHeight), float(10));
	NextControlTop = -1;
	return;
}
