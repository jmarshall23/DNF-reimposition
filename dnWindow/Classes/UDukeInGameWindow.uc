/*******************************************************************************
 * UDukeInGameWindow generated by Eliot.UELib using UELib.CLI.
...
function Created()
{
	...
	TopButton.xOffset = __NFUN_195__(__NFUN_196__(20, 1024), XMod);
	...
	if(__NFUN_169__(i, NumOptions))
	{
		...
		OptionButtons[i].xOffset = __NFUN_195__(__NFUN_196__(20, 1024), XMod);
	...
	BottomButton.xOffset = __NFUN_195__(__NFUN_196__(20, 1024), XMod);
...
function BeforePaint(Canvas C, float X, float Y)
{
	...
	YPos = __NFUN_195__(__NFUN_196__(164, 720), YMod);
	TopButton.SetSize(XWidth, YHeight);
	TopButton.xOffset = __NFUN_195__(__NFUN_196__(20, 960), XMod);
	...
	if(__NFUN_169__(i, NumOptions))
	{
		...
		OptionButtons[i].xOffset = __NFUN_195__(__NFUN_196__(20, 960), XMod);
		OptionButtons[i].WinLeft = xOffset;
		OptionButtons[i].WinTop = __NFUN_198__(YPos, __NFUN_195__(__NFUN_195__(__NFUN_196__(32, 720), YMod), float(__NFUN_165__(i, 1))));
		__NFUN_184__(i);
		// [Loop Continue]
		goto J0x188;
	}
	BottomButton.SetSize(XWidth, YHeight);
	BottomButton.xOffset = __NFUN_195__(__NFUN_196__(20, 960), XMod);
	BottomButton.WinLeft = xOffset;
	BottomButton.WinTop = __NFUN_198__(YPos, __NFUN_195__(__NFUN_195__(__NFUN_196__(32, 720), YMod), float(__NFUN_165__(NumOptions, 1))));
	return;
}
...
function SlideInWindow()
{
	...
	XMod = __NFUN_195__(4, float(W));
	YMod = __NFUN_195__(3, float(h));
	xOffset = __NFUN_195__(__NFUN_196__(-256, 1024), XMod);
	bSlideIn = true;
	bSlideOut = false;
	ShowWindow();
	IdentifyTarget = none;
...
function Tick(float Delta)
{
	...
	if(bSlideIn)
	{
		__NFUN_209__(xOffset, __NFUN_195__(Delta, float(800)));
		// End:0xB4
		if(__NFUN_203__(xOffset, float(0)))
		{
			xOffset = 0;
			bSlideIn = false;
		}
	...
	if(bSlideOut)
	{
		__NFUN_210__(xOffset, __NFUN_195__(Delta, float(800)));
		// End:0x17A
		if(__NFUN_202__(xOffset, __NFUN_195__(__NFUN_196__(-256, 1024), XMod)))
		{
			xOffset = __NFUN_195__(__NFUN_196__(-256, 1024), XMod);
			bSlideOut = false;
			// End:0x174
	...
	if(bFadeIn)
	{
		__NFUN_209__(FadeFactor, __NFUN_195__(Delta, float(700)));
		// End:0x1B5
		if(__NFUN_201__(FadeFactor, float(100)))
		{
			FadeFactor = 100;
			bFadeIn = false;
		}
	...
	if(bFadeOut)
	{
		__NFUN_210__(FadeFactor, __NFUN_195__(Delta, float(700)));
		// End:0x1F5
