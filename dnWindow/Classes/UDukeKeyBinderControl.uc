/*******************************************************************************
 * UDukeKeyBinderControl generated by Eliot.UELib using UELib.CLI.
...
{
	// End:0x50
	if(__NFUN_145__(bPolling))
	{
		// End:0x3D
		if(__NFUN_200__(X, __NFUN_199__(WinWidth, __NFUN_195__(float(20), WinScaleY))))
		{
...
function ProcessMenuKey(int KeyNo)
{
	...
	// End:0x114
	if(__NFUN_150__(__NFUN_150__(__NFUN_150__(__NFUN_150__(__NFUN_173__(KeyNo, int(Root.Console.91)), __NFUN_173__(KeyNo, int(Root.Console.92))), __NFUN_173__(KeyNo, int(Root.Console.236))), __NFUN_173__(KeyNo, int(Root.Console.237))), __NFUN_173__(KeyNo, int(Root.Console.19))))
	{
		return;
	}
	StopPolling();
	...
	if(__NFUN_309__(KeyName, ""))
	{
		...
		if(__NFUN_309__(Alias, ""))
		{
			...
			if(__NFUN_170__(pos, -1))
			{
				...
				Alias = __NFUN_302__(__NFUN_317__(Alias, pos), __NFUN_318__(Alias, __NFUN_166__(__NFUN_166__(__NFUN_166__(__NFUN_314__(Alias), pos), __NFUN_314__(AliasNames[Index])), 1)));
			}
			J0x125:

			pos = __NFUN_315__(Alias, "|");
			// End:0x15E
			if(__NFUN_173__(pos, 1))
			{
				Alias = __NFUN_318__(Alias, __NFUN_166__(__NFUN_314__(Alias), 3));				
			}
			else
			{
				// End:0x18D
				if(__NFUN_173__(pos, __NFUN_166__(__NFUN_314__(Alias), 2)))
				{
					Alias = __NFUN_317__(Alias, __NFUN_166__(pos, 1));					
				}
				else
				{
					// End:0x1DB
					if(__NFUN_170__(pos, -1))
					{
						Cmd = __NFUN_327__(__NFUN_317__(Alias, pos), true, true);
						Alias = __NFUN_327__(__NFUN_318__(Alias, __NFUN_166__(__NFUN_166__(__NFUN_314__(Alias), pos), 1)), true);						
					}
					else
					{
					...
					// End:0x232
					if(__NFUN_145__(__NFUN_310__(Cmd, AliasNames[Index])))
					{
						// End:0x21E
						if(__NFUN_308__(NewCmd, ""))
						{
							NewCmd = Cmd;							
						}
						else
						{							
							__NFUN_312__(NewCmd, __NFUN_303__("|", Cmd));
						}
					}
				}
			}
...
function SetKey(int KeyNo)
{
	...
	// End:0x18
	if(__NFUN_173__(int(BoundKeys[SelectedIndex]), KeyNo))
	{
		return;
	}
	// End:0x64
...
function ForceSetKey(int Index, int KeyNo)
{
	...
	if(__NFUN_309__(KeyName, ""))
	{
		...
		if(__NFUN_309__(Alias, ""))
		{
			...
			if(__NFUN_170__(pos, -1))
			{
				Cmd = __NFUN_327__(__NFUN_317__(AliasScratch, pos));
				AliasScratch = __NFUN_318__(AliasScratch, __NFUN_166__(__NFUN_166__(pos, __NFUN_314__(AliasScratch)), 1));				
			}
			else
			{
			...
			if(!(__NFUN_173__(pos, -1)))
				goto J0x96;
			// End:0x183
			if(__NFUN_145__(bAlreadyBound))
			{
				Alias = __NFUN_302__(__NFUN_302__(AliasNames[Index], " | "), Alias);				
	...
	if(__NFUN_309__(KeyName, ""))
	{
		...
		if(__NFUN_309__(Alias, ""))
		{
			...
			if(__NFUN_169__(i, 150))
			{
				...
				{
					// End:0x16A
					if(__NFUN_174__(__NFUN_314__(Alias), __NFUN_314__(AliasNames[i])))
					{
						// End:0x136
						if(__NFUN_173__(pos, 0))
						{
							pos = __NFUN_315__(__NFUN_318__(Alias, __NFUN_166__(__NFUN_314__(Alias), __NFUN_314__(AliasNames[i]))), " ");
							// End:0x133
							if(__NFUN_174__(pos, 0))
							{
								// [Explicit Continue]
								goto J0x177;
							}							
						...
						{
							pos = __NFUN_315__(__NFUN_318__(Alias, __NFUN_165__(__NFUN_166__(__NFUN_314__(Alias), pos), 1)), " ");
							// End:0x16A
							if(__NFUN_174__(pos, 0))
							{
								// [Explicit Continue]
...
function DrawKey(Canvas C, float X, float Y, int i)
{
	...
	ClipText(C, X, __NFUN_198__(Y, __NFUN_196__(__NFUN_199__(KeyHeight, YL), 2)), LocalizedKeyName[int(BoundKeys[i])], false, class'UWindowScene'.default.TTFontScale, class'UWindowScene'.default.TTFontScale,, 2);
	return;
}
...
function LoadExistingKeys()
{
	...
	if(__NFUN_169__(i, 255))
	{
		...
		// End:0x6E
		if(__NFUN_150__(__NFUN_173__(i, int(236)), __NFUN_173__(i, int(237))))
		{
			// [Explicit Continue]
			goto J0x214;
		}
		...
		if(__NFUN_309__(KeyName, ""))
		{
			...
			if(__NFUN_309__(Alias, ""))
			{
				...
				if(__NFUN_169__(j, 150))
				{
					...
					{
						// End:0x1F8
						if(__NFUN_174__(__NFUN_314__(Alias), __NFUN_314__(AliasNames[j])))
						{
							// End:0x1B2
							if(__NFUN_173__(pos, 0))
							{
								pos = __NFUN_315__(__NFUN_318__(Alias, __NFUN_166__(__NFUN_314__(Alias), __NFUN_314__(AliasNames[j]))), " ");
								// End:0x1AF
								if(__NFUN_173__(pos, 0))
								{
	...
	// End:0x24A
	if(__NFUN_150__(__NFUN_414__(), __NFUN_145__(GetPlayerOwner().bUse4Weapons)))
	{
		Commands[25] = "";		
	}
	else
...
function bool IsAnyKeyUnBound()
{
	...
	{
		// End:0x3D
		if(__NFUN_148__(__NFUN_309__(Commands[i], ""), __NFUN_308__(BoundKeys[i], "")))
		{
			return true;
		}
		__NFUN_184__(i);
