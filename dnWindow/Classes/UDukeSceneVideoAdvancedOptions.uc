/*******************************************************************************
 * UDukeSceneVideoAdvancedOptions generated by Eliot.UELib using UELib.CLI.
...
function SetDefaults()
{
	...
	ShadowDetail.SetSelectedIndex(__NFUN_166__(int(GetPlayerOwner().ConsoleCommand("get ini:Engine.Engine.ViewportManager ShadowMapDetail")), 1));
	// End:0x128
	if(__NFUN_145__(bool(GetPlayerOwner().ConsoleCommand("get ini:Engine.Engine.ViewportManager AllowStencilShadows"))))
	{
	...
	{
		// End:0x190
		if(__NFUN_145__(bool(GetPlayerOwner().ConsoleCommand("get ini:Engine.Engine.ViewportManager AllowCharacterShadows"))))
		{
	...
	if(__NFUN_145__(__NFUN_414__()))
	{
		...
		FOVvalue = __NFUN_191__(FOVvalue, FOVMin, FOVMax);
		// End:0x3F7
		if(__NFUN_145__(FOVSetting.SetSelectedItem(string(FOVvalue))))
		{
			defaultFOVSetting();
		}
	}
...
function Paint(Canvas C, float X, float Y)
{
	...
	TextureDetail.ArrowLeft = __NFUN_199__(float(ButtonWidth), __NFUN_195__(float(250), WinScaleY));
	ShadowDetail.ArrowLeft = __NFUN_199__(float(ButtonWidth), __NFUN_195__(float(250), WinScaleY));
	ShadowsEnabled.ArrowLeft = __NFUN_199__(float(ButtonWidth), __NFUN_195__(float(250), WinScaleY));
	Antialiasing.ArrowLeft = __NFUN_199__(float(ButtonWidth), __NFUN_195__(float(250), WinScaleY));
	TextureDetail.WinLeft = float(ButtonLeft);
	TextureDetail.WinTop = float(ControlStart);
	ShadowDetail.WinLeft = float(ButtonLeft);
	ShadowDetail.WinTop = __NFUN_198__(__NFUN_198__(TextureDetail.WinTop, TextureDetail.WinHeight), float(ControlBuffer));
	ShadowsEnabled.WinLeft = float(ButtonLeft);
	ShadowsEnabled.WinTop = __NFUN_198__(__NFUN_198__(ShadowDetail.WinTop, ShadowDetail.WinHeight), float(ControlBuffer));
	MotionBlurCheck.WinLeft = float(ButtonLeft);
	MotionBlurCheck.WinTop = __NFUN_198__(__NFUN_198__(ShadowsEnabled.WinTop, ShadowsEnabled.WinHeight), float(ControlBuffer));
	Antialiasing.WinLeft = float(ButtonLeft);
	Antialiasing.WinTop = __NFUN_198__(__NFUN_198__(MotionBlurCheck.WinTop, MotionBlurCheck.WinHeight), float(ControlBuffer));
	FilmGrainCheck.WinLeft = float(ButtonLeft);
	FilmGrainCheck.WinTop = __NFUN_198__(__NFUN_198__(Antialiasing.WinTop, Antialiasing.WinHeight), float(ControlBuffer));
	PostEffectsCheck.WinLeft = float(ButtonLeft);
	PostEffectsCheck.WinTop = __NFUN_198__(__NFUN_198__(FilmGrainCheck.WinTop, FilmGrainCheck.WinHeight), float(ControlBuffer));
	// End:0x460
	if(__NFUN_145__(__NFUN_414__()))
	{
		FOVSetting.ArrowLeft = __NFUN_199__(float(ButtonWidth), __NFUN_195__(float(250), WinScaleY));
		FOVSetting.WinWidth = float(ButtonWidth);
		FOVSetting.WinHeight = float(ButtonHeight);
		FOVSetting.WinLeft = float(ButtonLeft);
		FOVSetting.WinTop = __NFUN_198__(__NFUN_198__(PostEffectsCheck.WinTop, PostEffectsCheck.WinHeight), float(ControlBuffer));
	}
	// End:0x48C
	if(bCanToggleMotionBlurFlimGrain)
	{
...
function OnNavForward()
{
	...
	super.OnNavForward();
	bCanToggleMotionBlurFlimGrain = __NFUN_145__(UDukeRootWindow(Root).AgentOnline.IsInGame());
	UpdateKeyWindows();
...
function NavigateBack()
{
	...
	// End:0x41
	if(__NFUN_174__(TextureDetailSetting, TextureDetail.GetSelectedIndex()))
	{		
	...
	GetPlayerOwner().DefaultFOVShrunk = float(__NFUN_166__(FOVvalue, 5));
