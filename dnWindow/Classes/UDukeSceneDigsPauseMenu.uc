/*******************************************************************************
 * UDukeSceneDigsPauseMenu generated by Eliot.UELib using UELib.CLI.
...
function NotifyFromControl(UWindowDialogControl C, byte E)
{
	...
	// End:0x19
	if(__NFUN_150__(bResumeFade, __NFUN_201__(QuitSoundDuration, float(0))))
	{
		return;
	}
...
function OnNavForward()
{
	...
	// End:0x88
	if(__NFUN_148__(__NFUN_148__(__NFUN_340__(GetPlayerOwner(), none), __NFUN_340__(GetPlayerOwner().Level, none)), __NFUN_340__(GetPlayerOwner().Level.Game, none)))
	{
