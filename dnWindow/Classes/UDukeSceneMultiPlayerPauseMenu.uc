/*******************************************************************************
 * UDukeSceneMultiPlayerPauseMenu generated by Eliot.UELib using UELib.CLI.
...
{
	return __NFUN_148__(__NFUN_145__(GetPlayerOwner().IsFrozen()), __NFUN_145__(GetPlayerOwner().bFullyShrunk));
	return;
}
...
function Paint(Canvas C, float X, float Y)
{
	...
	if(__NFUN_402__())
	{
		ChangeTeamButton.WinTop = __NFUN_198__(__NFUN_198__(InviteButton.WinTop, InviteButton.WinHeight), float(ControlBuffer));		
	}
	else
	{
		ChangeTeamButton.WinTop = __NFUN_198__(__NFUN_198__(ResumeButton.WinTop, ResumeButton.WinHeight), float(ControlBuffer));
	}
	ChallengesButton.WinLeft = float(ButtonLeft);
	// End:0x338
	if(bTeamStyle)
	{
		ChallengesButton.WinTop = __NFUN_198__(__NFUN_198__(ChangeTeamButton.WinTop, ChangeTeamButton.WinHeight), float(ControlBuffer));		
	}
	else
	{
	...
	HelpOptionsButton.WinTop = __NFUN_198__(__NFUN_198__(ChallengesButton.WinTop, ChallengesButton.WinHeight), float(ControlBuffer));
	QuitButton.WinLeft = float(ButtonLeft);
	QuitButton.WinTop = __NFUN_198__(__NFUN_198__(HelpOptionsButton.WinTop, HelpOptionsButton.WinHeight), float(ControlBuffer));
	// End:0x40E
	if(__NFUN_402__())
	{
...
{
	// End:0x23
	if(__NFUN_148__(__NFUN_339__(W, ChangeTeamBox), __NFUN_170__(iResult, 0)))
	{
		SwitchTeams();
	}
	...
	if(__NFUN_173__(int(E), 2))
	{
		...
		else
		{
			...
			if(__NFUN_339__(C, ChangeTeamButton))
			{
				...
				{
					// End:0xE3
					if(__NFUN_150__(DukeMultiPlayer(GetPlayerOwner()).GameReplicationInfo.bWaitingForPlayers, __NFUN_201__(DukeMultiPlayer(GetPlayerOwner()).GameReplicationInfo.CountDown, 0)))
					{
...
function bool LossFromQuittingAtThisTime()
{
	...
	// End:0x27
	if(__NFUN_145__(GetPlayerOwner().IsMP()))
	{
		return false;
	}
	// End:0x45
	...
	// End:0x70
	if(__NFUN_201__(DukeMultiPlayer(GetPlayerOwner()).GameReplicationInfo.CountDown, 0))
	{
		return false;
	}
	return __NFUN_145__(DukeMultiPlayer(GetPlayerOwner()).GameReplicationInfo.bWaitingForPlayers);
	return;
}
...
defaultproperties
{
	...
	SoundNavigateForwardInfo=(bAllowRepeats=false,bPlayAsAmbient=false,MixerGroupOverride=None,SimpleSingleSound=none,Sounds=/* Array type was not detected. */,Y[1]=Y)
	FadeAlphaSpeed=2
	bFadeAll=true
}