/*******************************************************************************
 * UDukeSceneSinglePlayerDifficulty generated by Eliot.UELib using UELib.CLI.
...
function Paint(Canvas C, float X, float Y)
{
	...
	Diff2Button.WinTop = __NFUN_198__(__NFUN_198__(Diff1Button.WinTop, Diff1Button.WinHeight), float(ControlBuffer));
	Diff3Button.WinLeft = float(ButtonLeft);
	Diff3Button.WinTop = __NFUN_198__(__NFUN_198__(Diff2Button.WinTop, Diff2Button.WinHeight), float(ControlBuffer));
	Diff4Button.WinLeft = float(ButtonLeft);
	Diff4Button.WinTop = __NFUN_198__(__NFUN_198__(Diff3Button.WinTop, Diff3Button.WinHeight), float(ControlBuffer));
	return;
}
...
function NotifyFromControl(UWindowDialogControl C, byte E)
{
	...
	{
		// End:0x118
		if(__NFUN_150__(__NFUN_150__(__NFUN_150__(__NFUN_339__(C, Diff1Button), __NFUN_339__(C, Diff2Button)), __NFUN_339__(C, Diff3Button)), __NFUN_339__(C, Diff4Button)))
		{
			switch(C)
			{
				// End:0x8A
...
function Tick(float Delta)
{
	...
	if(__NFUN_148__(__NFUN_173__(TravelFade, 1), __NFUN_204__(FadeAlpha, 0.01)))
	{
		...
		{
			// End:0x11A
			if(__NFUN_148__(bResetEgo, __NFUN_340__(DukePlayer(GetPlayerOwner()), none)))
			{
			...
			SaveDifficulty();
			// End:0x188
			if(__NFUN_174__(__NFUN_315__(TravelURL, "?Difficulty="), -1))
			{
...
function GetTitleLocation(Canvas C, coerce out float Top, coerce out float Right)
{
	...
	Right = float(__NFUN_189__(int(Right), int(__NFUN_198__(float(ButtonLeft), XL))));
	return;
}
