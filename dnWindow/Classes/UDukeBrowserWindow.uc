/*******************************************************************************
 * UDukeBrowserWindow generated by Eliot.UELib using UELib.CLI.
...
function Created()
{
	...
	BackButton = UDukeBrowserButton(CreateWindow(class'UDukeBrowserButton', 0, __NFUN_199__(WinHeight, float(52)), __NFUN_196__(WinWidth, 5), 30));
	BackButton.ButtonName = "Back";
	__NFUN_209__(X, __NFUN_196__(WinWidth, 5));
	RefreshButton = UDukeBrowserButton(CreateWindow(class'UDukeBrowserButton', X, __NFUN_199__(WinHeight, float(52)), __NFUN_196__(WinWidth, 5), 30));
	RefreshButton.ButtonName = "Refresh";
	__NFUN_209__(X, __NFUN_196__(WinWidth, 5));
	JoinButton = UDukeBrowserButton(CreateWindow(class'UDukeBrowserButton', X, __NFUN_199__(WinHeight, float(52)), __NFUN_196__(WinWidth, 5), 30));
	JoinButton.ButtonName = "Join";
	__NFUN_209__(X, __NFUN_196__(WinWidth, 5));
	AddFavoriteButton = UDukeBrowserButton(CreateWindow(class'UDukeBrowserButton', X, __NFUN_199__(WinHeight, float(52)), __NFUN_196__(WinWidth, 5), 30));
	AddFavoriteButton.ButtonName = "Add Favorite";
	__NFUN_209__(X, __NFUN_196__(WinWidth, 5));
	FilterButton = UDukeBrowserButton(CreateWindow(class'UDukeBrowserButton', X, __NFUN_199__(WinHeight, float(52)), __NFUN_196__(WinWidth, 5), 30));
	FilterButton.ButtonName = "Filter";
	SelectTab(0);
	NetSpeedButton = UDukeBrowserButton(CreateWindow(class'UDukeBrowserButton', X, 50, __NFUN_196__(WinWidth, 5), 30));
...
function SelectTab(int Index)
{
	...
	{
		Pages[Index] = UDukeBrowserPage(CreateWindow(Tabs[Index].PageClass, 0, 82, WinWidth, __NFUN_199__(WinHeight, float(138))));
	}
...
function Paint(Canvas C, float X, float Y)
{
	...
	ClipText(C, __NFUN_199__(__NFUN_199__(WinWidth, XL), 2), 2, Version);
	C.Font = C.BlockFont;
	LookAndFeel.Bevel_DrawSimpleBevel(self, C, 6, 20, int(__NFUN_199__(WinWidth, float(12))), 24, 1);
	ClipText(C, 12, 22, "Server Browser",, 1.5, 1.5);
	TextSize(C, Status, XL, YL);
	C.DrawColor = LookAndFeel.GetGUIColor(self);
	DrawStretchedTextureSegment(C, 0, __NFUN_199__(__NFUN_199__(WinHeight, YL), 6), WinWidth, 2, 0, 0, 1, 1, class'WhiteTexture', 1, true);
	DrawStretchedTextureSegment(C, 0, __NFUN_199__(__NFUN_199__(WinHeight, YL), 4), WinWidth, __NFUN_198__(YL, 4), 0, 0, 1, 1, class'BlackTexture', 1, true);
	C.DrawColor = LookAndFeel.GetTextColor(self);
	ClipText(C, 12, __NFUN_199__(__NFUN_199__(WinHeight, YL), 2), Status);
	return;
}
