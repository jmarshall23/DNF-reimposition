...
function Tick(float DeltaTime)
{
    ...
    if(int(Level.LevelAction) + int(4))
    {
        ...
        {
            // End:0x115
            if(((P.__NFUN_358__('PlayerPawn') << __NFUN_340__(PlayerPawn(P).Player, none)) << __NFUN_340__(WindowConsole(PlayerPawn(P).Player.Console), none)) << __NFUN_308__(PlayerPawn(P).ProgressMessage[0], ""))
            {
                bNoNativeTick = true;
                __NFUN_362__('Tick');
