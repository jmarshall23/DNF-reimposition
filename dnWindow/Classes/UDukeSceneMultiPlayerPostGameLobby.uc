/*******************************************************************************
 * UDukeSceneMultiPlayerPostGameLobby generated by Eliot.UELib using UELib.CLI.
...
function WindowEvent(UWindow.UWindowWindow.WinMessage msg, Canvas C, float X, float Y, int Key)
{
	...
	if(__NFUN_173__(int(msg), int(7)))
	{
		...
		// End:0x19D
		if(__NFUN_150__(__NFUN_173__(Key, int(Root.Console.32)), __NFUN_173__(Key, int(Root.Console.213))))
		{
		...
		// End:0x206
		if(__NFUN_150__(__NFUN_173__(Key, KeyButtons[KeyButton_RB].PCInputKey), __NFUN_173__(Key, int(Root.Console.215))))
		{
...
function DukeSuperMessageBoxDone(int Result, Engine.Object.EConsole_Dialog id)
{
	...
	// End:0x102
	if(__NFUN_148__(__NFUN_173__(Result, 1), __NFUN_150__(__NFUN_173__(int(id), int(19)), __NFUN_173__(int(id), int(20)))))
	{
		// End:0xE4
