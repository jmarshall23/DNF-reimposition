/*******************************************************************************
 * UDukeSceneStat_Chall_LB generated by Eliot.UELib using UELib.CLI.
...
function Paint(Canvas C, float X, float Y)
{
	...
	Challenges.WinTop = __NFUN_198__(__NFUN_198__(stats.WinTop, stats.WinHeight), float(ControlBuffer));
	Leaderboard.WinLeft = float(ButtonLeft);
	Leaderboard.WinTop = __NFUN_198__(__NFUN_198__(Challenges.WinTop, Challenges.WinHeight), float(ControlBuffer));
	return;
}
