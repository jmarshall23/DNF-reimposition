/*******************************************************************************
 * UDukeScoreboardMenu generated by Eliot.UELib using UELib.CLI.
...
function RefreshTaunts()
{
	...
	if(__NFUN_169__(i, 4))
	{
		...
		UDukeScoreboardTauntMenu(Taunts[i].SubMenu).AddTaunts(__NFUN_162__(i, 8), __NFUN_165__(__NFUN_162__(i, 8), 8));
		Taunts[i].SubMenu.bLeaveOnscreen = true;
		Taunts[i].SubMenu.Font = 6;
		Taunts[i].SubMenu.bCloseOnExecute = true;
		Taunts[i].bDisabled = false;
		// End:0x14B
		if(__NFUN_173__(Taunts[i].SubMenu.Items.Count(), 0))
		{
