/*******************************************************************************
 * UDukeGBMessageBox generated by Eliot.UELib using UELib.CLI.
...
function Paint(Canvas C, float X, float Y)
{
	...
	// End:0x187
	if(__NFUN_145__(bDisableFilterType))
	{
...
function float SetupSlider(UDukeListSlider slider, float YPadding)
{
	...
	slider.WinWidth = __NFUN_195__(SliderWidth, class'UWindowScene'.default.WinScaleY);
	slider.WinHeight = __NFUN_195__(SliderHeight, class'UWindowScene'.default.WinScaleY);
	slider.WinLeft = __NFUN_196__(__NFUN_199__(WinWidth, slider.WinWidth), 2);
	slider.ArrowLeft = __NFUN_195__(float(ArrowAlignment), class'UWindowScene'.default.WinScaleY);
	return __NFUN_198__(slider.WinHeight, SpacingBuffer);
	return;
}
...
function GetDialogDimensions(Canvas C, out float X, out float Y, out float W, out float h)
{
	...
	if(__NFUN_308__(MessageText, ""))
	{
		...
		// End:0xE7
		if(__NFUN_200__(frameWidth, __NFUN_198__(__NFUN_195__(SliderWidth, class'UWindowScene'.default.WinScaleY), __NFUN_195__(EdgeBuffer, float(2)))))
		{
			frameWidth = __NFUN_198__(__NFUN_195__(SliderWidth, class'UWindowScene'.default.WinScaleY), __NFUN_195__(EdgeBuffer, float(2)));
		}
		frameHeight = __NFUN_198__(__NFUN_198__(__NFUN_198__(EdgeBuffer, YL), __NFUN_195__(__NFUN_198__(SpacingBuffer, __NFUN_195__(SliderHeight, class'UWindowScene'.default.WinScaleY)), float(NumSliders))), EdgeBuffer);
...
function Tick(float Delta)
{
	...
	// End:0x4D
	if(__NFUN_145__(GetPlayerOwner().__NFUN_999__(RequiredKey)))
	{
		PerformClose();
	}
	return;
