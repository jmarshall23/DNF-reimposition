/*******************************************************************************
 * acAssaultTrooper_Crouch generated by Eliot.UELib using UELib.CLI.
 * Eliot.UELib © 2009-2022 Eliot van Uytfanghe. All rights reserved.
 * http://eliotvu.com
 *
 * All rights belong to their respective owners.
 *******************************************************************************/
class acAssaultTrooper_Crouch extends AIAnimationControllerEx;
...
defaultproperties
{
	...
	PainAnims[7]=(Front=Anim_PainFrontRight,Back=Anim_PainBackRight,Left=None,Right=None,FrontBig=Anim_PainFrontRight,BackBig=Anim_PainBackRightBig,LeftBig=None,RightBig=None,NewAnimCont=0,WoundedPart=0)
	...
	PainAnims[9]=(Front=Anim_PainFrontRight,Back=Anim_PainBackRight,Left=None,Right=None,FrontBig=Anim_PainFrontRight,BackBig=Anim_PainBackRightBig,LeftBig=None,RightBig=None,NewAnimCont=0,WoundedPart=0)
	...
	PainAnims[11]=(Front=Anim_PainFrontRight,Back=Anim_PainBackRight,Left=None,Right=None,FrontBig=Anim_PainFrontRight,BackBig=Anim_PainBackRightBig,LeftBig=None,RightBig=None,NewAnimCont=0,WoundedPart=0)
	PainAnims[12]=(Front=Anim_PainFrontLeft,Back=Anim_PainBackLeft,Left=None,Right=None,FrontBig=Anim_PainFrontLeftBig,BackBig=Anim_PainBackLeftBig,LeftBig=None,RightBig=None,NewAnimCont=0,WoundedPart=0)
	PainAnims[13]=(Front=Anim_PainFrontRight,Back=Anim_PainBackRight,Left=None,Right=None,FrontBig=Anim_PainFrontRight,BackBig=Anim_PainBackRightBig,LeftBig=None,RightBig=None,NewAnimCont=0,WoundedPart=0)
	PainAnims[14]=(Front=Anim_PainFrontLeft,Back=Anim_PainBackLeft,Left=None,Right=None,FrontBig=Anim_PainFrontLeftBig,BackBig=Anim_PainBackLeftBig,LeftBig=None,RightBig=None,NewAnimCont=0,WoundedPart=0)
	PainAnims[15]=(Front=Anim_PainFrontRight,Back=Anim_PainBackRight,Left=None,Right=None,FrontBig=Anim_PainFrontRight,BackBig=Anim_PainBackRightBig,LeftBig=None,RightBig=None,NewAnimCont=0,WoundedPart=0)
	PainAnims[16]=(Front=Anim_PainFrontLeft,Back=Anim_PainBackLeft,Left=None,Right=None,FrontBig=Anim_PainFrontLeftBig,BackBig=Anim_PainBackLeftBig,LeftBig=None,RightBig=None,NewAnimCont=0,WoundedPart=0)
	PainAnims[17]=(Front=Anim_PainFrontRight,Back=Anim_PainBackRight,Left=None,Right=None,FrontBig=Anim_PainFrontRight,BackBig=Anim_PainBackRightBig,LeftBig=None,RightBig=None,NewAnimCont=0,WoundedPart=0)
