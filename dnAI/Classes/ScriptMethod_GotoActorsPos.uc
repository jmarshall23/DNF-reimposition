/*******************************************************************************
 * ScriptMethod_GotoActorsPos generated by Eliot.UELib using UELib.CLI.
...
{
	return __NFUN_302__(__NFUN_302__(__NFUN_302__(__NFUN_302__(__NFUN_302__(__NFUN_302__(__NFUN_302__(__NFUN_302__(__NFUN_302__(__NFUN_302__(__NFUN_302__(__NFUN_302__(__NFUN_302__(__NFUN_302__("GotoActorsPos (", string(TargetActorTag)), ", ("), string(TargetPosVar)), "), "), string(Range)), ", "), string(RangeVar)), ", "), string(__NFUN_365__(class'EAIFocus', int(Focus)))), ", "), string(FocusActorTag)), ", "), string(Run)), ")");
	return;
}
