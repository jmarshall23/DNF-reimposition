...
defaultproperties
{
	...
	m_Relations(4)=(SpawnWithWeaponDrawn=true,NumPipeBombs=-2,PipeBombChance=-1,bDirectional=true,Texture='dt_editor.Icons.aifactory')
	m_Relations(5)=
/* Exception thrown while deserializing m_Relations
