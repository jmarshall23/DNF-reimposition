/*******************************************************************************
 * AIPathHUD generated by Eliot.UELib using UELib.CLI.
...
simulated function DrawAIHUD(Canvas C)
{
	...
	DrawString(C, __NFUN_302__("Distance  To Dest:  ", string(__NFUN_251__(__NFUN_239__(m_aTarget.__NFUN_887__(), m_aTarget.Location)))));
	...
	// End:0xEBB
	if(__NFUN_201__(m_aTarget.GotoXParms.StuckTime, 0.5))
	{
		C.DrawColor = RedColor;
	}
	...
	// End:0x117C [Loop If]
	if(__NFUN_169__(i, string(m_aTarget.PhysicsContactActors)))
	{
		// End:0x1172
...
function DoPathingHistory(Canvas C)
{
	...
	// End:0x2AD [Loop If]
	if(__NFUN_169__(i, string(m_aTarget.PathingHistory)))
	{
		Hist = m_aTarget.PathingHistory[i];
		// End:0x210
		if(__NFUN_173__(int(Hist.Result), int(1)))
		{
			C.DrawColor = RedColor;			
		}
		else
		...
		str = __NFUN_302__(string(__NFUN_165__(i, 1)), "  ");
		DrawString(C, str);
...
exec function PathHistoryPlusPlus()
{
	...
	__NFUN_184__(m_aTarget.PathingHistoryMaxSize);
	return;
}
...
exec function PathHistoryMinusMinus()
{
	...
	__NFUN_185__(m_aTarget.PathingHistoryMaxSize);
	string(m_aTarget.PathingHistory) = __NFUN_188__(string(m_aTarget.PathingHistory), m_aTarget.PathingHistoryMaxSize);
	return;
}
...
exec function ShowGoal()
{
	...
	bShowGoal = __NFUN_145__(bShowGoal);
	BroadcastLog(__NFUN_302__("AIPathHud::ShowGoal ", string(bShowGoal)));
	return;
}
...
exec function ForceCutScene()
{
	...
	m_aTarget.bForcePhysicsCutScene = __NFUN_145__(m_aTarget.bForcePhysicsCutScene);
	BroadcastLog(__NFUN_302__("AIPathHud::bForcePhysicsCutScene ", string(m_aTarget.bForcePhysicsCutScene)));
	return;
}
...
exec function Rover()
{
	...
	// End:0xA7
	if(__NFUN_173__(int(m_aTarget.Physics), int(18)))
	{
...
exec function FixIt()
{
	...
	// End:0x11E
	if(__NFUN_148__(m_aTarget.__NFUN_398__('AnimX'), __NFUN_173__(m_aTarget.AnimXParms.Mode, 5)))
	{
