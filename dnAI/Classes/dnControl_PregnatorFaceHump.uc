/*******************************************************************************
 * dnControl_PregnatorFaceHump generated by Eliot.UELib using UELib.CLI.
...
final function MountPregnatorToUser()
{
	...
	DesiredLocation.TimeTotal = __NFUN_196__(__NFUN_195__(0.25, __NFUN_251__(__NFUN_239__(PregnatorMountPrefab.MountOrigin, Pregnator.MountOrigin))), 80);
...
simulated function AttachPawnSuccess(Pawn Attachee, optional bool bForced)
{
	...
	__NFUN_605__(__NFUN_226__(GruntRate, GruntRateVariance), true, 'Grunt');
	__NFUN_605__(__NFUN_226__(GruntRate, GruntRateVariance), true, 'PregnatorIdle');
...
function Grunt()
{
	...
	__NFUN_607__(__NFUN_226__(GruntRate, GruntRateVariance), false, 'Grunt');
	return;
}
...
function Rustle()
{
	...
	__NFUN_607__(__NFUN_226__(GruntRate, GruntRateVariance), false, 'Rustle');
	return;
}
...
function PregnatorIdle()
{
	...
	__NFUN_607__(__NFUN_226__(GruntRate, GruntRateVariance), false, 'PregnatorIdle');
	return;
}
...
simulated function PlayUserAnim()
{
	...
	// End:0x71
	if(__NFUN_148__(__NFUN_148__(__NFUN_342__(States[CurrentStateIndex].UserAnimName, 'None'), __NFUN_340__(Pregnator, none)), __NFUN_340__(Pregnator.AnimationController, none)))
	{
...
{
	// End:0x52
	if(__NFUN_150__(__NFUN_150__(__NFUN_339__(Pregnator, none), Pregnator.__NFUN_921__()), User.__NFUN_921__()))
	{
		// End:0x42
		if(__NFUN_340__(Pregnator, none))
		{
...
final simulated function DamagePlayer()
{
	...
	if(__NFUN_340__(User, none))
	{
		User.TakeDamage(Pregnator, Damage, User.Location, __NFUN_235__(float(-1), Vector(User.Rotation)), class'MeleeDamage',, Pregnator.Location);
		// End:0x91
		if(__NFUN_150__(__NFUN_339__(User, none), User.IsDead()))
		{
			ReleaseControlOfPregnator();
...
state() idle
{
	...
	function UpdateUserLift()
	{
		...
		// End:0x72
		if(__NFUN_148__(__NFUN_340__(Pregnator, none), __NFUN_340__(Pregnator.AnimationController, none)))
		{
