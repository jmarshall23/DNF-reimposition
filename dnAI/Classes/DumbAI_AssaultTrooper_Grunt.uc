/*******************************************************************************
 * DumbAI_AssaultTrooper_Grunt generated by Eliot.UELib using UELib.CLI.
 * Eliot.UELib © 2009-2022 Eliot van Uytfanghe. All rights reserved.
 * http://eliotvu.com
 *
 * All rights belong to their respective owners.
 *******************************************************************************/
class DumbAI_AssaultTrooper_Grunt extends AssaultTrooper_Grunt
	config
	collapsecategories;
...
event PostBeginPlay()
{
	super(AssaultTrooper_Captain).PostBeginPlay();
	AIDisableIK();
	return;
}
