/*******************************************************************************
 * EggPod generated by Eliot.UELib using UELib.CLI.
...
static function string StaticCalcOrientation(Vector LocalUp)
{
	...
	MyUpDirDotWorldUp = __NFUN_244__(LocalUp, __NFUN_232__(0, 0, 1));
	// End:0x35
	if(__NFUN_201__(MyUpDirDotWorldUp, 0.9))
	{
		return "Floor";
	}
	// End:0x4E
...
function PostInit()
{
	...
	if(HasPregnator)
	{
		...
		PregnatorsLoc = __NFUN_239__(Location, __NFUN_234__(LocalUp, CollisionHeight));
		switch(Orientation)
		{
			// End:0xA8
			case "Floor":
			...
			case "Ceiling":
				...
				__NFUN_210__(PregnatorsLoc.Z, MyPregnatorClass.default.CollisionHeight);
				// End:0x120
				break;
			// End:0x112
			case "Wall":
...
static function Pregnator_EggPod StaticSpawnPregnatorFromEggpod(Actor MyEggPod, class<Pregnator_EggPod> MyPregnatorClass)
{
	...
	__NFUN_279__(MyEggPod.Rotation, vX, vY, vZ);
	...
	switch(Orientation)
	{
		// End:0x29D
		case "Floor":
			MyPregnator.PodVel = __NFUN_232__(150, 0, 250);
			// End:0x308
			break;
		// End:0x2CD
		case "Ceiling":
			MyPregnator.PodVel = __NFUN_232__(0, 0, -400);
			// End:0x308
			break;
		// End:0x2FA
		case "Wall":
...
function AnimStarted_OpenFast()
{
	...
	switch(Orientation)
	{
		// End:0x8A
		case "Floor":
			MyPregnator.PodVel = __NFUN_232__(200, 0, 300);
			// End:0xF5
			break;
		// End:0xBA
		case "Ceiling":
			MyPregnator.PodVel = __NFUN_232__(0, 0, -500);
			// End:0xF5
			break;
		// End:0xE7
		case "Wall":
...
{
	// End:0x5E
	if(__NFUN_148__(__NFUN_148__(HasPregnator, __NFUN_340__(PrimaryTargetActor, none)), __NFUN_202__(PrimaryTarget.GetDist2D(), float(StartPreOpenDist))))
	{
		OpenGate = __NFUN_198__(__NFUN_198__(Level.GameTimeSeconds, PreOpenPeriod), __NFUN_195__(__NFUN_222__(), RndPreOpenPeriod));
		return 0;
	}
	return 1;
	return;
...
{
	// End:0x3D
	if(__NFUN_148__(__NFUN_148__(HasPregnator, __NFUN_340__(PrimaryTargetActor, none)), __NFUN_202__(PrimaryTarget.GetDist(), float(OpenFastDist))))
	{
...
{
	// End:0x3B
	if(__NFUN_148__(__NFUN_148__(HasPregnator, __NFUN_203__(Level.GameTimeSeconds, OpenGate)), __NFUN_340__(PrimaryTargetActor, none)))
	{
		SetAnimPreset_Open();
		return 0;
	}
...
{
	SetAnimPresets(0, 'Anim_Open', true, -1, none, __NFUN_232__(0, 0, 0), 0);
	return;
}

function SetAnimPreset_OpenFast()
{
	SetAnimPresets(0, 'Anim_OpenFast', true, -1, none, __NFUN_232__(0, 0, 0), 0);
	return;
}
...
event RegisterPrecacheComponents(PrecacheIndex PrecacheIndex)
{
	...
	LocalUp = __NFUN_263__(__NFUN_232__(0, 0, 1), Rotation);
	Orientation = CalcOrientation();
	switch(Orientation)
	{
		// End:0x56
