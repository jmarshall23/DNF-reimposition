/*******************************************************************************
 * ActionPointHUD generated by Eliot.UELib using UELib.CLI.
...
simulated function DrawAIHUD(Canvas C)
{
	...
	DrawMessageArea(C);
	// End:0x30
	if(__NFUN_171__(string(DebugTreeItems), string(default.DebugTreeItems)))
	{
		PopulateDebugTree();
	}
...
function DrawSecondaryAPInfo(Canvas C)
{
	...
	// End:0x1C
	if(__NFUN_150__(__NFUN_339__(EditingActionPoint, none), __NFUN_339__(SecondaryActionPoint, none)))
	{
		return;
	}
	bFoundInfo = false;
	...
	// End:0xFE [Loop If]
	if(__NFUN_148__(__NFUN_145__(bFoundInfo), __NFUN_169__(i, string(EditingActionPoint.CloseActionPoints))))
	{
	...
	// End:0x1C5 [Loop If]
	if(__NFUN_148__(__NFUN_145__(bFoundInfo), __NFUN_169__(i, string(EditingActionPoint.RetreatActionPoints))))
	{
	...
	// End:0x28C [Loop If]
	if(__NFUN_148__(__NFUN_145__(bFoundInfo), __NFUN_169__(i, string(EditingActionPoint.AdvanceActionPoints))))
	{
	...
	// End:0x351 [Loop If]
	if(__NFUN_148__(__NFUN_145__(bFoundInfo), __NFUN_169__(i, string(EditingActionPoint.FlankActionPoints))))
	{
...
function bool DebugTreeOnEnter(optional bool Found)
{
	...
	switch(Item.var1)
	{
		...
		case 1:
			// End:0x5D
			if(__NFUN_148__(__NFUN_340__(EditingActionPoint, none), __NFUN_339__(SecondaryActionPoint, none)))
			{
...
exec function ShowAll()
{
	...
	foreach __NFUN_747__(class'ActionPoint', ap)
	{
		...
		__NFUN_676__(ap.Location, __NFUN_238__(ap.Location, __NFUN_234__(Vector(ap.Rotation), 75)), NewColorBytes(0, 0, 255), 10);		
	}	
	return;
}
...
final function DrawDebugAP(Canvas C)
{
	...
	// End:0xF9 [Loop If]
	if(__NFUN_169__(i, string(EditingActionPoint.CloseActionPoints)))
	{
		APNInfo = EditingActionPoint.CloseActionPoints[i];
		// End:0xAE
	...
	// End:0x194 [Loop If]
	if(__NFUN_169__(i, string(EditingActionPoint.RetreatActionPoints)))
	{
		APNInfo = EditingActionPoint.RetreatActionPoints[i];
		// End:0x149
		if(__NFUN_339__(APNInfo.ActionPoint, none))
	...
	// End:0x22F [Loop If]
	if(__NFUN_169__(i, string(EditingActionPoint.AdvanceActionPoints)))
	{
		APNInfo = EditingActionPoint.AdvanceActionPoints[i];
		// End:0x1E4
		if(__NFUN_339__(APNInfo.ActionPoint, none))
	...
	// End:0x2CA [Loop If]
	if(__NFUN_169__(i, string(EditingActionPoint.FlankActionPoints)))
	{
		APNInfo = EditingActionPoint.FlankActionPoints[i];
		// End:0x27F
		if(__NFUN_339__(APNInfo.ActionPoint, none))
	...
	// End:0x365 [Loop If]
	if(__NFUN_169__(i, string(EditingActionPoint.LateralActionPoints)))
	{
	...
	// End:0x400 [Loop If]
	if(__NFUN_169__(i, string(EditingActionPoint.UnknownActionPoints)))
	{
	...
	// End:0x49B [Loop If]
	if(__NFUN_169__(i, string(EditingActionPoint.WalkToActionPoints)))
	{
	...
	// End:0x536 [Loop If]
	if(__NFUN_169__(i, string(EditingActionPoint.VaultToActionPoints)))
	{
	...
	// End:0x5D1 [Loop If]
	if(__NFUN_169__(i, string(EditingActionPoint.FlyToActionPoints)))
	{
...
{
	bShowLocked = __NFUN_145__(bShowLocked);
	return;
}

exec function ShowUsers()
{
	bShowUsers = __NFUN_145__(bShowUsers);
	return;
}
...
final function ShowDestructible()
{
	...
	{
		i = __NFUN_166__(string(deco.DestroyableActionPoints), 1);
		J0xFE:
