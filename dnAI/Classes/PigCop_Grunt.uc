...
defaultproperties
{
	...
	BerzStompInfo=(StompRadius=100,AnimName=Anim_Stomp,BoneName=hand_right_a,StompDamageAmount=50,StompDamageRadius=80,StompDamageVel=200,StompDamageLift=350,bDebug=false,SafeHeight=50,bCanStompShrunk=true,ShakeInfo=(bNoLerp=false,bToggleSign=true,Style=2,Function=1,FalloffActor=none,FalloffDistance=0,ShakeDuration=0.6,ShakeFrequency=0.08,ShakeMagnitude=2500,ShakeFullMagnitude=0,ShakeFullMagnitudeTime=0,ShakeName=CycloidStompShake),ShakeRadius=6000,ParticleEffectClass='p_Impacts.StompImpact.StompImpact_Spawner',AdditionalEffectBones=(hand_left_a),StompLocation=(X=1.298303E-41,Y=3.773024E-17,Z=0),Z=0)
	...
	ClawDamageAmount=30
	StompInfo(0)=(StompRadius=30,AnimName=Anim_StompLeft,BoneName=ball_left_a,StompDamageAmount=50,StompDamageRadius=40,StompDamageVel=200,StompDamageLift=350,bDebug=false,SafeHeight=20,bCanStompShrunk=false,ShakeInfo=(bNoLerp=false,bToggleSign=true,Style=2,Function=1,FalloffActor=none,FalloffDistance=0,ShakeDuration=0.6,ShakeFrequency=0.08,ShakeMagnitude=2500,ShakeFullMagnitude=0,ShakeFullMagnitudeTime=0,ShakeName=PigCopStompShake),ShakeRadius=600,ParticleEffectClass='p_Impacts.StompImpact.StompImpact_Spawner',AdditionalEffectBones=none,StompLocation=(X=1.298303E-41,Y=3.773024E-17,Z=0),Z=0)
	...
	FootprintType=0
	FieldOfView=-0.6
	PawnRotationRate=(Pitch=-2147474894,Yaw=574554112,Roll=80000)
	EyeBone=forehead
	BodyBone=spine_mid
	...
	GroundSpeed=280
	FootBones(0)=(bRightSide=false,BoneName=ball_left_a,BoneID=foot_left_1,BoneRotOffset=(Pitch=8754,Yaw=574554112,Roll=0),Roll=0)
	FootBones(1)=none
