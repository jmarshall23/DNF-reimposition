/*******************************************************************************
 * acPigCop_Prone generated by Eliot.UELib using UELib.CLI.
 * Eliot.UELib © 2009-2022 Eliot van Uytfanghe. All rights reserved.
 * http://eliotvu.com
 *
 * All rights belong to their respective owners.
 *******************************************************************************/
class acPigCop_Prone extends AIAnimationControllerEx;
...
defaultproperties
{
	...
	MuzzleAimerContraints=(MinViewPitchOffset=0,MaxViewPitchOffset=100,IgnoreThresholdPitch=16384,MinViewYawOffset=-1000,MaxViewYawOffset=1000,IgnoreThresholdYaw=0,SmerpOn=0,SmerpOff=0,Acceleration=0.5,AccelerationReset=0.1,Velocity=5000,VelocityReset=2500)
	WeaponAimerContraints=(MinViewPitchOffset=0,MaxViewPitchOffset=100,IgnoreThresholdPitch=16384,MinViewYawOffset=-1000,MaxViewYawOffset=1000,IgnoreThresholdYaw=0,SmerpOn=0,SmerpOff=0,Acceleration=0.5,AccelerationReset=0.1,Velocity=5000,VelocityReset=2500)
