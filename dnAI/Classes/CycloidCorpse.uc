/*******************************************************************************
 * CycloidCorpse generated by Eliot.UELib using UELib.CLI.
...
function bool CreateRagdollCorpse(InteractiveActor aOther)
{
	...
	if(__NFUN_340__(C, none))
	{
		...
		// End:0xE9
		if(__NFUN_201__(C.HumiliationTimeout, 0))
		{
	...
	if(__NFUN_340__(HumiliationControlClass, none))
	{
		...
		{
			HumiliationControl.MountOrigin = __NFUN_232__(0, 0, 0);
