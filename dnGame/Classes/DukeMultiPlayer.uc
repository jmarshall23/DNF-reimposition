/*******************************************************************************
 * DukeMultiPlayer generated by Eliot.UELib using UELib.CLI.
...
simulated function NU_bOfficiallyInGame(bool NewValue)
{
	...
	// End:0x27
	if(__NFUN_148__(bOfficiallyInGame, __NFUN_145__(IsDead())))
	{
		__NFUN_590__(false);
	}
	return;
...
{
	// End:0x17
	if(__NFUN_145__(super(Pawn).CanFreeze(DamageType, inHealth)))
	{
		return false;
	}
	return bAllowFreeze;
...
simulated function StartFreezing(float FreezeDuration)
{
	...
	// End:0x6C
	if(__NFUN_150__(__NFUN_173__(int(FrozenState), int(1)), __NFUN_173__(int(FrozenState), int(3))))
	{
		return;
	}
	// End:0x8E
	if(__NFUN_200__(Level.TimeSeconds, __NFUN_198__(FrozenStateChangeTime, ReFreezeTime)))
	{
		return;
	}
	SetFrozenState(1);
...
{
	// End:0x2B
	if(__NFUN_148__(__NFUN_339__(GPM, none), __NFUN_173__(int(Role), int(ROLE_Authority))))
	{
...
simulated function BeerDrinkingOffset(out Vector CameraLocation)
{
	...
	// End:0x56
	if(__NFUN_148__(bDrinkingBeer, __NFUN_200__(DrinkingBeerOffset, 1)))
	{
		DrinkingBeerOffset = __NFUN_227__(__NFUN_198__(DrinkingBeerOffset, Level.TimeDeltaSeconds), 0, 1);		
	}
	else
	{
		// End:0x9A
		if(__NFUN_148__(__NFUN_145__(bDrinkingBeer), __NFUN_201__(DrinkingBeerOffset, 0)))
		{
			DrinkingBeerOffset = __NFUN_227__(__NFUN_199__(DrinkingBeerOffset, Level.TimeDeltaSeconds), 0, 1);
		}
	}
	// End:0x103
	if(__NFUN_201__(DrinkingBeerOffset, 0))
	{
		CameraLocation = __NFUN_239__(CameraLocation, __NFUN_235__(__NFUN_199__(1, DrawScale), __NFUN_234__(__NFUN_234__(Vector(Rotation), float(1)), DrinkingBeerOffset)));
		CameraLocation.Z = __NFUN_198__(CameraLocation.Z, __NFUN_195__(__NFUN_195__(__NFUN_199__(1, DrawScale), float(1)), DrinkingBeerOffset));
	}
	return;
}
...
{
	// End:0x33
	if(__NFUN_148__(IsDead(), __NFUN_145__(bBehindView)))
	{
...
event SetCameraToCorpse(out Vector CameraLocation, out Rotator CameraRotation)
{
	...
	{
		// End:0xD5
		if(MyCorpse.MeshInstance.__NFUN_525__('spine2'))
		{
			deathcamcorpseLoc = MyCorpse.MeshInstance.__NFUN_533__('spine2', true);
			deathcamwantedLoc = deathcamcorpseLoc;
			__NFUN_209__(deathcamwantedLoc.Z, __NFUN_196__(CollisionHeight, 2));
			deathcamlocTop = deathcamwantedLoc;
			__NFUN_249__(deathcamwantedLoc, __NFUN_234__(__NFUN_234__(__NFUN_241__(__NFUN_232__(1, 0, 0), ViewRotation), -105), DrawScale));
...
simulated function PostBeginPlay()
{
	...
	// End:0x4F
	if(__NFUN_148__(IsServer(), __NFUN_340__(dnMultiplayer(Level.Game), none)))
	{
		SetOMPLID();
	}
	Init3rdPersonControllers(false);
	// End:0xBE
	if(__NFUN_148__(__NFUN_148__(__NFUN_340__(CorpseType, none), __NFUN_339__(MyCorpse, none)), __NFUN_145__(IsMyDigs())))
	{
...
{
	return __NFUN_184__(EnforcerID);
	return;
}
...
simulated event NotifyHitActor(Actor HitActor, class<DamageType> DamageType)
{
	...
	// End:0x6F
	if(__NFUN_148__(__NFUN_148__(__NFUN_340__(DamageType, class'MeleeDamage'), __NFUN_340__(DamageType, class'MightyFootDamage')), __NFUN_340__(DamageType, class'ShrunkSmashDamage')))
	{
		// End:0x6F
		if(__NFUN_148__(HitActor.bIsPlayerPawn, IsLocallyControlled()))
		{
...
{
	// End:0x1B
	if(__NFUN_150__(__NFUN_171__(11, Num), __NFUN_169__(Num, 0)))
	{
		return;
	}
...
{
	// End:0x43
	if(__NFUN_148__(__NFUN_339__(Weapon, none), IsLocallyControlled()))
	{
		__NFUN_210__(NoWeaponTime, DeltaSeconds);
		// End:0x40
...
simulated function bool CanBeExecutedBy(Pawn TestPawn)
{
	...
	{
		// End:0xA7
		if(__NFUN_148__(__NFUN_340__(DukeMultiPlayer(P), none), __NFUN_340__(P, TestPawn)))
		{
			// End:0xA7
			if(__NFUN_148__(__NFUN_340__(DukeMultiPlayer(P).ExecutionControl.ExecutionVictim, none), __NFUN_339__(DukeMultiPlayer(P).ExecutionControl.ExecutionVictim, self)))
			{
				return false;
			}
		}
...
simulated event wttUpdate(float Delta)
{
	...
	J0x00:
	// End:0xEE [Loop If]
	if(__NFUN_169__(i, string(FiredProjectiles)))
	{
		// End:0xE4
		if(__NFUN_148__(__NFUN_340__(FiredProjectiles[i], none), __NFUN_145__(FiredProjectiles[i].bExploded)))
		{
			// End:0xE4
			if(__NFUN_148__(__NFUN_243__(FiredProjectilesLastLoc[i], __NFUN_232__(0, 0, 0)), __NFUN_243__(FiredProjectiles[i].Location, __NFUN_232__(0, 0, 0))))
			{
...
noexport simulated exec delegate wttTakeDamage(int Damage)
{
	...
	if(__NFUN_339__(self, Level.__NFUN_1161__()))
	{
		...
		__NFUN_681__(__NFUN_238__(Location, __NFUN_234__(Fwd, float(100))), __NFUN_302__(__NFUN_302__(__NFUN_302__(__NFUN_302__(__NFUN_302__("-", string(Damage)), " = "), string(Ego)), "  "), string(Health)), NewColorBytes(255, 255, 0), 2);		
	}
	else
	{
		__NFUN_681__(__NFUN_238__(Location, __NFUN_232__(0, 0, 50)), __NFUN_302__(__NFUN_302__(__NFUN_302__(__NFUN_302__(__NFUN_302__("-", string(Damage)), " = "), string(Ego)), "  "), string(Health)), NewColorBytes(255, 0, 0), 2);
	}
	return;
}
...
exec function wtt(optional float debuglinetime)
{
	...
	bWeaponTuningTool = __NFUN_145__(bWeaponTuningTool);
	P = Level.PawnList;
	J0x24:
...
noexport simulated delegate DrunkParticles(bool bOn)
{
	...
	// End:0x21
	if(__NFUN_148__(IsDead(), bOn))
	{
		return;
	}
	// End:0x72
	if(__NFUN_148__(__NFUN_339__(DrunkEffect, none), bOn))
	{
		DrunkEffect = __NFUN_615__(default.DrunkEffectClass, self,, __NFUN_238__(Location, __NFUN_234__(DrunkParticlesOffset, ShrinkScale)), Rotation);
		DrunkEffect.RemoteRole = ROLE_None;
	}
	// End:0x138
	if(__NFUN_148__(bOn, __NFUN_340__(DrunkEffect, none)))
	{
		DrunkEffect.__NFUN_1059__(DrawScale);
		DrunkEffect.DisableTickWhenEmpty = false;
		DrunkEffect.__NFUN_645__(__NFUN_238__(Location, __NFUN_234__(DrunkParticlesOffset, ShrinkScale)));
...
{
	// End:0x39
	if(__NFUN_148__(__NFUN_340__(SteroidHandsEffect[0], none), SteroidHandsEffect[0].Enabled))
	{
		SteroidHandsEffect[0].__NFUN_1059__(DrawScale);
	}
	// End:0x72
	if(__NFUN_148__(__NFUN_340__(SteroidHandsEffect[1], none), SteroidHandsEffect[1].Enabled))
	{
...
noexport simulated delegate SteroidsParticles(bool bOn)
{
	...
	vLefthand = MeshInstance.__NFUN_533__('lefthand');
	vRighthand = MeshInstance.__NFUN_533__('righthand');
	// End:0xD7
	if(__NFUN_148__(__NFUN_339__(SteroidHandsEffect[0], none), bOn))
	{
...
simulated delegate ClientSetupGravOverride(float grav)
{
	...
	if(__NFUN_173__(int(Role), int(ROLE_AutonomousProxy)))
	{
		...
		{
			__NFUN_246__(vol.Gravity, OverrideGravityMagnitude);			
		}		
	}
	return;
}
...
noexport simulated delegate StartPowerupEffects(DukeMultiPlayer.EPowerupEffect Type, int Duration, optional bool recursive, optional bool bPostSpawn)
{
	...
	// End:0xB1
	if(__NFUN_173__(int(Type), int(0)))
	{
	...
	// End:0x103
	if(__NFUN_173__(int(Type), int(1)))
	{
		// End:0xFD
		if(IsLocallyControlled())
		{
...
simulated function FadeToPowerupEffect(float fadeTo, bool Weapons, bool body)
{
	...
	if(Weapons)
	{
		...
		// End:0xE2
		if(__NFUN_148__(__NFUN_340__(Weapon, none), __NFUN_339__(MP_MightyFoot(Weapon), none)))
		{
...
noexport simulated delegate ApplyDamageBoosterToWeapons(optional Weapon NW)
{
	...
	// End:0x1D2
	if(__NFUN_148__(__NFUN_340__(NW, none), __NFUN_339__(MP_MightyFoot(NW), none)))
	{
...
simulated event NU_WeaponChange(Weapon NewWeapon)
{
	...
	// End:0x25
	if(__NFUN_201__(Powerup_DamageBoosterRemaining, 0))
	{
...
simulated function DamageBoosterWarningSound()
{
	...
	{
		__NFUN_210__(DamageBoosterWarningTime, 0.25);
	}
	__NFUN_605__(DamageBoosterWarningTime, false, 'DamageBoosterWarningSound');
	return;
}
...
{
	return __NFUN_148__(HasJetpack(), __NFUN_173__(int(Physics), int(4)));
	return;
}
...
event bool PawnAllowPickup(class<Inventory> InvClass)
{
	...
	// End:0x68
	if(__NFUN_148__(bInfiniteAmmo, __NFUN_145__(__NFUN_357__(InvClass, class'Upgrade_SOS'))))
	{
	...
	// End:0x99
	if(__NFUN_148__(__NFUN_145__(IsRoundInProgress()), __NFUN_150__(__NFUN_339__(InvClass, class'MP_DamageBooster'), __NFUN_339__(InvClass, class'MP_Invincibility'))))
	{
		return false;
	}
...
simulated event Bump(Actor Other)
{
	...
	{
		// End:0xA5
		if(__NFUN_148__(__NFUN_148__(__NFUN_148__(Other.bIsPlayerPawn, __NFUN_173__(int(PostureStateEx), int(3))), __NFUN_172__(int(Role), int(ROLE_Authority))), __NFUN_201__(__NFUN_199__(Location.Z, CollisionHeight), __NFUN_198__(Other.Location.Z, Other.CollisionHeight))))
		{
			CheckForStomp(Other, Velocity, __NFUN_232__(0, 0, 1));
		}
	}
	return;
}
...
function CheckForStomp(Actor Other, Vector ImpactVelocity, Vector ImpactNormal)
{
	...
	// End:0x0D
	if(__NFUN_145__(IsRoundInProgress()))
	{
		return;
	}
	// End:0x1D
	if(__NFUN_173__(int(PostureStateEx), int(8)))
	{
		return;
	}
	// End:0x28
	...
	{
		// End:0x14E
		if(__NFUN_148__(__NFUN_340__(dmp, none), __NFUN_145__(dmp.IsDead())))
		{
			// End:0x14E
			if(__NFUN_150__(__NFUN_145__(Level.Game.bTeamGame), __NFUN_174__(int(dmp.PlayerReplicationInfo.Team), int(PlayerReplicationInfo.Team))))
			{
				// End:0x14E
				if(__NFUN_148__(__NFUN_145__(dmp.bBeingStomped), __NFUN_145__(dmp.bPowerup_Invincibility)))
				{
					// End:0x14E
					if(__NFUN_148__(dmp.bFullyShrunk, __NFUN_145__(bFullyShrunk)))
					{
						// End:0x14E
						if(__NFUN_201__(ImpactNormal.Z, 0.95))
						{
							SmashPawn = dmp;
...
function MaybeStepOnPawn(Pawn PawnOther)
{
	...
	// End:0xBD
	if(__NFUN_148__(__NFUN_340__(Level.Game, none), Level.Game.bTeamGame))
	{
		// End:0xBD
		if(__NFUN_173__(int(PawnOther.PlayerReplicationInfo.Team), int(PlayerReplicationInfo.Team)))
		{
			return;
		}
	}
...
{
	// End:0x34
	if(__NFUN_150__(DukeMultiPlayer(PawnOther).bBeingStomped, DukeMultiPlayer(PawnOther).bPowerup_Invincibility))
	{
		return false;
	}
	// End:0x41
...
simulated function ApplyCustomizationInfo_TitleOptions(int Index)
{
	...
	// End:0x121
	if(__NFUN_148__(__NFUN_148__(__NFUN_172__(Index, 0), __NFUN_169__(Index, string(class'ChallengeInfo'.default.ChallengesArray))), __NFUN_173__(int(class'ChallengeInfo'.default.ChallengesArray[Index].Category), int(7))))
	{
...
simulated function ApplyCustomizationInfo_HatOption(int Index)
{
	...
	// End:0x14D
	if(__NFUN_148__(__NFUN_148__(__NFUN_148__(__NFUN_148__(__NFUN_172__(Index, 0), __NFUN_169__(Index, string(class'ChallengeInfo'.default.ChallengesArray))), __NFUN_173__(int(class'ChallengeInfo'.default.ChallengesArray[Index].Category), int(2))), __NFUN_309__(class'ChallengeInfo'.default.ChallengesArray[Index].AttachMesh, "")), __NFUN_342__(class'ChallengeInfo'.default.ChallengesArray[Index].AttachBone, 'None')))
	{
...
simulated function ApplyCustomizationInfo_FaceOption(int Index)
{
	...
	// End:0x14D
	if(__NFUN_148__(__NFUN_148__(__NFUN_148__(__NFUN_148__(__NFUN_172__(Index, 0), __NFUN_169__(Index, string(class'ChallengeInfo'.default.ChallengesArray))), __NFUN_173__(int(class'ChallengeInfo'.default.ChallengesArray[Index].Category), int(3))), __NFUN_309__(class'ChallengeInfo'.default.ChallengesArray[Index].AttachMesh, "")), __NFUN_342__(class'ChallengeInfo'.default.ChallengesArray[Index].AttachBone, 'None')))
	{
		CD = __NFUN_615__(class'CustomizationDecoration', self);
		CD.__NFUN_595__(StaticMesh(__NFUN_366__(class'ChallengeInfo'.default.ChallengesArray[Index].AttachMesh, class'StaticMesh')));
		CD.MountMeshItem = class'ChallengeInfo'.default.ChallengesArray[Index].AttachBone;
...
simulated function ApplyCustomizationInfo_ShirtOption(int Index)
{
	...
	// End:0xD7
	if(__NFUN_148__(__NFUN_148__(__NFUN_172__(Index, 0), __NFUN_169__(Index, string(class'ChallengeInfo'.default.ChallengesArray))), __NFUN_173__(int(class'ChallengeInfo'.default.ChallengesArray[Index].Category), int(4))))
	{
		matName = class'ChallengeInfo'.default.ChallengesArray[Index].AMName;
		// End:0xD7
		if(__NFUN_174__(class'ChallengeInfo'.static.__NFUN_1169__(class'ChallengeInfo'.default.PlainShirtId), Index))
		{
...
simulated function ApplyCustomizationInfo_ShirtLogoOption(int Index)
{
	...
	// End:0x90
	if(__NFUN_148__(__NFUN_148__(__NFUN_172__(Index, 0), __NFUN_169__(Index, string(class'ChallengeInfo'.default.ChallengesArray))), __NFUN_173__(int(class'ChallengeInfo'.default.ChallengesArray[Index].Category), int(5))))
	{
		matName = class'ChallengeInfo'.default.ChallengesArray[Index].AMName;
...
{
	__NFUN_601__('ShirtColour', class'DukeMultiplayerAssets'.default.ShirtColors[__NFUN_191__(Index, 0, __NFUN_166__(string(class'DukeMultiplayerAssets'.default.ShirtColors), 1))]);
	return;
}
...
{
	__NFUN_180__(DisplayStatsStartIndex, i);
	// End:0x1E
	if(__NFUN_169__(DisplayStatsStartIndex, 0))
	{
	...
	if(__NFUN_340__(CurrentDamageVolume, none))
	{
		...
		if(__NFUN_145__(IsDead()))
		{
			...
			if(CurrentDamageVolume.bActive)
			{
				...
				// End:0x149
				if(__NFUN_150__(__NFUN_145__(CurrentDamageVolume.__NFUN_358__('JetpackVolume')), IsFlyingJetpack()))
				{
					// End:0xDC
					if(__NFUN_145__(CurrentDamageVolume.bIgnoreOwner))
					{
					...
					TakeDamage(P, __NFUN_195__(CurrentDamageVolume.DamagePerInterval, DrawScale), Location, __NFUN_232__(0, 0, 0), CurrentDamageVolume.DamageType,, Location);
				}
				bInstaGib = saveGib;
			}
	...
	if(__NFUN_340__(CurrentDamageVolume, none))
	{
		...
		if(__NFUN_145__(IsDead()))
		{
			...
			if(CurrentDamageVolume.bActive)
			{
				...
				TakeDamage(CurrentDamageVolume.EventInstigator, __NFUN_195__(CurrentDamageVolume.SecondaryDamagePerInterval, DrawScale), Location, __NFUN_232__(0, 0, 0), CurrentDamageVolume.SecondaryDamageType,, Location);
				bInstaGib = saveGib;
			}
			bPowerup_Invincibility = saveInvincibility;
		}		
...
{
	MyCorpse.TakeDamage(CurrentDamageVolume.EventInstigator, __NFUN_195__(CurrentDamageVolume.SecondaryDamagePerInterval, float(1000)), Location, __NFUN_232__(0, 0, 0), CurrentDamageVolume.SecondaryDamageType, 'spine2', Location);
	MyCorpse.AddRandomImpulseToSpawnedGibs(1000);
	MyCorpse.ApplyImpulse(__NFUN_232__(0, 0, 10000), Location, 'Root');
	return;
}
...
simulated function DamageVolumeKill(PhysicsVolume Volume)
{
	...
	// End:0xB6
	if(__NFUN_150__(__NFUN_148__(__NFUN_340__(dv, none), dv.bActive), __NFUN_339__(dv, none)))
	{
		// End:0x7A
...
simulated function DamageVolTurnedOn()
{
	...
	// End:0x5C
	if(__NFUN_201__(CurrentDamageVolume.SecondaryDamageInterval, float(0)))
	{
		__NFUN_607__(CurrentDamageVolume.SecondaryDamageInterval, true, 'SecondaryDamageVolumeDamage');
	}
	// End:0x95
	if(__NFUN_201__(CurrentDamageVolume.AutoTurnOffSeconds, float(0)))
	{
...
simulated event PhysicsVolumeChange(PhysicsVolume NewVolume)
{
	...
	if(NewVolume.__NFUN_358__('DamageVolume'))
	{
		...
		// End:0x66
		if(__NFUN_200__(__NFUN_198__(LastPhysicsVolumeChangeDamageTimestamp, 0.1), Level.TimeSeconds))
		{
			DamageVolumeDamage();
		}
	...
	else
	{
		...
		if(NewVolume.__NFUN_358__('JetpackVolume'))
		{
			...
			// End:0x145
			if(__NFUN_148__(__NFUN_150__(__NFUN_173__(int(Role), int(ROLE_Authority)), __NFUN_173__(int(Role), int(ROLE_AutonomousProxy))), CurrentJetPackVolume.bUseFog))
			{
...
simulated function JetPackFogUpdate()
{
	...
	targetOpacity = __NFUN_227__(__NFUN_196__(__NFUN_199__(__NFUN_199__(Location.Z, CurrentJetPackVolume.Location.Z), float(CurrentJetPackVolume.jetpackFogStart)), float(__NFUN_166__(CurrentJetPackVolume.jetpackFogEnd, CurrentJetPackVolume.jetpackFogStart))), 0, 1);
	// End:0xD2
	if(__NFUN_150__(__NFUN_145__(HasJetpack()), __NFUN_145__(IsFlyingJetpack())))
	{
		// End:0xCF
		if(__NFUN_201__(targetOpacity, 0))
		{
			targetOpacity = __NFUN_199__(CurrentJetPackVolume.DistanceFog.Opacity, Level.TimeDeltaSeconds);
		}		
	}
	else
	{
		// End:0x1A5
		if(__NFUN_148__(HasJetpack(), IsFlyingJetpack()))
		{
			diff = __NFUN_199__(targetOpacity, CurrentJetPackVolume.DistanceFog.Opacity);
			// End:0x157
			if(__NFUN_200__(diff, __NFUN_194__(Player.Console.LastFrameTime)))
			{
				targetOpacity = __NFUN_199__(CurrentJetPackVolume.DistanceFog.Opacity, Level.TimeDeltaSeconds);
			}
			// End:0x1A5
			if(__NFUN_201__(diff, Player.Console.LastFrameTime))
			{
				targetOpacity = __NFUN_198__(CurrentJetPackVolume.DistanceFog.Opacity, Level.TimeDeltaSeconds);
			}
		}
	}
	targetOpacity = __NFUN_227__(targetOpacity, 0, 1);
...
simulated function LevelUpEffect()
{
	...
	// End:0xA2
	if(__NFUN_173__(PlayerProgress.CurrentLevel, __NFUN_166__(PlayerProgress.OverDriveLevel, 1)))
	{
		// End:0xA2
...
{
	return __NFUN_150__(bISprintDown, super(PlayerPawn).CalculatePhysics_Base3DMotion_ShouldFlyUp());
	return;
}
...
{
	return __NFUN_173__(int(Role), int(ROLE_Authority));
	return;
}
...
function TripMineThrow(MP_LaserMine MIne)
{
	...
	__NFUN_184__(NumActiveTripmines);
...
function TripMineDestoryed(MP_LaserMine MIne)
{
	...
	__NFUN_185__(NumActiveTripmines);
	i = __NFUN_166__(string(ActiveTripMines), 1);
	J0x26:
...
{
	// End:0x0D
	if(__NFUN_145__(bBlowExplosivesOnDeath))
	{
		return;
	}
...
function TripmineDetonate()
{
	...
	J0x00:
	// End:0x48 [Loop If]
	if(__NFUN_169__(i, string(ActiveTripMines)))
	{
...
{
	// End:0x1A
	if(__NFUN_148__(__NFUN_145__(bBlowExplosivesOnDeath), __NFUN_145__(bForceExplode)))
	{
		return;
	}
	PipebombDetonate();
...
function RemoveTripMinesAndPipeBombs()
{
	...
	{
		D.bActive = false;
		i = __NFUN_166__(string(D.PipeBombs), 1);
		J0x98:
...
exec function UseWeapon(string WeaponString)
{
	...
	if(__NFUN_308__(WeaponString, "dnGame.PipeBomb"))
	{
		D = MP_Detonator(ActivatableInventory(__NFUN_918__('MP_Detonator')));
		// End:0x8F
		if(__NFUN_148__(__NFUN_340__(D, none), __NFUN_172__(D.ActivePipeBombCount, MaxActivePipeBombs)))
		{
	...
	{
		// End:0xD6
		if(__NFUN_172__(NumActiveTripmines, MaxActiveTripMines))
		{
			return;
		}
...
simulated function FinishWeaponChange()
{
	...
	// End:0x34
	if(__NFUN_150__(__NFUN_340__(MP_PipeBomb(Weapon), none), __NFUN_340__(MP_Detonator(Weapon), none)))
	{
...
{
	// End:0x27
	if(__NFUN_148__(bOnSteroids, __NFUN_340__(Weapon.Class, class'MP_Holoduke')))
	{
		return;
	}
	// End:0x42
...
{
	// End:0x3B
	if(__NFUN_148__(__NFUN_340__(Weapon, none), __NFUN_340__(Weapon.MeshInstance, none)))
	{
		Weapon.MeshInstance.__NFUN_559__();
	}
	// End:0x76
	if(__NFUN_148__(__NFUN_340__(NewWeapon, none), __NFUN_340__(NewWeapon.MeshInstance, none)))
	{
...
simulated function ChangeToWeapon(Weapon NewWeapon)
{
	...
	// End:0x75
	if(__NFUN_148__(bOnSteroids, __NFUN_340__(NewWeapon.Class, class'MP_MightyFoot')))
	{
		// End:0x75
...
{
	// End:0x16
	if(__NFUN_150__(IsPreRound(), IsEndOfRound()))
	{
		return;
	}
...
simulated function int GetWeaponPriority(Weapon Weap)
{
	...
	{
		// End:0x6F
		if(__NFUN_148__(__NFUN_148__(__NFUN_148__(__NFUN_148__(__NFUN_148__(__NFUN_340__(Weap, none), __NFUN_339__(Weap.Class, class'MP_MightyFoot')), __NFUN_340__(PrimaryWeapon1, none)), __NFUN_340__(PrimaryWeapon2, none)), __NFUN_340__(PrimaryWeapon3, none)), __NFUN_340__(PrimaryWeapon4, none)))
		{
			return -1;
		}		
	}
	...
	{
		// End:0xBC
		if(__NFUN_148__(__NFUN_148__(__NFUN_148__(__NFUN_340__(Weap, none), __NFUN_339__(Weap.Class, class'MP_MightyFoot')), __NFUN_340__(PrimaryWeapon1, none)), __NFUN_340__(PrimaryWeapon2, none)))
		{
			return -1;
		}
	}
...
function bool PowerupDamageAdjustment(Pawn Instigator, out float Damage, class<DamageType> DamageType)
{
	...
	{
		// End:0x93
		if(__NFUN_148__(__NFUN_340__(DukeMultiPlayer(Instigator), none), DukeMultiPlayer(Instigator).bPowerup_DamageBooster))
		{
...
function UpdatePowerup_Invincibility()
{
	...
	if(bPowerup_Invincibility)
	{
		__NFUN_210__(Powerup_InvincibilityRemaining, PowerUpStepTime);
		// End:0x3D
...
function UpdatePowerup_DamageBooster()
{
	...
	if(bPowerup_DamageBooster)
	{
		__NFUN_210__(Powerup_DamageBoosterRemaining, PowerUpStepTime);
		// End:0x3D
...
simulated function SubmitToLeaderboard(Engine.Object.EMatchResult LocalPlayerMatchResult, bool IsEndOfGame)
{
	...
	// End:0xE8
	if(__NFUN_148__(__NFUN_148__(__NFUN_340__(l_Online, none), __NFUN_145__(l_Online.IsPrivateMatch())), __NFUN_145__(bHasSubmittedScoresThisRound)))
	{
		Wins = 0;
		Losses = 0;
		// End:0x6E
		if(__NFUN_173__(int(LocalPlayerMatchResult), int(0)))
		{
			Wins = 1;			
		}
		else
		{
			// End:0x83
			if(__NFUN_173__(int(LocalPlayerMatchResult), int(2)))
			{
				Losses = 1;
			}
		}
...
simulated exec function SaveAll(optional bool bCreate, optional bool bIgnoreLoadedMetadataFlag)
{
	...
	// End:0x1A
	if(__NFUN_148__(__NFUN_145__(bIgnoreLoadedMetadataFlag), __NFUN_145__(bLoadedMetadata)))
	{
		return;
	}
	// End:0x27
	...
	// End:0x77
	if(__NFUN_148__(__NFUN_145__(bCreate), __NFUN_150__(__NFUN_339__(GameReplicationInfo, none), GameReplicationInfo.bPrivateMatch)))
	{
		__NFUN_355__("PRIVATE MATCH SAVING BLOCK!");
		return;
	}
...
simulated function ApplyMetaData()
{
	...
	assert(__NFUN_148__(__NFUN_339__(LocalPlayerPawn, self), __NFUN_340__(PlayerProgress, none)));
	LoadAll();
...
simulated event HostLeft(int Reason)
{
	...
	if(__NFUN_340__(OnlineAgent(class'Engine'.static.__NFUN_503__()), none))
	{
		...
		// End:0xD7
		if(__NFUN_150__(__NFUN_173__(int(errorReason), int(39)), __NFUN_173__(int(errorReason), int(38))))
		{
			// End:0xD7
			if(__NFUN_148__(__NFUN_339__(Level.__NFUN_1161__(), self), bLoadedMetadata))
			{
...
event SpawnPickupForWeapon(optional Weapon DropWeapon)
{
	...
	if(__NFUN_340__(MP_Detonator(Weapon), none))
	{
		...
		// End:0x61
		if(__NFUN_148__(__NFUN_340__(pipe, none), __NFUN_173__(pipe.GetTotalAmmo(), 0)))
		{
			return;
		}
	}
	...
	if(__NFUN_340__(MP_Tripmine(Weapon), none))
	{
		...
		// End:0xAB
		if(__NFUN_148__(__NFUN_340__(trip, none), __NFUN_173__(trip.GetTotalAmmo(), 0)))
		{
			return;
		}
	}
	...
	if(__NFUN_340__(DropWeapon, none))
	{
		...
		if(IsMostlyShrunk())
		{
			weaponDrop = DropWeapon.SpawnPickupForWeapon(__NFUN_195__(0.25, DropWeapon.default.DrawScale), true);			
		}
		else
		{
...
{
	// End:0x60
	if(__NFUN_148__(__NFUN_148__(__NFUN_340__(Weapon, none), __NFUN_341__(Weapon.__NFUN_399__(), 'Deactivating')), __NFUN_150__(__NFUN_339__(ActInv.Class, class'MP_FortyOunceBeer'), __NFUN_339__(ActInv.Class, class'MP_Steroids'))))
	{
		return false;
	}
...
function ChangeTeam(int n)
{
	...
	{
		// End:0xA4
		if(__NFUN_173__(int(class'ChallengeInfo'.default.ChallengesArray[i].Category), int(4)))
		{
...
{
	// End:0x46
	if(__NFUN_148__(__NFUN_340__(Weapon, none), __NFUN_342__(Weapon.__NFUN_399__(), 'Reloading')))
	{
...
{
	// End:0x63
	if(__NFUN_148__(__NFUN_148__(__NFUN_148__(__NFUN_148__(__NFUN_173__(int(Role), int(ROLE_Authority)), __NFUN_340__(self, Level.__NFUN_1161__())), __NFUN_145__(GameReplicationInfo.bPrivateMatch)), __NFUN_145__(bGameEnded)), __NFUN_145__(bIdleKicked)))
	{
		bIdleKicked = true;
		ServerIdleKick();
	}
...
simulated function BecomeUnfrozen()
{
	...
	D = MP_Detonator(ActivatableInventory(__NFUN_918__('MP_Detonator')));
	// End:0xCD
	if(__NFUN_148__(__NFUN_148__(__NFUN_340__(MP_PipeBomb(Weapon), none), __NFUN_340__(D, none)), D.CanActivateNow()))
	{
	...
	{
		// End:0x156
		if(__NFUN_150__(__NFUN_150__(__NFUN_340__(MP_Tripmine(Weapon), none), __NFUN_340__(MP_PipeBomb(Weapon), none)), __NFUN_148__(__NFUN_340__(MP_MightyFoot(Weapon), none), __NFUN_150__(__NFUN_148__(__NFUN_340__(PreviousWeapon, none), __NFUN_170__(PreviousWeapon.GetTotalAmmo(), 0)), bInfiniteAmmo))))
		{
			Weapon.bDeactivationAllowed = true;
			// End:0x156
			if(IsLocallyControlled())
...
exec function DoHeatVision()
{
	...
	{
		bDukeVisionOn = __NFUN_145__(bDukeVisionOn);
	}
	// End:0x4A
	if(bDukeVisionOn)
	{
...
{
	// End:0x5C
	if(__NFUN_148__(__NFUN_340__(Weapon, none), __NFUN_150__(__NFUN_150__(__NFUN_173__(int(Weapon.WeaponState), int(1)), __NFUN_173__(int(Weapon.WeaponState), int(2))), __NFUN_173__(int(Weapon.WeaponState), int(0)))))
	{
		return false;
	}
...
simulated function TakeShrinkerDamage(Pawn Instigator)
{
	...
	__NFUN_209__(ShrinkDamage, __NFUN_195__(float(100), Instigator.DrawScale));
	return;
}
...
{
	// End:0x26
	if(__NFUN_150__(__NFUN_150__(bOnSteroids, bPowerup_Invincibility), __NFUN_145__(bReadyToShrink)))
	{
		return false;		
	}
	else
...
function bool FriendlyFireCheck(Pawn Instigator)
{
	...
	if(__NFUN_148__(__NFUN_340__(Level.Game, none), Level.Game.bTeamGame))
	{
		...
		// End:0xC7
		if(__NFUN_173__(int(PlayerReplicationInfo.Team), int(Instigator.PlayerReplicationInfo.Team)))
		{
			// End:0xC7
			if(__NFUN_148__(Level.Game.__NFUN_358__('dnDeathmatchGame_TeamDM'), __NFUN_145__(dnDeathmatchGame_TeamDM(Level.Game).bFriendlyFire)))
			{
				return false;
			}
		}
...
{
	// End:0x24
	if(__NFUN_148__(__NFUN_340__(DamageType, class'RocketDamage'), __NFUN_340__(DamageType, class'HomingRocketDamage')))
	{
		return false;
	}
	return true;
...
function RocketJump(Pawn Instigator, Vector DamageStart, class<DamageType> DamageType, out float Damage)
{
	...
	// End:0x20
	if(__NFUN_145__(IsRocketJumpDamageTypeValid(DamageType)))
	{
		return;
	}
	// End:0x4D
	if(__NFUN_200__(__NFUN_244__(__NFUN_232__(0, 0, -1), __NFUN_253__(__NFUN_239__(DamageStart, Location))), 0.85))
	{
		return;
	}
	// End:0x7A
	if(__NFUN_148__(__NFUN_148__(__NFUN_174__(int(PostureStateEx), int(4)), __NFUN_174__(int(PostureStateEx), int(5))), __NFUN_145__(bJumpInProgress)))
	{
		return;
	}
	// End:0x122
	if(bDontUseMeqonPhysics)
	{
		ExplosionVector = __NFUN_234__(__NFUN_239__(Location, DamageStart), RocketJumpForce);
		ExplosionVector.X = 0;
		ExplosionVector.Y = 0;
		// End:0x10D
		if(__NFUN_201__(ExplosionVector.Z, float(0)))
		{
			// End:0xF1
			if(__NFUN_201__(ExplosionVector.Z, MaxRocketJumpForce))
			{
		...
		Velocity = __NFUN_238__(Velocity, ExplosionVector);		
	}
	else
	{
		__NFUN_820__(__NFUN_234__(__NFUN_239__(Location, DamageStart), RocketJumpForce), DamageStart);
	}
	__NFUN_207__(Damage, RocketJumpDamageResistanceFactor);
	return;
}
...
{
	// End:0x9D
	if(__NFUN_148__(__NFUN_148__(__NFUN_148__(__NFUN_145__(bFullyShrunk), __NFUN_150__(IsFrozen(), __NFUN_200__(__NFUN_199__(Level.TimeSeconds, BecomeUnfrozenTime), 2))), Attacker.bFullyShrunk), __NFUN_150__(__NFUN_339__(DamageClass, class'MeleeDamage'), __NFUN_339__(DamageClass, class'MightyFootDamage'))))
	{
		__NFUN_210__(SubdualDamage, __NFUN_195__(Damage, SubdualDamageFactor));
		ShakeView(MiniFrozenPunchShakeInfo);
		// End:0x9D
		if(__NFUN_201__(SubdualDamage, float(0)))
		{
			return true;
		}
	}
...
{
	// End:0x56
	if(__NFUN_148__(__NFUN_148__(__NFUN_148__(__NFUN_339__(DamageType, class'ShotgunDamage'), __NFUN_145__(bFullyShrunk)), __NFUN_340__(Instigator, none)), Instigator.bFullyShrunk))
	{
		__NFUN_207__(Damage, class'MP_Shotgun'.default.ShrunkDamageModifier);
	}
	// End:0x6F
	if(bFullyShrunk)
	{
		__NFUN_207__(Damage, __NFUN_196__(float(1), DrawScale));
	}
	return Damage;
	return;
}
...
{
	// End:0x3C
	if(__NFUN_148__(__NFUN_340__(Level.Game, none), dnMultiplayer(Level.Game).bEndOfGameRequest))
	{
		return;
	}
	// End:0x51
	...
	// End:0x86
	if(__NFUN_148__(__NFUN_145__(IsRoundInProgress()), __NFUN_340__(Instigator, none)))
	{
		return;
	}
	PlayerProgress.Stat_TakeDamagePreInvincibility(DamageType);
	// End:0xB7
	if(__NFUN_145__(PowerupDamageAdjustment(Instigator, Damage, DamageType)))
	{
		return;
	}
	// End:0xD1
	...
	// End:0xFE
	if(__NFUN_145__(FriendlyFireCheck(Instigator)))
	{
		return;
	}
	// End:0x123
	if(__NFUN_148__(__NFUN_340__(Instigator, none), Instigator.__NFUN_358__('HoloActor')))
	{
		return;
	}
...
{
	return __NFUN_148__(__NFUN_340__(Level.Game, none), __NFUN_145__(dnMultiplayer(Level.Game).IsAlone()));
	return;
}
...
{
	// End:0x44
	if(__NFUN_148__(__NFUN_201__(Powerup_InvincibilityRemaining, float(0)), bPowerup_Invincibility))
	{
		switch(DamageType)
		{
			// End:0x27
...
simulated function DiedActivity(optional Pawn Killer, optional int Damage, optional Vector DamageOrigin, optional Vector DamageDirection, optional class<DamageType> DamageType, optional name HitBoneName)
{
	...
	// End:0x12
	if(__NFUN_145__(FallingDeathCheck(DamageType)))
	{
		return;
	}
	...
	// End:0x10D
	if(__NFUN_150__(IsRoundInProgress(), __NFUN_145__(bEndGameRequested)))
	{
	...
	{
		// End:0x1FB
		if(__NFUN_148__(__NFUN_340__(Killer, none), __NFUN_340__(Killer, self)))
		{
			__NFUN_184__(Killer.PlayerReplicationInfo.Kills);
		}
		// End:0x221
		if(__NFUN_145__(GameReplicationInfo.bWaitingForPlayers))
		{
			__NFUN_184__(PlayerReplicationInfo.Deaths);
		}
	}
	// End:0x23F
	...
	FixPhysics();
	// End:0x2E1
	if(__NFUN_148__(__NFUN_340__(DukeMultiPlayer(Killer), none), __NFUN_340__(Killer, self)))
	{
	}
	// End:0x4C2
	if(__NFUN_148__(__NFUN_148__(__NFUN_340__(DukeMultiPlayer(Killer), none), __NFUN_340__(DukeMultiPlayer(Killer), self)), __NFUN_173__(int(Role), int(ROLE_Authority))))
	{
		// End:0x354
		...
		// End:0x3D0
		if(__NFUN_148__(__NFUN_148__(bWasDrinkingBeer, __NFUN_340__(dnMultiplayer(Level.Game), none)), __NFUN_173__(int(dnMultiplayer(Level.Game).GameType), int(4))))
		{
		...
		else
		{
			...
			else
			{
				...
				else
				{
					...
					{
						// End:0x49E
						if(__NFUN_148__(bWasGibbed, __NFUN_169__(PlayerProgress.MultiKillCount, 2)))
						{
...
function ServerRestartPlayer(optional bool bForce, optional bool bClientReceivedInventory)
{
	...
	// End:0x73
	if(__NFUN_148__(__NFUN_203__(Level.TimeSeconds, __NFUN_198__(CanRespawnTime, ForceRespawnTime)), IsDead()))
	{
		bInitialSpawn = false;
		bForce = true;
	}
...
simulated function CheckTeabag()
{
	...
	// End:0xF0 [Loop If]
	if(__NFUN_169__(i, string(Level.Corpses)))
	{
		...
		CorpseHeadLoc = Corpse.__NFUN_568__().__NFUN_533__('Head', true);
		FootLocation = Location;
		__NFUN_210__(FootLocation.Z, __NFUN_961__());
		// End:0xE6
		if(__NFUN_200__(__NFUN_252__(__NFUN_239__(FootLocation, CorpseHeadLoc)), float(300)))
		{
...
{
	__NFUN_210__(BallsOfSteelDelay, 1);
	// End:0x23
	if(__NFUN_202__(BallsOfSteelDelay, 0))
	{
...
exec function JumpDown()
{
	...
	Jetpack = ActivatableInventory(__NFUN_918__('MP_Jetpack'));
	// End:0x89
	if(__NFUN_148__(__NFUN_148__(HasJetpack(), __NFUN_145__(IsFlyingJetpack())), Jetpack.CanActivateNow()))
	{
		// End:0x89
		if(__NFUN_150__(__NFUN_173__(int(Physics), int(2)), bJumpInProgress))
		{
			DoJetpack();
...
simulated function AllowRespawn(optional bool bForced)
{
	bRespawn = true;
	// End:0x26
	if(__NFUN_148__(bInitialSpawn, __NFUN_145__(bForced)))
	{
		bInitialSpawn = false;
	}
	return;
...
{
	// End:0x2A
	if(__NFUN_148__(__NFUN_203__(Level.TimeSeconds, CanRespawnTime), IsDead()))
	{
		AllowRespawn();
	}
	return;
...
simulated function ClearHUDEffects()
{
	...
	// End:0x10D [Loop If]
	if(__NFUN_169__(i, string(HUD.HUDEffects)))
	{
...
simulated event NU_PostureStateChange(Engine.Actor.EPostureStateEx NewPS)
{
	...
	// End:0x43
	if(__NFUN_174__(int(PostureStateEx), int(PreviousPostureStateEx)))
	{
		LastIdleAnim = 'None';
		LastAnimX = 'None';
		LastAnimZ = 'None';
...
{
	// End:0x38
	if(__NFUN_150__(__NFUN_150__(bReplayingSavedMoves, bIsJumpPadLaunching), __NFUN_201__(__NFUN_198__(RestartTime, 0.1), Level.TimeSeconds)))
	{
		return;
	}
	...
	// End:0xA9
	if(__NFUN_148__(__NFUN_173__(int(Role), int(ROLE_Authority)), __NFUN_173__(int(RemoteRole), int(ROLE_AutonomousProxy))))
	{
...
simulated function bool UpdateWeaponAnimationState(Weapon SourceWeapon, byte NewWeaponState)
{
	...
	if(__NFUN_145__(IsLocallyControlled()))
	{
		GetLookAnimGrid(class'Weapon', Weapon, __NFUN_175__(__NFUN_165__(ViewRotation.Pitch, 65536), 65535), AnimName, GridY);
...
simulated event StartTurning(bool bLeftDirection)
{
	...
	// End:0x1D
	if(__NFUN_173__(int(LowerBodyOverrideState), int(1)))
	{
		return;
	}
	// End:0x3E
...
{
	// End:0x33
	if(__NFUN_173__(nRotatingOnSpotApproach, 0))
	{
		bRotatingOnSpot_PlayingTurningAnim = false;
		AnimationController.EmptyAnimChannels_ByBlock('LegsOverrideBlock');
		TurnType = 0;		
	...
	{
		// End:0x80
		if(__NFUN_173__(nRotatingOnSpotApproach, 1))
		{
			SetLowerBodyOverrideState(0);
			AnimationController.EmptyAnimChannels_ByBlock('LegsOverrideBlock');
			bRotatingOnSpot_PlayingTurningAnim = false;
...
exec function DebugAnims()
{
	...
	{
		MetagameHUD(MyHUD).bDebugPlayerAnims = __NFUN_145__(MetagameHUD(MyHUD).bDebugPlayerAnims);
	}
	return;
}
...
exec function DebugAnimsAI()
{
	...
	if(__NFUN_340__(MetagameHUD(MyHUD), none))
	{
		MetagameHUD(MyHUD).bDebugAIAnims = __NFUN_145__(MetagameHUD(MyHUD).bDebugAIAnims);
	}
	return;
}
...
exec function DebugRotationOnSpot()
{
	...
	if(__NFUN_340__(MetagameHUD(MyHUD), none))
	{
		MetagameHUD(MyHUD).bDebugRotationOnSpot = __NFUN_145__(MetagameHUD(MyHUD).bDebugRotationOnSpot);
	}
	return;
}
...
{
	// End:0x74
	if(__NFUN_148__(__NFUN_148__(__NFUN_340__(dnDeathmatchGame(Level.Game), none), __NFUN_340__(dnDeathmatchGame(Level.Game).Announcer, none)), __NFUN_145__(dnDeathmatchGame(Level.Game).Announcer.AllowExternalVO())))
	{
		return;
	}
...
{
	// End:0x0D
	if(__NFUN_145__(bCanPlayTriggeredVO))
	{
		return;
	}
	PlayEventVO(trig);
...
{
	// End:0x96
	if(__NFUN_202__(__NFUN_222__(), playchance))
	{
		// End:0x80
		if(__NFUN_148__(__NFUN_148__(__NFUN_340__(dnDeathmatchGame(Level.Game), none), __NFUN_340__(dnDeathmatchGame(Level.Game).Announcer, none)), __NFUN_145__(dnDeathmatchGame(Level.Game).Announcer.AllowExternalVO())))
		{
...
simulated function PlayEventVO(DukeMultiPlayer.VOTrigger trig)
{
	...
	// End:0x231
	if(__NFUN_145__(__NFUN_148__(bLocalPlayerOnly, __NFUN_145__(IsLocallyControlled()))))
	{
...
function ServerUseDown()
{
	...
	super.ServerUseDown();
	// End:0x6F
	if(__NFUN_148__(__NFUN_340__(TouchingWeaponPickup, none), CanPickupWeapon()))
	{
		SentinelAddEvent(none, TouchingWeaponPickup, "weapon_pickup", 0, "");
		TouchingWeaponPickup.Used(self, self);
...
simulated function DrawBone(name BoneName, Actor Object, float fTime)
{
	...
	{
		BoneLocation = Object.MeshInstance.__NFUN_533__(BoneName, true);
		ParentName = Object.MeshInstance.__NFUN_526__(BoneName);
		// End:0xE4
		if(__NFUN_342__(ParentName, 'None'))
		{
			ParentLocation = Object.MeshInstance.__NFUN_533__(ParentName, true);
...
simulated function OutputSkeleton(Actor Object)
{
	...
	// End:0x5D [Loop If]
	if(__NFUN_169__(nBone, nTotalBones))
	{
		__NFUN_355__(string(Object.MeshInstance.__NFUN_524__(nBone)));
		__NFUN_184__(nBone);
		// [Loop Continue]
		goto J0x24;
	}
...
{
	// End:0x4C
	if(__NFUN_148__(__NFUN_173__(int(FrozenState), int(0)), __NFUN_145__(IsDead())))
	{
		// End:0x4C
		if(__NFUN_148__(__NFUN_145__(__NFUN_684__(5)), bCanTaunt))
		{
			ServerDoTaunt();
			bCanTaunt = false;
...
simulated exec function DynamicActorList()
{
	...
	{
		__NFUN_184__(Count);
		__NFUN_355__(__NFUN_303__("- ", string(A)));		
	}	
...
simulated event Actor TraceFromCrosshairMeshEx(float MaxDistance, optional out Vector HitLocation, optional out Vector HitNormal, optional out name HitMeshBone, optional out MaterialEx HitMeshTexture, optional out Vector HitUV, optional Vector Extent, optional bool bShootable)
{
	...
	// End:0xFA
	if(__NFUN_173__(string(TraceActorList), 0))
	{
		return none;
	}
	...
	// End:0x180 [Loop If]
	if(__NFUN_169__(i, string(TraceActorList)))
	{
		Distance = __NFUN_251__(__NFUN_239__(Location, TraceActorList[i].Location));
		// End:0x176
	...
	HitLocation = __NFUN_239__(HitLocation, __NFUN_234__(__NFUN_253__(__NFUN_239__(HitLocation, StartTrace)), 2));
	bCollide = __NFUN_734__(HitLocation, StartTrace, true);
	// End:0x1C7
	if(__NFUN_145__(bCollide))
	{
		return none;		
	}
	else
	...
	Result = TraceFromCrosshairMesh(__NFUN_199__(__NFUN_251__(__NFUN_239__(StartTrace, HitLocation)), 2), HitLocation,,,,,, true);
	// End:0x20E
...
{
	// End:0x33
	if(__NFUN_148__(__NFUN_339__(ExecutionControl.User, self), ExecutionControl.bUsedCrouchedAnim))
	{
		bUncrouch = false;
	}
...
{
	// End:0x2D
	if(__NFUN_150__(__NFUN_339__(Player, none), Player.Console.bBlockShowMenu))
	{
		return;
	}
	super.ShowMenu();
...
event RegisterPrecacheComponents(PrecacheIndex PrecacheIndex)
{
	...
	i = __NFUN_166__(string(Shirts), 1);
	J0x574:
	...
	i = __NFUN_166__(string(class'ChallengeInfo'.default.ChallengesArray), 1);
	J0x5BA:
...
{
	// End:0x57
	if(__NFUN_148__(__NFUN_148__(__NFUN_148__(__NFUN_340__(Player.Console, none), __NFUN_340__(GameReplicationInfo, none)), IsMP()), __NFUN_146__(bQuitGame, false)))
	{
...
defaultproperties
{
	...
	DrunkParticlesOffset=(X=1.292418E-41,Y=2.94903E-17,Z=0)
