/*******************************************************************************
 * dnSinglePlayer generated by Eliot.UELib using UELib.CLI.
...
{
	// End:0x116
	if(__NFUN_148__(__NFUN_340__(Injured, none), __NFUN_340__(InstigatedBy, none)))
	{
		// End:0x92
		if(__NFUN_148__(__NFUN_148__(__NFUN_148__(InstigatedBy.bIsPlayerPawn, __NFUN_145__(Injured.bIsPlayerPawn)), __NFUN_145__(InstigatedBy.IsMostlyShrunk())), Injured.IsMostlyShrunk()))
		{
			return __NFUN_225__(1, __NFUN_196__(Injured.Health, float(Damage)));			
		}
		else
		{
			// End:0xC5
			if(__NFUN_148__(InstigatedBy.IsMostlyShrunk(), __NFUN_145__(Injured.IsMostlyShrunk())))
			{
			...
			{
				// End:0x113
				if(__NFUN_148__(__NFUN_148__(__NFUN_145__(InstigatedBy.IsMostlyShrunk()), Injured.IsMostlyShrunk()), __NFUN_145__(Injured.bIsPlayerPawn)))
				{
					return __NFUN_196__(1, ShrunkenDamageScale);
				}
			}
		}		
	}
	...
	{
		// End:0x14F
		if(__NFUN_148__(__NFUN_340__(InstigatedBy, none), __NFUN_145__(__NFUN_357__(DamageType, class'PhysicsImpactDamage'))))
		{
			// End:0x14F
...
function float ModifyDamage(float Damage, class<DamageType> DamageType, Pawn Injured, Pawn Instigator)
{
	...
	// End:0xAC
	if(__NFUN_148__(__NFUN_340__(DamageType, none), __NFUN_145__(DamageType.default.bIgnoreDifficultyDamageScaling)))
	{
		// End:0x79
		if(__NFUN_148__(__NFUN_340__(Injured, none), Injured.bIsPlayerPawn))
		{
		...
		{
			// End:0xAC
			if(__NFUN_148__(__NFUN_340__(Instigator, none), Instigator.bIsPlayerPawn))
			{
	...
	// End:0x18B
	if(__NFUN_148__(__NFUN_340__(Instigator, none), __NFUN_340__(Injured, none)))
	{
		// End:0x18B
		if(__NFUN_145__(Instigator.bIsPlayerPawn))
		{
			// End:0x13A
			if(__NFUN_148__(Injured.bIsPlayerPawn, __NFUN_145__(Injured.IsEnemyTo(Instigator))))
			{
				Damage = 0;				
			}
			else
			{
				// End:0x18B
				if(__NFUN_148__(__NFUN_148__(Injured.bIsPawn, __NFUN_145__(Injured.bIsPlayerPawn)), __NFUN_145__(Injured.IsEnemyTo(Instigator))))
				{
					Damage = 0;
				}
			}
...
event PlayerPawn Login(string Portal, string Options, out string Error, class<PlayerPawn> SpawnClass)
{
	...
	// End:0x77
	if(__NFUN_148__(__NFUN_340__(SinglePlayerDuke, none), HasOption(Options, "NewGame")))
	{
...
event PostLogin(PlayerPawn NewPlayer)
{
	...
	// End:0xD8
	if(__NFUN_148__(__NFUN_148__(__NFUN_204__(Level.GameTimeSeconds, 0), __NFUN_340__(SinglePlayerStart, none)), SinglePlayerStart.bSpawnShrunk))
	{
...
event Tick(float DeltaTime)
{
	...
	if(__NFUN_174__(int(Level.LevelAction), int(4)))
	{
		...
		{
			// End:0xC0
			if(__NFUN_148__(__NFUN_148__(__NFUN_148__(P.bIsPlayerPawn, __NFUN_340__(PlayerPawn(P).Player, none)), __NFUN_340__(WindowConsole(PlayerPawn(P).Player.Console), none)), __NFUN_308__(PlayerPawn(P).ProgressMessage[0], "")))
			{
				__NFUN_362__('Tick');
				// [Explicit Break]
				goto J0xD8;
...
{
	// End:0x20
	if(__NFUN_145__(Level.bSavedGame))
	{
