/*******************************************************************************
 * Upgrade_ZoomMode generated by Eliot.UELib using UELib.CLI.
...
{
	// End:0x47
	if(__NFUN_148__(Instigator.bIsPlayerPawn, PlayerPawn(Instigator).CanZoomIn()))
	{
		super.StartActivate();
		// End:0x47
...
simulated function StartDeactivate()
{
	...
	// End:0x2F
	if(__NFUN_148__(Instigator.bIsPlayerPawn, __NFUN_172__(int(Role), int(ROLE_Authority))))
	{
		ZoomOut();
	}
	return;
...
simulated function ZoomIn()
{
	...
	// End:0x7E
	if(__NFUN_150__(__NFUN_339__(PlayerInstigator.Weapon, none), __NFUN_202__(ZoomScale, float(0))))
	{
	...
	// End:0x166
	if(__NFUN_148__(__NFUN_148__(__NFUN_148__(__NFUN_148__(__NFUN_145__(IsMP()), PlayerInstigator.bDoAimAssist), PlayerInstigator.__NFUN_994__()), __NFUN_340__(PlayerInstigator.AimAssistEnemy, none)), __NFUN_340__(PlayerInstigator.AimAssistEnemy, PlayerInstigator.DirectLookHitActor)))
	{
		PlayerInstigator.__NFUN_583__('AnimationValues', 'AimAssistViewLerp');
		PlayerInstigator.__NFUN_577__('AnimationValues', 'AimAssistViewLerp', 0, 1, __NFUN_198__(ZoomTime, 0.15), 1);
	}
	return;
}
