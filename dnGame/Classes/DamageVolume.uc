/*******************************************************************************
 * DamageVolume generated by Eliot.UELib using UELib.CLI.
...
function EventInstigatorVolumeCheck(optional bool resetDamageTimers)
{
	...
	foreach __NFUN_749__(class'DukeMultiPlayer', dmp)
	{
		__NFUN_184__(Count);
		// End:0x56
		if(__NFUN_148__(__NFUN_339__(dmp.CurrentDamageVolume, self), resetDamageTimers))
		{
