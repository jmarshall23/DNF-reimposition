...
defaultproperties
{
	...
	MuzzleInfo(0)=(MuzzleFireStartAnim=StartFireLeft,MuzzleFireAnim=FireLeft,MuzzleFireStopAnim=StopFireLeft,MuzzleFlashClass='p_Weapons.Devastator_MuzzleFlash.Devastator_MuzzleFlash_Spawner',MuzzleBoneName=mount_muzzle_left_down,MuzzleMountAngles=(Pitch=8741,Yaw=572915712,Roll=32768),Roll=0)
