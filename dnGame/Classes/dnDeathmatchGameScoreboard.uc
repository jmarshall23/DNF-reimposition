/*******************************************************************************
 * dnDeathmatchGameScoreboard generated by Eliot.UELib using UELib.CLI.
...
function DrawHeader(Canvas C)
{
	...
	ScoreStart = __NFUN_195__(__NFUN_196__(58, 720), C.ClipY);
	C.bCenter = true;
	SetFontSize(C, 1);
...
function DrawVictoryConditions(Canvas C)
{
	...
	C.__NFUN_1238__("Test", XL, YL, FontScaleX, FontScaleY);
	C.__NFUN_1250__(0, __NFUN_198__(__NFUN_199__(C.CurY, YL), float(8)));
	// End:0x14A
	if(__NFUN_309__(LastKilledByMessage, ""))
	{
...
function DrawTrailer(Canvas C)
{
	...
	C.__NFUN_1250__(0, __NFUN_199__(C.ClipY, __NFUN_195__(float(2), YL)));
	C.__NFUN_1232__(__NFUN_303__(__NFUN_303__(PlayerOwner.GameReplicationInfo.GameName, MapTitle), Level.Title), true);
	C.__NFUN_1250__(0, __NFUN_199__(C.ClipY, YL));
	RemainingTimeSeconds = __NFUN_199__(PlayerOwner.GameReplicationInfo.MatchEndTime, PlayerOwner.Level.TimeSeconds);
	// End:0x1F9
	if(__NFUN_150__(bTimeDown, __NFUN_170__(dnDeathmatchGameReplicationInfo(PlayerOwner.GameReplicationInfo).TimeLimit, 0)))
	{
		bTimeDown = true;
		// End:0x193
		...
		{
			Minutes = int(__NFUN_196__(RemainingTimeSeconds, float(60)));
			seconds = int(__NFUN_197__(RemainingTimeSeconds, float(60)));
	...
	// End:0x3C9
	if(__NFUN_309__(PlayerOwner.GameReplicationInfo.GameEndedComments, ""))
	{
		C.bCenter = true;
		C.__NFUN_1231__("Test", XL, YL);
		C.__NFUN_1250__(0, __NFUN_199__(C.ClipY, float(__NFUN_188__(int(__NFUN_195__(YL, float(6))), int(__NFUN_195__(C.ClipY, 0.1))))));
	...
	{
		// End:0x498
		if(__NFUN_148__(__NFUN_340__(PlayerOwner, none), __NFUN_202__(PlayerOwner.Health, float(0))))
		{
			C.bCenter = true;
			C.__NFUN_1231__("Test", XL, YL);
			C.__NFUN_1250__(0, __NFUN_199__(C.ClipY, float(__NFUN_188__(int(__NFUN_195__(YL, float(6))), int(__NFUN_195__(C.ClipY, 0.1))))));
...
function DrawCategoryHeaders(Canvas C)
{
	...
	C.__NFUN_1250__(__NFUN_199__(__NFUN_195__(__NFUN_196__(C.ClipX, float(8)), float(2)), __NFUN_196__(XL, float(2))), Offset);
	C.__NFUN_1232__(PlayerString,,,, FontScaleX, FontScaleY);
	C.__NFUN_1238__(FragsString, XL, YL, FontScaleX, FontScaleY);
	C.__NFUN_1250__(__NFUN_199__(__NFUN_195__(__NFUN_196__(C.ClipX, float(8)), float(5)), __NFUN_196__(XL, float(2))), Offset);
	C.__NFUN_1232__(FragsString,,,, FontScaleX, FontScaleY);
	C.__NFUN_1238__(DeathsString, XL, YL, FontScaleX, FontScaleY);
	C.__NFUN_1250__(__NFUN_199__(__NFUN_195__(__NFUN_196__(C.ClipX, float(8)), float(6)), __NFUN_196__(XL, float(2))), Offset);
...
function SortScores(int n)
{
	...
	// End:0x1D5 [Loop If]
	if(__NFUN_169__(i, __NFUN_166__(n, 1)))
	{
		Max = i;
		j = __NFUN_165__(i, 1);
		J0x32:
		...
		{
			// End:0x7E
			if(__NFUN_170__(Ordered[j].Score, Ordered[Max].Score))
			{
				Max = j;
				// [Explicit Continue]
				goto J0x188;
			...
			// End:0xEC
			if(__NFUN_148__(__NFUN_173__(Ordered[j].Score, Ordered[Max].Score), __NFUN_169__(Ordered[j].Deaths, Ordered[Max].Deaths)))
			{
				Max = j;
				// [Explicit Continue]
				goto J0x188;
			...
			// End:0x188
			if(__NFUN_148__(__NFUN_148__(__NFUN_173__(Ordered[j].Score, Ordered[Max].Score), __NFUN_173__(Ordered[j].Deaths, Ordered[Max].Deaths)), __NFUN_169__(Ordered[j].PlayerID, Ordered[Max].Score)))
			{
				Max = j;
			}
			J0x188:
...
function DrawNameAndPing(Canvas C, PlayerReplicationInfo PRI, float xOffset, float YOffset)
{
	...
	SetFontSize(C, 1);
	PlayerOwner = PlayerPawn(Owner);
	bLocalPlayer = __NFUN_173__(PRI.PlayerID, PlayerOwner.PlayerReplicationInfo.PlayerID);
	// End:0x6F
	if(bLocalPlayer)
	{
		C.DrawColor = GoldColor;		
	...
	C.__NFUN_1250__(__NFUN_199__(__NFUN_198__(__NFUN_195__(C.ClipX, 0.75), __NFUN_195__(XL, 0.5)), XL2), YOffset);
	C.__NFUN_1232__(string(PRI.Deaths), false,,, FontScaleX, FontScaleY);
	SetFontSize(C, 2);
	// End:0x535
	if(__NFUN_148__(__NFUN_201__(C.ClipX, float(512)), __NFUN_174__(int(Level.NetMode), int(NM_Standalone))))
	{
		C.DrawColor = WhiteColor;
		...
		C.__NFUN_1250__(__NFUN_198__(__NFUN_195__(C.ClipX, 0.75), XL), YOffset);
		...
		C.__NFUN_1250__(__NFUN_198__(__NFUN_195__(C.ClipX, 0.75), XL), __NFUN_198__(YOffset, __NFUN_195__(0.5, YL)));
		C.__NFUN_1232__(__NFUN_303__(__NFUN_302__(FPHString, ": "), string(__NFUN_163__(__NFUN_162__(60, PRI.Score), Time))), false,,, FontScaleX, FontScaleY);
		XL3 = __NFUN_225__(XL3, XL2);
		C.__NFUN_1250__(__NFUN_198__(__NFUN_198__(__NFUN_198__(__NFUN_195__(C.ClipX, 0.75), XL), XL3), float(16)), YOffset);
		C.__NFUN_1232__(__NFUN_303__(__NFUN_302__(PingString, ":"), string(PRI.Ping)), false,,, FontScaleX, FontScaleY);
		C.__NFUN_1250__(__NFUN_198__(__NFUN_198__(__NFUN_198__(__NFUN_195__(C.ClipX, 0.75), XL), XL3), float(16)), __NFUN_198__(YOffset, __NFUN_195__(0.5, YL)));
...
function DrawScores(Canvas C)
{
	...
	C.__NFUN_1250__(0, __NFUN_195__(__NFUN_196__(160, 720), C.ClipY));
	...
	YOffset = YStart;
	// End:0x1B3
	if(__NFUN_170__(PlayerCount, 15))
	{
		PlayerCount = int(__NFUN_224__(float(PlayerCount), __NFUN_199__(__NFUN_196__(__NFUN_199__(C.ClipY, YStart), YL), float(1))));
	}
	C.__NFUN_1250__(0, 0);
	i = 0;
	J0x1D1:
	...
	{
		YOffset = __NFUN_198__(YStart, __NFUN_195__(float(i), YL));
...
defaultproperties
{
	...
	RedColor=(B=121,G=2,R=1,A=255)
	LightGreenColor=(B=121,G=2,R=1,A=0)
	DarkGreenColor=(B=121,G=2,R=1,A=32)
	GreenColor=(B=121,G=2,R=1,A=0)
	CyanColor=(B=121,G=2,R=1,A=0)
	BlueColor=(B=121,G=2,R=1,A=0)
	GoldColor=(B=121,G=2,R=1,A=255)
	PurpleColor=(B=121,G=2,R=1,A=255)
	TurqColor=(B=121,G=2,R=1,A=0)
	GrayColor=(B=121,G=2,R=1,A=200)
	LightBlueColor=(B=121,G=2,R=1,A=0)
	DarkBlueColor=(B=121,G=2,R=1,A=0)
	OrangeColor=(B=121,G=2,R=1,A=255)
}