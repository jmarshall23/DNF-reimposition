/*******************************************************************************
 * DukePlayer generated by Eliot.UELib using UELib.CLI.
...
final event bool NoteDiscoveredEgoAward(int AwardID)
{
	...
	// End:0xBD
	if(__NFUN_145__(HasDiscoveredEgoAward(AwardID)))
	{
		__NFUN_383__("EgoAwards", string(__NFUN_365__(class'EEgoAwardID', AwardID)), true, "Progress.ini");
	...
	// End:0x133
	if(__NFUN_145__(HasDiscoveredEgoAward(AwardID, true)))
	{
		__NFUN_383__("ACH_EgoAwards", string(__NFUN_365__(class'EEgoAwardID', AwardID)), true, "Progress.ini");
	...
	{
		// End:0x160
		if(__NFUN_145__(HasDiscoveredEgoAward(i, true)))
		{
			return true;
		}
		__NFUN_185__(i);
...
function RefreshHelpText(Decoration Something)
{
	...
	// End:0x3B
	if(__NFUN_150__(__NFUN_339__(UsableSomething, none), __NFUN_340__(UsableSomething, InteractiveDecoration)))
	{
		return;
	}
	// End:0xF9
	if(__NFUN_174__(string(UsableSomething.HUDHelpEntries), 0))
	{
		bUseHelpPanel = true;
		i = __NFUN_166__(string(UsableSomething.HUDHelpEntries), 1);
		J0x72:
...
simulated function SpawnShades()
{
	...
	{
		// End:0xC3
		if(__NFUN_148__(__NFUN_148__(bWearsShades, __NFUN_150__(__NFUN_339__(Shades, none), __NFUN_340__(Shades.MountParent, self))), __NFUN_339__(__NFUN_596__(), default.Mesh)))
		{
...
simulated event TravelPostAccept()
{
	...
	// End:0x3A
	if(__NFUN_174__(default.dnQAState, 0))
	{
		dnQA(dnQAState);
	}
	TurnOffZoom();
...
{
	// End:0x24
	if(__NFUN_150__(__NFUN_173__(int(FlotsamEffect), int(2)), __NFUN_173__(int(FlotsamEffect), int(4))))
	{
...
final function ApplyNewFlotsamEffect(ZoneInfo NewZone, PhysicsVolume NewHeadVolume)
{
	...
	{
		// End:0xE3
		if(__NFUN_174__(int(NewHeadVolume.VolumeFlotsamEffect), int(0)))
		{
	...
	{
		// End:0x14D
		if(__NFUN_148__(__NFUN_340__(HeadVolume, none), __NFUN_174__(int(HeadVolume.VolumeFlotsamEffect), int(0))))
		{
	...
	i = __NFUN_166__(string(FlotsamEffects), 1);
	J0x20B:
	...
	{
		// End:0x2DA
		if(__NFUN_148__(__NFUN_340__(FlotsamEffects[i], none), __NFUN_339__(FlotsamEffects[i].Class, NewFlotsamEffectClass)))
		{
...
event ZoneChange(ZoneInfo NewZone)
{
	...
	// End:0x2D
	if(__NFUN_148__(IsLocallyControlled(), __NFUN_145__(bReplayingSavedMoves)))
	{
...
event PhysicsVolumeChange(PhysicsVolume NewVolume)
{
	...
	// End:0x112
	if(__NFUN_148__(__NFUN_148__(__NFUN_148__(__NFUN_145__(IsMP()), __NFUN_340__(NewVolume, none)), IsLocallyControlled()), __NFUN_145__(bReplayingSavedMoves)))
	{
		// End:0x112
		if(__NFUN_148__(NewVolume.bWaterVolume, __NFUN_145__(bWasWaterVolume)))
		{
			// End:0x112
			if(__NFUN_200__(Velocity.Z, float(-400)))
			{
				__NFUN_279__(Rotation, X, Y, Z);
				SplashLoc = __NFUN_238__(__NFUN_239__(Location, __NFUN_234__(__NFUN_232__(0, 0, 1), __NFUN_198__(__NFUN_196__(CollisionHeight, 2), 48))), __NFUN_234__(X, 16));
	...
	// End:0x156
	if(__NFUN_148__(__NFUN_148__(__NFUN_148__(__NFUN_145__(bReplayingSavedMoves), NewVolume.bWaterVolume), __NFUN_145__(bWasWaterVolume)), __NFUN_200__(Velocity.Z, float(-400))))
	{
	}
...
{
	// End:0x31
	if(__NFUN_148__(__NFUN_340__(Other, none), Other.bIsPawn))
	{
...
event KImpact(name SelfBoneName, KarmaActor Other, name OtherBoneName, Vector Position, Vector ImpactVelocity, Vector ImpactNormal)
{
	...
	// End:0x62
	if(__NFUN_201__(__NFUN_251__(ImpactVelocity), 100))
	{
		CrackedScreenAlpha = __NFUN_227__(__NFUN_196__(__NFUN_251__(ImpactVelocity), 500), CrackedScreenAlpha, 1);
	}
...
function MaybeStepOnPawn(Pawn PawnOther)
{
	...
	// End:0x67
	if(__NFUN_148__(__NFUN_148__(__NFUN_150__(PawnOther.bFullyShrunk, PawnOther.Stompable), __NFUN_145__(bFullyShrunk)), __NFUN_145__(IsFrozen())))
	{
...
function bool StepOnPawn(Pawn PawnOther)
{
	...
	// End:0x1E
	if(__NFUN_150__(__NFUN_340__(SmashPawn, none), __NFUN_173__(int(LowerBodyOverrideState), int(3))))
	{
		return false;
	}
	// End:0x3B
	if(__NFUN_148__(__NFUN_145__(IsLocallyControlled()), __NFUN_174__(int(Role), int(ROLE_Authority))))
	{
		return false;
	}
	// End:0x81
	if(__NFUN_148__(GameReplicationInfo.bTeamGame, __NFUN_173__(int(PawnOther.PlayerReplicationInfo.Team), int(PlayerReplicationInfo.Team))))
	{
		return false;
	}
	// End:0xA1
	if(__NFUN_150__(__NFUN_173__(int(PostureStateEx), int(8)), __NFUN_173__(int(PostureStateEx), int(3))))
	{
		return false;
	}
	// End:0xCF
	if(__NFUN_148__(__NFUN_145__(PawnOther.bFullyShrunk), __NFUN_145__(PawnOther.Stompable)))
	{
		return false;
	}
	// End:0xE4
	...
	// End:0xFC
	if(__NFUN_145__(PawnOther.CanBeSmashedBy(self)))
	{
		return false;
	}
	// End:0x121
	if(__NFUN_203__(PawnOther.Location.Z, Location.Z))
	{
		return false;
	}
	ViewVector = Vector(CalcedViewRotation);
	TargetVector = __NFUN_253__(__NFUN_239__(PawnOther.Location, CalcedViewLocation));
	// End:0x163
	if(__NFUN_200__(__NFUN_244__(TargetVector, ViewVector), StompMinDot))
	{
		return false;
	}
	bStomping = true;
	...
	__NFUN_791__(__NFUN_232__(0, 0, 0));
	__NFUN_792__(__NFUN_232__(0, 0, 0));
	__NFUN_793__(__NFUN_232__(0, 0, 0));
...
simulated function ClientLookAtSmashVictim(Actor Other)
{
	...
	__NFUN_210__(LookAtPoint.Z, float(20));
...
function KillSmashTarget()
{
	...
	{
		// End:0x7C
		if(__NFUN_145__(SmashPawn.__NFUN_358__('HoloActor')))
		{
			// End:0x45
			if(__NFUN_339__(BloodScreenSplatterEffect, none))
			{
			...
			{
				BloodScreenSplatterEffect.__NFUN_645__(__NFUN_238__(CalcedViewLocation, Vector(CalcedViewRotation)));
		...
		// End:0x139
		if(__NFUN_148__(__NFUN_148__(__NFUN_145__(IsDead()), bMaybePlayStompLine), __NFUN_202__(__NFUN_222__(), 0.4)))
		{
...
{
	return __NFUN_148__(IsMP(), super(Pawn).ShouldCheckUnshrinkClear());
	return;
}
...
{
	// End:0x20
	if(__NFUN_200__(__NFUN_199__(Level.TimeSeconds, OldMessageTime), float(5)))
	{
		return;
	}
...
{
	// End:0x20
	if(__NFUN_200__(__NFUN_199__(Level.TimeSeconds, OldMessageTime), float(10)))
	{
		return;
	}
...
function UseInventory(string IClassName)
{
	...
	// End:0x55
	if(__NFUN_148__(__NFUN_340__(ActInv, none), ActInv.CanActivateNow()))
	{
...
exec function DoHoloDuke()
{
	...
	// End:0x61
	if(__NFUN_145__(HoloDuke.CanActivateNow()))
	{
		HoloDukeSpawnFailed();		
	}
	else
...
function HoloDukeSpawnFailed()
{
	...
	if(__NFUN_340__(DukeHUD(MyHUD), none))
	{
		DukeHUD(MyHUD).HoloDukeSpawnFailedTimer = __NFUN_198__(Level.GameTimeSeconds, 3);
	}
	return;
}
...
exec function ShowCyl()
{
	...
	{
		DukeHUD(MyHUD).bDrawCyl = __NFUN_145__(DukeHUD(MyHUD).bDrawCyl);
	}
	return;
}
...
exec function ShowBounds()
{
	...
	if(MyHUD.__NFUN_358__('DukeHUD'))
	{
		DukeHUD(MyHUD).bDrawBounds = __NFUN_145__(DukeHUD(MyHUD).bDrawBounds);
	}
	return;
}
...
{
	return __NFUN_150__(bStomping, super.CurrentlyInvincible());
	return;
}

function bool ImmuneToDamage()
{
	return __NFUN_150__(bStomping, super.ImmuneToDamage());
	return;
}
...
{
	// End:0x1D
	if(__NFUN_148__(bOnlyTakeTransferredDamage, __NFUN_340__(DamageType, class'TransferredDamage')))
	{
		return;
	}
...
function TookDamage(Pawn Instigator, float Damage, Engine.Object.EPawnBodyPart BodyPart, Vector DamageOrigin, Vector DamageDirection, class<DamageType> DamageType, optional name HitBoneName, optional Vector DamageStart)
{
	...
	// End:0x7A
	if(__NFUN_148__(__NFUN_148__(__NFUN_145__(IsMP()), bDemoMode), __NFUN_202__(Health, float(0))))
	{
		DemoDied();
	}
	return;
...
{
	// End:0x51
	if(__NFUN_148__(__NFUN_148__(__NFUN_148__(__NFUN_145__(IsMP()), bDemoMode), DemoDeath), __NFUN_202__(DemoDeathMessageTimeLeft, 0)))
	{
		DemoDeath = false;
...
function DrawDemoDeath(Canvas C)
{
	...
	// End:0x96
	if(__NFUN_201__(DemoDeathMessageTimeLeft, 0))
	{
		...
		{
			__NFUN_210__(DemoDeathMessageTimeLeft, Level.TimeDeltaSeconds);
			// End:0x93
	...
	__NFUN_209__(XL, 16);
	__NFUN_209__(YL, 16);
	X = __NFUN_195__(0.5, __NFUN_199__(float(C.SizeX), XL));
	Y = __NFUN_195__(225, MyHUD.CenterScale);
	C.__NFUN_1250__(X, Y);
	...
	C.__NFUN_1250__(__NFUN_198__(X, 8), __NFUN_198__(Y, 8));
...
simulated function DiedActivity(optional Pawn Killer, optional int Damage, optional Vector DamageOrigin, optional Vector DamageDirection, optional class<DamageType> DamageType, optional name HitBoneName)
{
	...
	CrackedScreenX = __NFUN_195__(__NFUN_199__(__NFUN_222__(), 0.5), CrackedScreenStretch);
	CrackedScreenY = __NFUN_195__(__NFUN_199__(__NFUN_222__(), 0.5), CrackedScreenStretch);
	// End:0x86
	if(__NFUN_174__(default.dnQAState, 0))
	{
		QA.Died(Killer, Damage, DamageOrigin, DamageType);
	}
	DukeVision = Upgrade_HeatVision(__NFUN_917__(class'Upgrade_HeatVision'));
	// End:0xB5
	if(__NFUN_340__(DukeVision, none))
	{
...
simulated function bool CanBreatheAtAll()
{
	...
	if(__NFUN_172__(i, 0))
	{
		...
		// End:0x88
		if(__NFUN_148__(__NFUN_148__(__NFUN_340__(AirPocket, none), __NFUN_340__(AirPocket.AirBubbles, none)), AirPocket.AirBubbles.Enabled))
		{
			// End:0x86
...
function Killed(Pawn Killer, Pawn Other, class<DamageType> DamageType, int KillingDamage, name KillBoneName)
{
	...
	// End:0x21E
	if(__NFUN_148__(__NFUN_148__(__NFUN_148__(__NFUN_148__(__NFUN_173__(int(Level.NetMode), int(NM_Standalone)), Level.Game.__NFUN_358__('dnSinglePlayer')), __NFUN_340__(Other, none)), __NFUN_339__(Killer, self)), __NFUN_340__(Killer, Other)))
	{
		...
		// End:0x21E
		if(__NFUN_148__(__NFUN_145__(IsDead()), Other.bShouldCauseKillSound))
		{
			RandomChance = Other.KillSoundRandomChance;
			// End:0x171
			if(__NFUN_148__(Other.bAllowSpecialKillSounds, __NFUN_357__(DamageType, class'ExecutionDamage')))
			{
				RandomChance = __NFUN_225__(0.45, RandomChance);
				KillSound = 'GotExecution';				
			}
			else
			{
				// End:0x1B2
				if(__NFUN_148__(__NFUN_148__(Other.bAllowSpecialKillSounds, __NFUN_357__(DamageType, class'MeleeDamage')), __NFUN_200__(__NFUN_222__(), 0.5)))
				{
				...
				{
					// End:0x1FC
					if(__NFUN_148__(__NFUN_342__(Other.CustomKillSoundName, 'None'), __NFUN_200__(__NFUN_222__(), Other.CustomKillSoundChance)))
					{
			...
			// End:0x21E
			if(__NFUN_202__(__NFUN_222__(), RandomChance))
			{
...
simulated function CorpseHeadBlownOff(Pawn OwnerPawn)
{
	...
	// End:0x93
	if(__NFUN_148__(__NFUN_148__(__NFUN_148__(__NFUN_148__(__NFUN_340__(OwnerPawn, none), OwnerPawn.bShouldCauseKillSound), OwnerPawn.bAllowSpecialKillSounds), __NFUN_173__(int(Level.NetMode), int(NM_Standalone))), Level.Game.__NFUN_358__('dnSinglePlayer')))
	{
		// End:0x93
		if(__NFUN_200__(__NFUN_222__(), 0.75))
		{
...
simulated event CorpseGibbed(Pawn OwnerPawn)
{
	...
	if(__NFUN_148__(__NFUN_148__(__NFUN_148__(__NFUN_148__(__NFUN_340__(OwnerPawn, none), OwnerPawn.bShouldCauseKillSound), OwnerPawn.bAllowSpecialKillSounds), __NFUN_173__(int(Level.NetMode), int(NM_Standalone))), Level.Game.__NFUN_358__('dnSinglePlayer')))
	{
		...
		{
			// End:0xE4
			if(__NFUN_148__(__NFUN_145__(bPlayedESRBMessyKillLine), __NFUN_200__(__NFUN_222__(), 0.4)))
			{				
...
function GetBestSavedGame(Engine.Object.ESaveType Type, out Engine.Object.ESaveType BestType, out int BestSave, out int BestMonth, out int BestDay, out int BestYear, out int BestHour, out int BestMinute, out int BestSecond)
{
	...
	if(__NFUN_169__(i, NumSaves))
	{
		...
		{
			// End:0x145
			if(__NFUN_173__(Year, BestYear))
			{
				// End:0xA4
				if(__NFUN_170__(Month, BestMonth))
				{
					IsBest = true;					
				}
				else
				{
					// End:0x145
					if(__NFUN_173__(Month, BestMonth))
					{
						// End:0xCD
						if(__NFUN_170__(Day, BestDay))
						{
							IsBest = true;							
						}
						else
						{
							// End:0x145
							if(__NFUN_173__(Day, BestDay))
							{
								// End:0xF6
								if(__NFUN_170__(Hour, BestHour))
								{
									IsBest = true;									
								}
								else
								{
									// End:0x145
									if(__NFUN_173__(Hour, BestHour))
									{
										// End:0x11F
										if(__NFUN_170__(Minute, BestMinute))
										{
											IsBest = true;											
										}
										else
										{
											// End:0x145
											if(__NFUN_173__(Minute, BestMinute))
											{
												// End:0x145
												if(__NFUN_170__(Second, BestSecond))
												{
													IsBest = true;
												}
											}
...
function StartDeathSequence()
{
	...
	if(__NFUN_145__(IsMP()))
	{
		__NFUN_607__(5, true, 'Death_LoadOrRestart');
	}
	return;
}
...
function Death_LoadOrRestart()
{
	StartLoadGame(1, -1);
	// End:0x33
	if(__NFUN_148__(Level.bSavedGame, __NFUN_786__()))
	{
		LoadGameType = 2;		
	}
	else
...
{
	CrackedScreenStretch = __NFUN_225__(0.1, NewStretch);
	return;
}
...
event DrawDeathEffects(Canvas C)
{
	...
	if(IsDead())
	{
		X = __NFUN_195__(__NFUN_227__(__NFUN_198__(CrackedScreenX, __NFUN_195__(__NFUN_195__(__NFUN_195__(CrackedScreenAlpha, __NFUN_213__(__NFUN_195__(Level.GameTimeSeconds, 40))), CrackedScreenStretch), 0.5)), __NFUN_194__(CrackedScreenStretch), 0), float(C.SizeX));
		Y = __NFUN_195__(__NFUN_227__(__NFUN_198__(CrackedScreenY, __NFUN_195__(__NFUN_195__(__NFUN_195__(CrackedScreenAlpha, __NFUN_212__(__NFUN_195__(Level.GameTimeSeconds, 40))), CrackedScreenStretch), 0.5)), __NFUN_194__(CrackedScreenStretch), 0), float(C.SizeY));
		C.__NFUN_1250__(X, Y);
		C.__NFUN_1234__(CrackedScreenMaterial, __NFUN_195__(float(C.SizeX), __NFUN_198__(1, CrackedScreenStretch)), __NFUN_195__(float(C.SizeY), __NFUN_198__(1, CrackedScreenStretch)), 0, 0, float(CrackedScreenMaterial.__NFUN_1191__()), float(CrackedScreenMaterial.__NFUN_1192__()));		
	}
	else
	{
		// End:0x15F
...
simulated event bool IsZoomedIn()
{
	...
	return __NFUN_148__(__NFUN_340__(ZoomMode, none), ZoomMode.bActive);
	return;
}
...
simulated event float GetZoomTime()
{
	...
	{
		// End:0x56
		if(__NFUN_148__(__NFUN_340__(Weapon, none), __NFUN_340__(ZoomMode, none)))
		{
			// End:0x56
			if(__NFUN_201__(Weapon.default.WeaponConfig.default.ZoomAmount, 0))
			{
...
function TurnOnZoom()
{
	...
	// End:0x4B
	if(__NFUN_148__(__NFUN_340__(ZoomMode, none), ZoomMode.CanActivateNow()))
	{
...
{
	// End:0xA3
	if(__NFUN_148__(__NFUN_340__(__NFUN_560__(), none), __NFUN_340__(Level, __NFUN_560__())))
	{
		// End:0x69
		if(__NFUN_174__(inArg, 0))
		{
			// End:0x3F
			...
			QA.Connect(self);
			__NFUN_607__(__NFUN_196__(float(QARate), 1000), true, 'dnQAUpdate');			
		}
		else
		{
...
{
	// End:0x54
	if(__NFUN_148__(__NFUN_148__(__NFUN_174__(default.dnQAState, 0), __NFUN_340__(QA, none)), QA.__NFUN_1144__()))
	{
...
simulated function bool IsDrivingVehicle()
{
	...
	// End:0x37
	if(__NFUN_148__(__NFUN_340__(Something, none), __NFUN_340__(Something.GetVehicle(), none)))
	{
		return true;
	}
	return false;
...
exec function ShowMenu()
{
	...
	// End:0x60
	if(__NFUN_150__(__NFUN_150__(__NFUN_339__(WC, none), WC.bLocked), WC.bLevelChange))
	{
		return;
	}
	// End:0x72
...
event SaveComplete()
{
	...
	// End:0x34
	if(__NFUN_145__(bHasCheatedThisLevel))
	{
...
simulated function ConsumeFood(optional bool bAlwaysBurp)
{
	...
	// End:0x3D
	if(__NFUN_150__(bAlwaysBurp, __NFUN_200__(__NFUN_222__(), 0.25)))
	{
		__NFUN_607__(__NFUN_198__(Duration, 0.5), false, 'ConsumeFoodBurp');
	}
	return;
}
...
function SetDrunkEffect(float NewDrunkLevel, optional bool bTravel, optional bool bDontSoberUp)
{
	...
	// End:0xF0
	if(__NFUN_148__(__NFUN_148__(__NFUN_148__(__NFUN_148__(__NFUN_145__(bTravel), __NFUN_204__(DrunkLevel, 1)), __NFUN_340__(MyHUD, none)), __NFUN_145__(bDisplayedBeerHintMessage)), __NFUN_145__(IsMyDigs())))
	{		
...
k2call simulated function FootStep(optional EventInfo AnimEventInfo)
{
	...
	if(IsSprinting())
	{
		MovementRustleSoundInfo.Volume = __NFUN_195__(1.5, default.MovementRustleSoundInfo.Volume);		
	}
	else
	{
...
simulated function bool IsCandidateForExecution(DukePlayer TestDuke)
{
	...
	// End:0x2B
	if(__NFUN_147__(IsMostlyShrunk(), TestDuke.IsMostlyShrunk()))
	{
		return false;
	}
	// End:0x3D
	if(__NFUN_145__(IsEnemyTo(TestDuke)))
	{
		return false;
	}
	// End:0x48
...
simulated function bool CanBeExecutedBy(Pawn TestPawn)
{
	...
	// End:0x1B
	if(__NFUN_150__(__NFUN_145__(IsMP()), __NFUN_339__(TestPawn, none)))
	{
		return false;
	}
	// End:0x26
	...
	if(__NFUN_340__(TestPawn.Weapon, none))
	{
		...
		// End:0xA8
		if(__NFUN_148__(TestPawn.Weapon.__NFUN_358__('MP_MightyFoot'), TestPawn.Weapon.IsActive()))
		{
			return false;
		}
	}
	...
	// End:0xDD
	if(__NFUN_150__(__NFUN_339__(TestDuke, none), __NFUN_145__(TestDuke.CanDoThings())))
	{
		return false;
	}
	// End:0x158
	if(IsCandidateForExecution(TestDuke))
	{
		...
		// End:0x158
		if(__NFUN_148__(__NFUN_340__(TestDuke.ExecutionControl, none), TestDuke.ExecutionControl.CanBeUsedBy(TestDuke)))
		{
...
event Used(Actor Other, Pawn Instigator)
{
	...
	if(__NFUN_148__(IsMP(), __NFUN_173__(int(Role), int(ROLE_Authority))))
	{
		...
		// End:0x52
		if(__NFUN_148__(__NFUN_340__(DukeInstigator, none), CanBeExecutedBy(DukeInstigator)))
		{
...
{
	return __NFUN_150__(__NFUN_150__(Level.InstaGib, bGodMode), bInfiniteAmmo);
	return;
}
...
event Unpaused()
{
	...
	if(bAttachedToUsableSomething)
	{
		...
		{
			// End:0x6A
			if(__NFUN_147__(IsZoomedIn(), Turret.bZoomedIn))
			{
				// End:0x6A
				if(Turret.bZoomedIn)
				{
...
function bool HasEnteredPreorderBonusEgoCode()
{
	...
	RetVal = __NFUN_174__(OutValue, 0);
	return RetVal;
	return;
}
...
event RegisterPrecacheComponents(PrecacheIndex PrecacheIndex)
{
	...
	{
		PrecacheIndex.__NFUN_1277__(VoicePack, 'GotKill');
	...
	{
		i = __NFUN_166__(string(HitNotifySounds), 1);
		J0x1B6:
	...
	if(__NFUN_145__(PrecacheIndex.bIsMP))
	{
		PrecacheIndex.__NFUN_1281__('NoWeaponIdle');
	...
	// End:0x780
	if(__NFUN_150__(__NFUN_150__(__NFUN_310__(PrecacheIndex.MapName, "Map04B"), __NFUN_310__(PrecacheIndex.MapName, "Map04C")), __NFUN_310__(PrecacheIndex.MapName, "Map05")))
	{
		PrecacheIndex.__NFUN_1277__(VoicePack, 'BodyMotion_Short');
		PrecacheIndex.__NFUN_1277__(VoicePack, 'Gen_Grunt');
		PrecacheIndex.__NFUN_1277__(VoicePack, 'KnockDown_BodySlam');
...
function UpdateAchievementCounter(DukePlayer.EAchievement Achievement, int AwardCount)
{
	...
	__NFUN_184__(Count);
	__NFUN_380__("Achievements", EnumName, Count, "Progress.ini");
	// End:0x9E
	if(__NFUN_172__(Count, AwardCount))
	{
...
function UpdateKillAchievements(Pawn Other, Engine.Object.EPawnBodyPart BodyPart, class<DamageType> DamageType, VehicleBase Vehicle)
{
	...
	// End:0x60
	if(__NFUN_150__(__NFUN_150__(__NFUN_339__(Other.Faction, none), __NFUN_339__(Other.Faction, class'AIFactionRat')), __NFUN_145__(Other.Faction.static.IsAlien())))
	{
		return;
	}
	__NFUN_375__("Achievements", "NumKills", NumKills, "Progress.ini");
	__NFUN_184__(NumKills);
	__NFUN_380__("Achievements", "NumKills", NumKills, "Progress.ini");
	// End:0xD7
	if(__NFUN_172__(NumKills, 50))
	{
		AwardAchievement(0);
	}
	// End:0xEB
	if(__NFUN_172__(NumKills, 100))
	{
		AwardAchievement(1);
	}
	// End:0xFF
	if(__NFUN_172__(NumKills, 250))
	{
		AwardAchievement(2);
	}
	// End:0x11C
			...
			else
			{
				...
				else
				{
					...
					else
					{
						...
						{
							// End:0x235
							if(__NFUN_148__(__NFUN_357__(DamageType, class'MeleeDamage'), bOnSteroids))
							{
	...
	// End:0x27F
	if(__NFUN_148__(__NFUN_357__(DamageType, class'BulletDamage'), __NFUN_150__(__NFUN_150__(__NFUN_173__(int(BodyPart), int(1)), __NFUN_173__(int(BodyPart), int(2))), __NFUN_173__(int(BodyPart), int(19)))))
	{
	...
	// End:0x2C2
	if(__NFUN_201__(__NFUN_199__(Level.GameTimeSeconds, FrameKillsTimeSeconds), KillFrameTime))
	{
		FrameKills = 0;
	}
	FrameKillsTimeSeconds = Level.GameTimeSeconds;
	__NFUN_184__(FrameKills);
	// End:0x2F2
	if(__NFUN_172__(FrameKills, 3))
	{
		AwardAchievement(15);
	}
	return;
...
{
	// End:0x22
	if(__NFUN_148__(bOnSteroids, __NFUN_201__(DrunkLevel, 0)))
	{
		AwardAchievement(14);
	}
	return;
...
final function CheckHelmetsDiscovered()
{
	...
	// End:0xB4
	if(__NFUN_148__(__NFUN_148__(__NFUN_170__(FoundA, 0), __NFUN_170__(FoundB, 0)), __NFUN_170__(FoundC, 0)))
	{
		AwardAchievement(36);
	}
	return;
...
final function AdjustAcknowledgedDifficulty(int CurrentDifficulty)
{
	...
	// End:0x83
	if(__NFUN_169__(CurrentDifficulty, olddiff))
	{
		__NFUN_380__("Difficulty", "AcknowledgedDifficulty", CurrentDifficulty, "Progress.ini");
	}
	return;
...
function GiveRandomInventoryMP(float holodukePercentage, float steroidspercentage, float beerpercentage, float jetpackpercentage)
{
	...
	// End:0x3B
	if(__NFUN_201__(__NFUN_222__(), __NFUN_199__(1, holodukePercentage)))
	{
		GiveItem("dnGame.MP_Holoduke", 0);
	}
	// End:0x69
	if(__NFUN_201__(__NFUN_222__(), __NFUN_199__(1, steroidspercentage)))
	{
		GiveItem("dnGame.MP_Steroids", 0);
	}
	// End:0x9D
	if(__NFUN_201__(__NFUN_222__(), __NFUN_199__(1, beerpercentage)))
	{
		GiveItem("dnGame.MP_fortyouncebeer", 0);
	}
	// End:0xCB
	if(__NFUN_201__(__NFUN_222__(), __NFUN_199__(1, jetpackpercentage)))
	{
		GiveItem("dnGame.MP_Jetpack", 100);
	}
	return;
...
exec function GibMe()
{
	...
	self.TakeDamage(none, __NFUN_198__(Health, 1000), __NFUN_232__(0, 0, 0), __NFUN_232__(0, 0, 0), class'ExplosionDamage');
	return;
}
...
exec function TestLoadScreen()
{
	...
	Player.Console.bDrawLoadScreenConsole = __NFUN_145__(Player.Console.bDrawLoadScreenConsole);
	// End:0xAF
...
exec function actorType()
{
	...
	__NFUN_355__(__NFUN_302__(__NFUN_302__(__NFUN_302__(__NFUN_302__(__NFUN_302__(__NFUN_302__(__NFUN_302__(__NFUN_302__("Total actors: ", string(__NFUN_165__(__NFUN_165__(ii, iR), is))), " (I: "), string(ii)), ", R: "), string(iR)), ", S: "), string(is)), ")"));
	return;
}
...
exec function dnBulletTime(float Scaler)
{
	...
	PlayerScaler = __NFUN_196__(1, Scaler);
...
exec function dnShrink(float ShrinkTime)
{
	...
	// End:0x2A
	if(__NFUN_150__(bFullyShrunk, IsShrinking()))
	{
		ExpandPawn();		
	}
	else
...
exec function dnKroz()
{
	...
	// End:0x2A2
	if(__NFUN_150__(IsDead(), __NFUN_202__(Health, float(0))))
	{
		__NFUN_631__();
		...
		Ego = EgoCap;
		// End:0xB4
		if(__NFUN_173__(__NFUN_729__(Location).iLeaf, -1))
		{
			// End:0xB1
			if(__NFUN_173__(__NFUN_729__(LastGhostLocation).iLeaf, -1))
			{
				// End:0x9B
		...
		// End:0x273 [Loop If]
		if(__NFUN_169__(i, string(default.ScaleModifierGroupList)))
		{
...
exec function dnScotty(optional int Chunk)
{
	...
	URL = "map";
	// End:0x2A
	if(__NFUN_169__(Chunk, 0))
	{
		Chunk = 0;
	}
	// End:0x47
	if(__NFUN_169__(Chunk, 10))
	{
...
exec function dnAmmo()
{
	...
	bInfiniteAmmo = __NFUN_145__(bInfiniteAmmo);
	// End:0x43
	if(bInfiniteAmmo)
	{
...
exec function TestDeath(string DamageType)
{
	...
	Died(self, 20, Location, __NFUN_235__(-1, Vector(CalcedViewRotation)), TestDamageType);
	return;
}
...
exec function dnBall()
{
	...
	ThrowVector.Z = __NFUN_227__(__NFUN_198__(__NFUN_211__(ThrowVector.Z), 0.4), 0, 1);
	Ball = __NFUN_615__(BallClass, self,, __NFUN_238__(Location, __NFUN_234__(__NFUN_234__(Vector(ViewRotation), CollisionRadius), 1.8)), ViewRotation);
	Ball.__NFUN_820__(__NFUN_234__(__NFUN_234__(ThrowVector, Ball.Mass), 35));
	return;
}
...
exec function dnCopy()
{
	...
	EndLoc = __NFUN_238__(CamLocation, __NFUN_234__(__NFUN_234__(Vector(CamRotation), __NFUN_392__()), float(2)));
...
exec function dnAIDebugExec()
{
	...
	if(__NFUN_340__(AI, none))
	{
		AI.DebugExecutive = __NFUN_145__(AI.DebugExecutive);
		BroadcastLog(__NFUN_302__(__NFUN_302__(__NFUN_303__("DCR", string(AI)), ".DebugExecutive="), string(AI.DebugExecutive)));		
	}
	else
	{
		BroadcastLog("DCR No trace actor");
...
exec function dnAIPathHistory(int i)
{
	...
	// End:0x3C
	if(__NFUN_148__(__NFUN_340__(ViewTarget, none), __NFUN_340__(BaseAI(ViewTarget), none)))
	{
...
exec function dnHudInfoPos(int Position)
{
	...
	{
		// End:0x3B
		if(__NFUN_171__(Position, 0))
		{
			__NFUN_184__(MyDukeHUD.UseInfoPosition);			
		}
		else
		{
...
{
	// End:0x1C
	if(__NFUN_201__(float(NewHealth), HealthCap))
	{
...
exec function dnUnlockCurrentMap()
{
	...
	// End:0x40 [Loop If]
	if(__NFUN_171__(diff, int(Level.Game.Difficulty)))
	{
...
function bool HaveWeapons(int i)
{
	...
	// End:0x2D
	if(__NFUN_340__(PrimaryWeapon2, none))
	{
		__NFUN_184__(j);
	}
	// End:0x40
	if(__NFUN_340__(PrimaryWeapon3, none))
	{
		__NFUN_184__(j);
	}
	// End:0x53
	if(__NFUN_340__(PrimaryWeapon4, none))
	{
		__NFUN_184__(j);
	}
	// End:0x6A
	if(__NFUN_173__(i, 1))
	{
		return __NFUN_170__(j, 0);		
	}
	else
	{
		return __NFUN_170__(j, 1);
	}
	return;
}
...
{
	// End:0x22
	if(__NFUN_200__(__NFUN_199__(Level.GameTimeSeconds, LoadGameTimeSeconds), 0.5))
	{
		return;
	}
	// End:0xA7
	if(__NFUN_148__(__NFUN_148__(Item.bIsPrimaryWeapon, __NFUN_145__(bDisplayedUseWeaponHint)), HaveWeapons(1)))
	{
		// End:0x9C
		if(__NFUN_145__(IsMP()))
		{
	...
	// End:0x12F
	if(__NFUN_148__(__NFUN_148__(Item.bIsPrimaryWeapon, __NFUN_145__(bDisplayedSwapWeaponsHint)), HaveWeapons(2)))
	{
		// End:0x124
		if(__NFUN_145__(IsMP()))
		{
	...
	// End:0x1E8
	if(__NFUN_148__(__NFUN_145__(bDisplayedGotSteroidsHintMessage), __NFUN_150__(__NFUN_341__(Item.Class.Name, 'Steroids'), __NFUN_341__(Item.Class.Name, 'MP_Steroids'))))
	{
		// End:0x1DD
		if(__NFUN_145__(IsMP()))
		{
	...
	// End:0x29D
	if(__NFUN_148__(__NFUN_145__(bDisplayedGotBeerHintMessage), __NFUN_150__(__NFUN_341__(Item.Class.Name, 'FortyOunceBeer'), __NFUN_341__(Item.Class.Name, 'MP_FortyOunceBeer'))))
	{
		// End:0x292
		if(__NFUN_145__(IsMP()))
		{
	...
	// End:0x356
	if(__NFUN_148__(__NFUN_145__(bDisplayedGotHolodukeHintMessage), __NFUN_150__(__NFUN_341__(Item.Class.Name, 'HoloDuke'), __NFUN_341__(Item.Class.Name, 'MP_Holoduke'))))
	{
		// End:0x34B
		if(__NFUN_145__(IsMP()))
		{
	...
	// End:0x40E
	if(__NFUN_148__(__NFUN_145__(bDisplayedGotJetpackHintMessage), __NFUN_150__(__NFUN_341__(Item.Class.Name, 'Jetpack'), __NFUN_341__(Item.Class.Name, 'MP_Jetpack'))))
	{
		// End:0x403
		if(__NFUN_145__(IsMP()))
		{
...
simulated function DisplayInventoryHint(class<TriggerHint> HintClass)
{
	...
	{
		// End:0x1B
		if(__NFUN_145__(IsDisplayInventoryHint(HintClass)))
		{
			return;
		}
		// End:0x54
...
simulated function bool IsDisplayInventoryHint(class<TriggerHint> HintClass)
{
	...
	if(IsMP())
	{
		...
		{
			// End:0x44
			if(__NFUN_145__(bDisplayedUseWeaponHint))
			{
				bDisplayedUseWeaponHint = true;
		...
		else
		{
			...
			{
				// End:0x7A
				if(__NFUN_145__(bDisplayedSwapWeaponsHint))
				{
					bDisplayedSwapWeaponsHint = true;
			...
			else
			{
				...
				{
					// End:0xB0
					if(__NFUN_145__(bDisplayedGotSteroidsHintMessage))
					{
						bDisplayedGotSteroidsHintMessage = true;
				...
				else
				{
					...
					{
						// End:0xE6
						if(__NFUN_145__(bDisplayedGotBeerHintMessage))
						{
							bDisplayedGotBeerHintMessage = true;
					...
					else
					{
						...
						{
							// End:0x11C
							if(__NFUN_145__(bDisplayedGotHolodukeHintMessage))
							{
								bDisplayedGotHolodukeHintMessage = true;
						...
						else
						{
							...
							{
								// End:0x152
								if(__NFUN_145__(bDisplayedGotJetpackHintMessage))
								{
									bDisplayedGotJetpackHintMessage = true;
...
simulated event FailedPickupAttempt(class<Inventory> InvClass, Pickup PickupRef, Engine.Actor.EPickupSource PickupSource)
{
	...
	// End:0xDB
	if(__NFUN_150__(__NFUN_173__(int(PickupSource), int(2)), __NFUN_173__(int(PickupSource), int(3))))
	{
		// End:0x59
...
function StartSteroids(float Duration, optional bool bTravel)
{
	...
	Ego = __NFUN_199__(Ego, __NFUN_199__(EgoCap, SteroidEgoCap));
	// End:0x42
...
function ClientStartSteroids(float Duration, optional bool bTravel)
{
	...
	// End:0xDE
	if(__NFUN_148__(__NFUN_145__(bTravel), __NFUN_145__(bDisplayedSteroidsHintMessage)))
	{		
...
k2call simulated function KickDamage(optional EventInfo AnimEventInfo)
{
	...
	if(__NFUN_340__(CurrentDoor, none))
	{
		...
		CenterOffset = __NFUN_236__(__NFUN_234__(CurrentDoor.PrePivot, CurrentDoor.DrawScale), CurrentDoor.DrawScale3D);
		TraceFireMaterialHit(class'MeleeDamage', CurrentDoor, __NFUN_239__(CurrentDoor.Location, __NFUN_263__(CenterOffset, CurrentDoor.Rotation)), __NFUN_253__(__NFUN_239__(CalcedViewLocation, CurrentDoor.Location)), HitMaterial, HitMasking);
...
simulated function ClientStomp()
{
	...
	{
		// End:0x17D
		if(__NFUN_201__(StompKnockbackRadius, 0))
		{
			pos = __NFUN_239__(Location, __NFUN_232__(0, 0, __NFUN_195__(0.8, CollisionHeight)));
			Gravity = __NFUN_253__(__NFUN_640__());
			// End:0x17C
			foreach __NFUN_754__(class'KarmaActor', KnockbackActor, StompKnockbackRadius, pos)
			{
				// End:0x7A
				...
				DistScale = __NFUN_196__(__NFUN_251__(Dir), StompKnockbackRadius);
				// End:0x17B
				if(__NFUN_201__(DistScale, 0))
				{
					__NFUN_250__(Dir, __NFUN_235__(__NFUN_244__(Dir, Gravity), Gravity));
					Dir = __NFUN_253__(Dir);
					Impulse = __NFUN_235__(DistScale, __NFUN_239__(__NFUN_235__(StompKnockbackImpulse, Dir), __NFUN_235__(StompKnockbackLift, Gravity)));
					// End:0x169
					if(__NFUN_148__(KnockbackActor.bIsPawn, Pawn(KnockbackActor).bPhysicsControllerActive))
					{
						// End:0x166
...
simulated function int GetWeaponPriority(Weapon Weap)
{
	...
	{
		// End:0x6F
		if(__NFUN_148__(__NFUN_148__(__NFUN_148__(__NFUN_148__(__NFUN_148__(__NFUN_340__(Weap, none), __NFUN_339__(Weap.Class, MightyFootClass)), __NFUN_340__(PrimaryWeapon1, none)), __NFUN_340__(PrimaryWeapon2, none)), __NFUN_340__(PrimaryWeapon3, none)), __NFUN_340__(PrimaryWeapon4, none)))
		{
			return -1;
		}		
	}
	...
	{
		// End:0xBC
		if(__NFUN_148__(__NFUN_148__(__NFUN_148__(__NFUN_340__(Weap, none), __NFUN_339__(Weap.Class, MightyFootClass)), __NFUN_340__(PrimaryWeapon1, none)), __NFUN_340__(PrimaryWeapon2, none)))
		{
			return -1;
		}
	}
...
{
	// End:0xAF
	if(__NFUN_148__(__NFUN_340__(MyHUD, none), __NFUN_145__(bDisplayedInfiniteAmmoHint)))
	{		
...
{
	// End:0x9D
	if(__NFUN_148__(bOnSteroids, __NFUN_340__(NewWeapon.Class, MightyFootClass)))
	{
		// End:0x9D
		if(__NFUN_148__(__NFUN_148__(__NFUN_148__(__NFUN_145__(__NFUN_357__(NewWeapon.Class, class'FortyOunceBeer')), __NFUN_145__(__NFUN_357__(NewWeapon.Class, class'HoloDuke'))), __NFUN_145__(__NFUN_357__(NewWeapon.Class, class'MP_Holoduke'))), __NFUN_145__(__NFUN_357__(NewWeapon.Class, class'Cigar'))))
		{
			return;
		}
	}
