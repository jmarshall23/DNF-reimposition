...
defaultproperties
{
	...
	DestroyableBones(5)=(BoneName=LeftArm,bAddToLimbCount=true,LimbCapClass='dnCorpse_LimbCap_Male_ArmLeft_Upper',LimbCapMountInfo=(bDontActuallyMount=false,bHideable=false,bIndependentRotation=false,bIndependentLocation=false,bMatchParentLocation=false,bMatchParentRotation=false,bSurviveDismount=false,bDontScaleByDrawScale=false,bScaleByDrawScaleNonDefault=false,bTransformDrawScale3DChange=false,bTakeParentTag=false,bTransferToCorpse=false,bDontSetOwner=false,MountParentTag=None,DrawScaleOverride=0,AppendToTag=None,ForceTag=None,ForceEvent=None,MountMeshItem=None,MountOrigin=(X=1.292418E-41,Y=2.94903E-17,Z=0),Z=8.5),MountOriginVariance=(X=1.292418E-41,Y=2.94903E-17,Z=0),Z=0)
	DestroyableBones(6)=(MountAngles=(Pitch=8741,Yaw=572915712,Roll=0),Roll=25000)
	...
	Gibs(0)=(BoneName=neck,ReqBones=none,RenderObject='sm_class_effects.Assault_Trooper_Gibs.Assault_Trooper_head_Gib',DrawScale=0,DrawScaleVariance=0,LocOffset=(X=-0.003910545,Y=2.954346E-17,Z=0.34964),Z=13.95496)
	Gibs(1)=(RotOffset=(Pitch=423305765,Yaw=572915712,Roll=-4),Roll=-2)
	...
	Gibs(3)=(BoneName=Root,ReqBones=none,RenderObject='sm_class_effects.Assault_Trooper_Gibs.Assault_Trooper_TorsoA_Gib',DrawScale=0,DrawScaleVariance=0,LocOffset=(X=1.292418E-41,Y=2.954525E-17,Z=2.64),Z=1.23)
	Gibs(4)=(RotOffset=(Pitch=-206036443,Yaw=572981247,Roll=0),Roll=0)
	...
	Gibs(6)=(BoneName=Root,ReqBones=none,RenderObject='sm_class_effects.Assault_Trooper_Gibs.Assault_Trooper_TorsoB_Gib',DrawScale=0,DrawScaleVariance=0,LocOffset=(X=2.717022E+23,Y=2.954479E-17,Z=-2.63),Z=9.64)
	Gibs(7)=(RotOffset=(Pitch=-206036443,Yaw=572981247,Roll=0),Roll=0)
	...
	Gibs(9)=(BoneName=Root,ReqBones=none,RenderObject='sm_class_effects.Assault_Trooper_Gibs.Assault_Trooper_TorsoC_Gib',DrawScale=0,DrawScaleVariance=0,LocOffset=(X=-1.075528E+08,Y=2.965352E-17,Z=5.48),Z=23.94)
	Gibs(10)=(RotOffset=(Pitch=-206036443,Yaw=572981247,Roll=0),Roll=0)
	...
	GibEffects(0)=(ParticleEffect='p_hit_effects.Blood_BodyExplode.Blood_BodyExplode_Spawner',BoneName=spine2,LocOffset=(X=1.292418E-41,Y=2.94903E-17,Z=0),Z=0)
