/*******************************************************************************
 * GameModeSpecificDecoration generated by Eliot.UELib using UELib.CLI.
...
function PostBeginPlay()
{
	...
	switch(dnMultiplayer(Level.Game).GameType)
	{
		...
		case 2:
			// End:0x74
			if(__NFUN_145__(bCaptureTheBabe))
			{
				shouldDestroy = true;
			}
			// End:0xB8
		...
		case 4:
			// End:0x8F
			if(__NFUN_145__(bKingOfTheHill))
			{
				shouldDestroy = true;
			}
			// End:0xB8
		...
		case 3:
			// End:0xAA
			if(__NFUN_145__(bTeamDeathMatch))
			{
				shouldDestroy = true;
			}
			// End:0xB8
