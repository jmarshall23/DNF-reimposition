/*******************************************************************************
 * ParticleSystemTimer_OilyFire generated by Eliot.UELib using UE Explorer.exe.
 * Eliot.UELib ? 2009-2022 Eliot van Uytfanghe. All rights reserved.
 * http://eliotvu.com
 *
 * All rights belong to their respective owners.
 *******************************************************************************/
class ParticleSystemTimer_OilyFire extends ParticleSystemTimer
    collapsecategories
...
defaultproperties
{
    ParticleSystemClass='p_Decorations.Oil_Fire.OilFire_Main'
    LightClass='TriggerLightEx_PST_OilyFire'
    bEffectActive=true
    SoundName=Fire_Oil
