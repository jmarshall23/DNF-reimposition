/*******************************************************************************
 * ComboSwitchController generated by Eliot.UELib using UELib.CLI.
...
final simulated function TriggerFunc_SwitchState()
{
	...
	{
		// End:0x67
		if(__NFUN_173__(SwitchStates[i].SpecialEventID, SpecialEventID))
		{
			SwitchStates[i].CurrentState = __NFUN_145__(SwitchStates[i].CurrentState);
		}
		__NFUN_184__(i);
		// [Loop Continue]
		goto J0x19;
...
final simulated function CheckSwitchState()
{
	...
	{
		// End:0x4D
		if(__NFUN_147__(SwitchStates[i].CurrentState, SwitchStates[i].DesiredState))
		{
			ComboCorrect = false;
		}
		__NFUN_184__(i);
