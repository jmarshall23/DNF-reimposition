/*******************************************************************************
 * MP_LaserMine generated by Eliot.UELib using UELib.CLI.
...
event PostBeginPlay()
{
	...
	{
		// End:0x32
		foreach __NFUN_747__(class'MP_LaserMine', LM)
		{
			LM.ProcessLinking();			
		}		
	}
...
noexport simulated delegate rInitializeMotionCustom()
{
	...
	{
		__NFUN_642__(2);
		Velocity = __NFUN_235__(__NFUN_195__(__NFUN_196__(DrawScale, default.DrawScale), ThrowForce), Vector(TossAngle));		
	}
	else
	{
		__NFUN_642__(18);
...
event KImpact(name SelfBoneName, KarmaActor Other, name OtherBoneName, Vector inPosition, Vector ImpactVelocity, Vector ImpactNormal)
{
	...
	if(__NFUN_148__(__NFUN_340__(Other, Instigator), __NFUN_339__(MountParent, none)))
	{
		...
		if(__NFUN_148__(bAccept, __NFUN_150__(bAcceptAtAnyAngle, __NFUN_201__(__NFUN_244__(Vector(Rotation), ImpactNormal), float(0)))))
		{
			...
			__NFUN_678__(Location, NewColorBytes(255, 0, 0, 255), 10);
			__NFUN_678__(__NFUN_238__(Location, __NFUN_234__(__NFUN_233__(ImpactNormal), TraceDist)), NewColorBytes(255, 0, 255, 255), 10);
			__NFUN_676__(Location, __NFUN_238__(Location, __NFUN_234__(__NFUN_233__(ImpactNormal), TraceDist)), NewColorBytes(255, 0, 255, 255), 10);
			__NFUN_736__(__NFUN_238__(Location, ImpactNormal), __NFUN_238__(Location, __NFUN_234__(__NFUN_233__(ImpactNormal), TraceDist)), TraceFlags, PlacementTraceResult);
			// End:0x276
			if(CanAcceptMinePlacement(PlacementTraceResult))
			{
				// End:0x23D
				if(__NFUN_200__(__NFUN_244__(PlacementTraceResult.Normal, ImpactNormal), 0))
				{
...
simulated event MineAttached()
{
	...
	// End:0x9B
	if(__NFUN_148__(__NFUN_340__(MountParent, none), __NFUN_150__(MountParent.bIsPawn, __NFUN_148__(__NFUN_340__(MountParent.MountParent, none), MountParent.MountParent.bIsPawn))))
	{
		ArmMineOnPawn();		
	}
	else
...
simulated function SpawnLaserBeam()
{
	...
	{
		// End:0xA5
		if(__NFUN_148__(__NFUN_173__(int(Instigator.PlayerReplicationInfo.Team), 0), Level.__NFUN_1161__().GameReplicationInfo.bTeamGame))
		{
		...
		// End:0x1E3
		if(__NFUN_150__(Instigator.bFullyShrunk, Instigator.IsShrinking()))
		{
...
simulated function bool CanBeUsedBy(Pawn User)
{
	...
	{
		// End:0x5B
		if(__NFUN_148__(__NFUN_148__(__NFUN_145__(bShielded), bEMPulsed), class'Inventory'.static.CanPickupClass(class'MP_Tripmine', User)))
		{
...
{
	// End:0x60
	if(__NFUN_148__(bArmed, __NFUN_145__(bDetonated)))
	{
		bDetonated = true;
		// End:0x3B
		if(__NFUN_340__(MountParent, none))
...
{
	GravityScale = __NFUN_195__(jumpPadGravityScalar, DrawScale);
