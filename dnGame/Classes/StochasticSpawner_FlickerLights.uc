/*******************************************************************************
 * StochasticSpawner_FlickerLights generated by Eliot.UELib using UELib.CLI.
...
simulated function TriggerEvent()
{
	...
	// End:0x65
	if(__NFUN_148__(__NFUN_173__(int(Role), int(ROLE_Authority)), __NFUN_342__(FlickerEvent, 'None')))
	{
