/*******************************************************************************
 * dnMutator_InstaGib generated by Eliot.UELib using UELib.CLI.
...
function MutatorTakeDamage(out float ActualDamage, Pawn Victim, Pawn InstigatedBy, out Vector HitLocation, out Vector HitDirection, class<DamageType> DamageType, name HitBoneName)
{
	...
	{
		// End:0x95
		if(__NFUN_148__(__NFUN_148__(__NFUN_340__(Victim, InstigatedBy), __NFUN_340__(InstigatedBy, none)), __NFUN_145__(__NFUN_148__(Level.GRI.bTeamGame, __NFUN_173__(int(Victim.PlayerReplicationInfo.Team), int(InstigatedBy.PlayerReplicationInfo.Team))))))
		{
			ActualDamage = 99999;
		}
