/*******************************************************************************
 * TriggerRadiusCheck generated by Eliot.UELib using UELib.CLI.
...
function PostBeginPlay()
{
	...
	RadiusSquared = __NFUN_195__(Radius, Radius);
	// End:0x32
	if(bEnabled)
	{
...
function Tick(float DeltaTime)
{
	...
	// End:0x2F
	if(__NFUN_150__(__NFUN_339__(TestActors[0], none), __NFUN_339__(TestActors[1], none)))
	{
		EnableTicking();
	}
	// End:0x55
	...
	// End:0x133
	if(__NFUN_201__(InternalFrameCounter, FrameCheck))
	{
		// End:0x94
		if(__NFUN_206__(FrameCheck, 0))
		{
			InternalFrameCounter = __NFUN_197__(InternalFrameCounter, FrameCheck);			
		}
		else
		{
			InternalFrameCounter = 0;
		}
		CurrentRadiusSquared = __NFUN_252__(__NFUN_239__(TestActors[0].Location, TestActors[1].Location));
		// End:0xFB
		if(__NFUN_148__(__NFUN_203__(CurrentRadiusSquared, RadiusSquared), __NFUN_200__(PreviousRadiusSquared, RadiusSquared)))
		{
		...
		{
			// End:0x128
			if(__NFUN_148__(__NFUN_200__(CurrentRadiusSquared, RadiusSquared), __NFUN_203__(PreviousRadiusSquared, RadiusSquared)))
			{
