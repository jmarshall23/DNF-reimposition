/*******************************************************************************
 * UWindowDialogControl generated by Eliot.UELib using UELib.CLI.
...
function UWindowDialogControl CheckExternalDrag(float X, float Y)
{
	...
	// End:0xC1
	if(__NFUN_148__(__NFUN_148__(__NFUN_340__(W, self), __NFUN_340__(C, none)), C.bAcceptExternalDragDrop))
	{
	...
	switch(Key)
	{
		...
		case int(P.9):
			...
			if(__NFUN_340__(TabNext, none))
			{
				...
				// End:0x88 [Loop If]
				if(__NFUN_148__(__NFUN_340__(n, self), __NFUN_145__(n.bWindowVisible)))
				{
					n = n.TabNext;
					// [Loop Continue]
					goto J0x4D;
...
function MouseEnter()
{
	...
	{
		// End:0x72
		if(__NFUN_148__(__NFUN_340__(ParentWindow.ChildInFocus, self), __NFUN_340__(ParentWindow.ChildInFocus, none)))
		{
