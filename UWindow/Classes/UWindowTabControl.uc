/*******************************************************************************
 * UWindowTabControl generated by Eliot.UELib using UELib.CLI.
...
function Created()
{
	super.Created();
	SelectedTab = none;
	TabArea = UWindowTabControlTabArea(CreateWindow(class'UWindowTabControlTabArea', 0, 0, __NFUN_199__(__NFUN_199__(WinWidth, float(10)), float(__NFUN_162__(LookAndFeel.SBPosIndicator.W, 2))), __NFUN_198__(LookAndFeel.Size_TabAreaHeight, LookAndFeel.Size_TabAreaOverhangHeight)));
	TabArea.bAlwaysOnTop = true;
	LeftButton = UWindowTabControlLeftButton(CreateWindow(class'UWindowTabControlLeftButton', __NFUN_199__(WinWidth, float(20)), 0, 10, 12));
	RightButton = UWindowTabControlRightButton(CreateWindow(class'UWindowTabControlRightButton', __NFUN_199__(WinWidth, float(10)), 0, 10, 12));
	return;
}
...
function BeforePaint(Canvas C, float X, float Y)
{
	...
	{
		TabArea.WinWidth = __NFUN_199__(__NFUN_199__(WinWidth, float(10)), float(__NFUN_162__(LookAndFeel.SBPosIndicator.W, 2)));
	}
	TabArea.LayoutTabs(C);
	WinHeight = __NFUN_198__(__NFUN_195__(LookAndFeel.Size_TabAreaHeight, float(TabArea.TabRows)), LookAndFeel.Size_TabAreaOverhangHeight);
...
function Paint(Canvas C, float X, float Y)
{
	...
	DrawStretchedTextureSegment(C, 0, 0, WinWidth, __NFUN_195__(LookAndFeel.Size_TabAreaHeight, float(TabArea.TabRows)), float(R.X), float(R.Y), float(R.W), float(R.h), t);
	return;
}
