/*******************************************************************************
 * UWindowPulldownMenu generated by Eliot.UELib using UELib.CLI.
...
{
	// End:0x2E
	if(__NFUN_148__(__NFUN_340__(Selected, none), __NFUN_340__(NewSelected, Selected)))
	{
		Selected.DeSelect();
	}
	// End:0x44
...
function SetSelected(float X, float Y)
{
	...
	NewSelected = UWindowPulldownMenuItem(Items.FindEntry(__NFUN_163__(int(__NFUN_199__(Y, float(VBorder))), ItemHeight)));
...
{
	// End:0x53
	if(__NFUN_148__(__NFUN_148__(__NFUN_340__(Selected, none), __NFUN_309__(Selected.Caption, "-")), __NFUN_145__(Selected.bDisabled)))
	{
...
function BeforePaint(Canvas C, float X, float Y)
{
	...
	WinWidth = __NFUN_198__(MaxWidth, float(__NFUN_162__(__NFUN_165__(HBorder, TextBorder), 2)));
	WinHeight = __NFUN_198__(float(__NFUN_162__(ItemHeight, Count)), float(__NFUN_162__(VBorder, 2)));
	// End:0x165
	if(__NFUN_148__(__NFUN_340__(UWindowMenuBarItem(Owner), none), UWindowMenuBarItem(Owner).bHelp))
	{
		WinLeft = __NFUN_199__(ParentWindow.WinWidth, WinWidth);
	}
	// End:0x1E8
	if(__NFUN_340__(UWindowPulldownMenuItem(Owner), none))
	{
		...
		// End:0x1E8
		if(__NFUN_201__(__NFUN_198__(WinWidth, WinLeft), ParentWindow.WinWidth))
		{
			WinLeft = __NFUN_199__(__NFUN_198__(i.Owner.WinLeft, float(i.Owner.HBorder)), WinWidth);
		}
	}
	return;
}
...
function KeyDown(int Key, float X, float Y)
{
	...
	switch(Key)
	{
		...
		case 38:
			// End:0x5D
			if(__NFUN_150__(__NFUN_339__(i, none), __NFUN_339__(i, Items.Next)))
			{
		...
		case 39:
			// End:0x346
			if(__NFUN_148__(__NFUN_340__(i, none), __NFUN_340__(i.SubMenu, none)))
			{
				Selected = none;
				PerformSelect(i);
...
function KeyUp(int Key, float X, float Y)
{
	...
	// End:0xD5
	if(__NFUN_148__(__NFUN_172__(Key, 65), __NFUN_171__(Key, 96)))
	{
		i = UWindowPulldownMenuItem(Items.Next);
		J0x34:
		...
		if(__NFUN_340__(i, none))
		{
			...
			if(__NFUN_173__(Key, int(i.HotKey)))
			{
				PerformSelect(i);
				// End:0xB8
				if(__NFUN_148__(__NFUN_148__(__NFUN_340__(i, none), __NFUN_309__(i.Caption, "-")), __NFUN_145__(i.bDisabled)))
				{
					BeforeExecuteItem(i);
					ExecuteItem(i);
				}
...
function MenuCmd(int Item)
{
	...
	{
		// End:0x87
		if(__NFUN_173__(j, Item))
		{
			PerformSelect(i);
			// End:0x85
			if(__NFUN_148__(__NFUN_309__(i.Caption, "-"), __NFUN_145__(i.bDisabled)))
			{
				BeforeExecuteItem(i);
				ExecuteItem(i);
			}
