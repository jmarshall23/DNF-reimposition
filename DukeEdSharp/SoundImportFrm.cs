...
{
    public partial class SoundImportFrm : Form
    {
        public SoundImportFrm()
        {
            InitializeComponent();
        }
        ...
        {
            string s = String.Format("AUDIO IMPORT FILE=\"{0}\" NAME=\"{1}\" PACKAGE=\"{2}\" GROUP=\"{3}\"", texturePathTxt.Text, nameTxt.Text, packageTxt.Text, groupTxt.Text);
