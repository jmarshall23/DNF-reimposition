...
{
    public partial class TextureImportFrm : Form
    {
        public TextureImportFrm()
        {
            InitializeComponent();
        }
        ...
        {
            string s = String.Format("TEXTURE IMPORT FILE=\"{0}\" NAME=\"{1}\" PACKAGE=\"{2}\" GROUP=\"{3}\"", texturePathTxt.Text, nameTxt.Text, packageTxt.Text, groupTxt.Text);
